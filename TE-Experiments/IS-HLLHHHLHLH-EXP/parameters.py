...
# Used permutation '1001110101', which corresponds to 'HLLHHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'