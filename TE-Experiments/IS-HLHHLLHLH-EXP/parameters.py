...
# Used permutation '101100101', which corresponds to 'HLHHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'