...
# Used permutation '1110000111', which corresponds to 'HHHLLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'