...
# Used permutation '0111010001', which corresponds to 'LHHHLHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'