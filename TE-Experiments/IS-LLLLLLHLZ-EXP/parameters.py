...
# Used permutation '000000102', which corresponds to 'LLLLLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'