...
# Used permutation '111110100', which corresponds to 'HHHHHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'