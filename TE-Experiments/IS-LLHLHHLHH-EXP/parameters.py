...
# Used permutation '001011011', which corresponds to 'LLHLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'