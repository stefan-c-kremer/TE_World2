...
# Used permutation '000001011', which corresponds to 'LLLLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'