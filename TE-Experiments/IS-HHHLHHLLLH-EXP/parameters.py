...
# Used permutation '1110110001', which corresponds to 'HHHLHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'