...
# Used permutation '1010000000', which corresponds to 'HLHLLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'