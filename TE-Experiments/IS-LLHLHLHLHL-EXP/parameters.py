...
# Used permutation '0010101010', which corresponds to 'LLHLHLHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'