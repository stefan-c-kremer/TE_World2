...
# Used permutation '1010110100', which corresponds to 'HLHLHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'