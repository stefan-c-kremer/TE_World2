...
# Used permutation '0111000111', which corresponds to 'LHHHLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'