...
# Used permutation '110011012', which corresponds to 'HHLLHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'