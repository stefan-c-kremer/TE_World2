...
# Used permutation '110101102', which corresponds to 'HHLHLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'