...
# Used permutation '0000010101', which corresponds to 'LLLLLHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'