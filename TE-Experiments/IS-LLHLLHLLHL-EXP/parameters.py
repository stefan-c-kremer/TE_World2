...
# Used permutation '0010010010', which corresponds to 'LLHLLHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'