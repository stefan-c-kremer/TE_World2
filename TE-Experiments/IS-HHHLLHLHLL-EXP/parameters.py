...
# Used permutation '1110010100', which corresponds to 'HHHLLHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'