...
# Used permutation '1000101100', which corresponds to 'HLLLHLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'