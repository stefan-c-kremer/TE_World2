...
# Used permutation '100011011', which corresponds to 'HLLLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'