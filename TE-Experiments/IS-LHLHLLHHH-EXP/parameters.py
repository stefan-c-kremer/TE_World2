...
# Used permutation '010100111', which corresponds to 'LHLHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'