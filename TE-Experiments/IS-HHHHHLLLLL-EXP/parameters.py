...
# Used permutation '1111100000', which corresponds to 'HHHHHLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'