...
# Used permutation '0111110010', which corresponds to 'LHHHHHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'