...
# Used permutation '0101101111', which corresponds to 'LHLHHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'