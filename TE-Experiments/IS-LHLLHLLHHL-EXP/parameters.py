...
# Used permutation '0100100110', which corresponds to 'LHLLHLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'