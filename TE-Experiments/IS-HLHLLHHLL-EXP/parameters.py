...
# Used permutation '101001100', which corresponds to 'HLHLLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'