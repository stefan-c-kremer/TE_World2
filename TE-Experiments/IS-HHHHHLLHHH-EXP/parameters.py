...
# Used permutation '1111100111', which corresponds to 'HHHHHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'