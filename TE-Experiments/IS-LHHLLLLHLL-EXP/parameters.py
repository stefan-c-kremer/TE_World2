...
# Used permutation '0110000100', which corresponds to 'LHHLLLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'