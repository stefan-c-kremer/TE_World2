...
# Used permutation '1110111010', which corresponds to 'HHHLHHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'