...
# Used permutation '011100112', which corresponds to 'LHHHLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'