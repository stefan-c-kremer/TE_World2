...
# Used permutation '0001100100', which corresponds to 'LLLHHLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'