...
# Used permutation '001100011', which corresponds to 'LLHHLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'