...
# Used permutation '110011001', which corresponds to 'HHLLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'