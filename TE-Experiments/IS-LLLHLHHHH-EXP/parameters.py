...
# Used permutation '000101111', which corresponds to 'LLLHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'