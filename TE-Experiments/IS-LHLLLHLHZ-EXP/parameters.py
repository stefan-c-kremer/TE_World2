...
# Used permutation '010001012', which corresponds to 'LHLLLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'