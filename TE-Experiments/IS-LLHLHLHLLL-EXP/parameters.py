...
# Used permutation '0010101000', which corresponds to 'LLHLHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'