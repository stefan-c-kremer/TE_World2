...
# Used permutation '000100100', which corresponds to 'LLLHLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'