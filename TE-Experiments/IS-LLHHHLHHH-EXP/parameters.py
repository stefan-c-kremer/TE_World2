...
# Used permutation '001110111', which corresponds to 'LLHHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'