...
# Used permutation '001010111', which corresponds to 'LLHLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'