...
# Used permutation '0110111011', which corresponds to 'LHHLHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'