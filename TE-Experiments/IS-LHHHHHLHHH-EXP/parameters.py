...
# Used permutation '0111110111', which corresponds to 'LHHHHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'