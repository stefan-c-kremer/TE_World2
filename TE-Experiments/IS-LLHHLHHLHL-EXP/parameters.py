...
# Used permutation '0011011010', which corresponds to 'LLHHLHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'