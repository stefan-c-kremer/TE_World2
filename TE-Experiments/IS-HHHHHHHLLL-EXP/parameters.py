...
# Used permutation '1111111000', which corresponds to 'HHHHHHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'