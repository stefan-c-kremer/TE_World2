...
# Used permutation '1111111000', which corresponds to 'HHHHHHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'