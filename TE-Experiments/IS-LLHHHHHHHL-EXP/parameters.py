...
# Used permutation '0011111110', which corresponds to 'LLHHHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'