...
# Used permutation '0101110101', which corresponds to 'LHLHHHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'