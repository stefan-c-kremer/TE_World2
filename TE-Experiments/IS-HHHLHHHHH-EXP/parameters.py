...
# Used permutation '111011111', which corresponds to 'HHHLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'