...
# Used permutation '001111112', which corresponds to 'LLHHHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'