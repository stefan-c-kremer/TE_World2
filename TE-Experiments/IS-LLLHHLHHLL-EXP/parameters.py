...
# Used permutation '0001101100', which corresponds to 'LLLHHLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'