...
# Used permutation '1011001100', which corresponds to 'HLHHLLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'