...
# Used permutation '101001102', which corresponds to 'HLHLLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'