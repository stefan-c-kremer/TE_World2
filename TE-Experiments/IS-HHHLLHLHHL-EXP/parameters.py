...
# Used permutation '1110010110', which corresponds to 'HHHLLHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'