...
# Used permutation '101001110', which corresponds to 'HLHLLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'