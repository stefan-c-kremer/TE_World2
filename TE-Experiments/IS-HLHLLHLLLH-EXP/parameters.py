...
# Used permutation '1010010001', which corresponds to 'HLHLLHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'