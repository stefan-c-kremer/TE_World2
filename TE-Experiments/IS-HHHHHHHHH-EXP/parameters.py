...
# Used permutation '111111111', which corresponds to 'HHHHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'