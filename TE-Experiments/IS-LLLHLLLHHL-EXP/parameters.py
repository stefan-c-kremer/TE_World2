...
# Used permutation '0001000110', which corresponds to 'LLLHLLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'