...
# Used permutation '0000000110', which corresponds to 'LLLLLLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'