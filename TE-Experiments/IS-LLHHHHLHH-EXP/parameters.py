...
# Used permutation '001111011', which corresponds to 'LLHHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'