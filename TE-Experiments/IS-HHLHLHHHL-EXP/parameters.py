...
# Used permutation '110101110', which corresponds to 'HHLHLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'