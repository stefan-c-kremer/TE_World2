...
# Used permutation '000110101', which corresponds to 'LLLHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'