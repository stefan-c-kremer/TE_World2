...
# Used permutation '0101011111', which corresponds to 'LHLHLHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'