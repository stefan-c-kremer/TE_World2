...
# Used permutation '1001010000', which corresponds to 'HLLHLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'