...
# Used permutation '0111000110', which corresponds to 'LHHHLLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'