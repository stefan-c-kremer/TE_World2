...
# Used permutation '110010112', which corresponds to 'HHLLHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'