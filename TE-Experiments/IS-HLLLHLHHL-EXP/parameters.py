...
# Used permutation '100010110', which corresponds to 'HLLLHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'