...
# Used permutation '1011011100', which corresponds to 'HLHHLHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'