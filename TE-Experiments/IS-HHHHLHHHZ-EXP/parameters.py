...
# Used permutation '111101112', which corresponds to 'HHHHLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'