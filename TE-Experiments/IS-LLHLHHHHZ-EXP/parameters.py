...
# Used permutation '001011112', which corresponds to 'LLHLHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'