...
# Used permutation '1010011100', which corresponds to 'HLHLLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'