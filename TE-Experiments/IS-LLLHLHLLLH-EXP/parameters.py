...
# Used permutation '0001010001', which corresponds to 'LLLHLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'