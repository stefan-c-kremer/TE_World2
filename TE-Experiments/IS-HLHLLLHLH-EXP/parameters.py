...
# Used permutation '101000101', which corresponds to 'HLHLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'