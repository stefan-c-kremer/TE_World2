...
# Used permutation '100111111', which corresponds to 'HLLHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'