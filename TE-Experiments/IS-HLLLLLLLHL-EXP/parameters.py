...
# Used permutation '1000000010', which corresponds to 'HLLLLLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'