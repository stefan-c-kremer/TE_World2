...
# Used permutation '1000000010', which corresponds to 'HLLLLLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'