...
# Used permutation '1001110100', which corresponds to 'HLLHHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'