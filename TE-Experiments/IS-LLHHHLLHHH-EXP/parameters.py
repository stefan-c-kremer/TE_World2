...
# Used permutation '0011100111', which corresponds to 'LLHHHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'