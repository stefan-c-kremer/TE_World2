...
# Used permutation '0111100110', which corresponds to 'LHHHHLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'