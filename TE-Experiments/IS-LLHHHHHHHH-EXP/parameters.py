...
# Used permutation '0011111111', which corresponds to 'LLHHHHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'