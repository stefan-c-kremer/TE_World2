...
# Used permutation '010010001', which corresponds to 'LHLLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'