...
# Used permutation '1100001000', which corresponds to 'HHLLLLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'