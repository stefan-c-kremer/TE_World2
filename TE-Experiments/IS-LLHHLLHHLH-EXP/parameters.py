...
# Used permutation '0011001101', which corresponds to 'LLHHLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'