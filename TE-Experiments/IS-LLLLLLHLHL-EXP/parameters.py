...
# Used permutation '0000001010', which corresponds to 'LLLLLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'