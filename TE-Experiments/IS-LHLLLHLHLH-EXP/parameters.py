...
# Used permutation '0100010101', which corresponds to 'LHLLLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'