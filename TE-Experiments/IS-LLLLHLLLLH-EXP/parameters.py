...
# Used permutation '0000100001', which corresponds to 'LLLLHLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'