...
# Used permutation '111001012', which corresponds to 'HHHLLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'