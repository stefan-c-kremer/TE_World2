...
# Used permutation '000101102', which corresponds to 'LLLHLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'