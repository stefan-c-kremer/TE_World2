...
# Used permutation '011101111', which corresponds to 'LHHHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'