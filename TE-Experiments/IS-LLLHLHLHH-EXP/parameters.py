...
# Used permutation '000101011', which corresponds to 'LLLHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'