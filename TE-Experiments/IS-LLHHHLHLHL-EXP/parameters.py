...
# Used permutation '0011101010', which corresponds to 'LLHHHLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'