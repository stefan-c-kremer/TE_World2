...
# Used permutation '1100001110', which corresponds to 'HHLLLLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'