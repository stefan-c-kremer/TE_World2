...
# Used permutation '010101001', which corresponds to 'LHLHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'