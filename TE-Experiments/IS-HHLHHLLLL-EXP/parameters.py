...
# Used permutation '110110000', which corresponds to 'HHLHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'