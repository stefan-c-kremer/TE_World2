...
# Used permutation '1101111010', which corresponds to 'HHLHHHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'