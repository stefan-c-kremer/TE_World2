...
# Used permutation '101110001', which corresponds to 'HLHHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'