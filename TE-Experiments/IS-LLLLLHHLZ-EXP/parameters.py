...
# Used permutation '000001102', which corresponds to 'LLLLLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'