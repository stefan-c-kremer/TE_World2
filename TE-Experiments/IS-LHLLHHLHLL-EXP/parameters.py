...
# Used permutation '0100110100', which corresponds to 'LHLLHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'