...
# Used permutation '0011110011', which corresponds to 'LLHHHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'