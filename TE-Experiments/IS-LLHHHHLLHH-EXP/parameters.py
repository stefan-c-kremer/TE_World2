...
# Used permutation '0011110011', which corresponds to 'LLHHHHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'