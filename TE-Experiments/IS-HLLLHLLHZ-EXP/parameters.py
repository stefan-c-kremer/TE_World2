...
# Used permutation '100010012', which corresponds to 'HLLLHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'