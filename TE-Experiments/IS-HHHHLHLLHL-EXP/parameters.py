...
# Used permutation '1111010010', which corresponds to 'HHHHLHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'