...
# Used permutation '1101100000', which corresponds to 'HHLHHLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'