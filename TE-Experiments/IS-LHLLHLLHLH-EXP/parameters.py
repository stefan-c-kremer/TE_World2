...
# Used permutation '0100100101', which corresponds to 'LHLLHLLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'