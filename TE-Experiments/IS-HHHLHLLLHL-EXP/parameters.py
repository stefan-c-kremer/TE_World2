...
# Used permutation '1110100010', which corresponds to 'HHHLHLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'