...
# Used permutation '0101110000', which corresponds to 'LHLHHHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'