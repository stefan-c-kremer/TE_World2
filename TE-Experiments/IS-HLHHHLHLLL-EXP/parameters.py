...
# Used permutation '1011101000', which corresponds to 'HLHHHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'