...
# Used permutation '0001001110', which corresponds to 'LLLHLLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'