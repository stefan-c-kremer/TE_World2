...
# Used permutation '1001001011', which corresponds to 'HLLHLLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'