...
# Used permutation '0100111000', which corresponds to 'LHLLHHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'