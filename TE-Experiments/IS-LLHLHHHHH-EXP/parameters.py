...
# Used permutation '001011111', which corresponds to 'LLHLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'