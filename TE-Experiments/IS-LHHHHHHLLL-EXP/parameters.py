...
# Used permutation '0111111000', which corresponds to 'LHHHHHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'