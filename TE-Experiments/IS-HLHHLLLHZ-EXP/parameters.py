...
# Used permutation '101100012', which corresponds to 'HLHHLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'