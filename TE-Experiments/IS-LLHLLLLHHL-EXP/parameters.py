...
# Used permutation '0010000110', which corresponds to 'LLHLLLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'