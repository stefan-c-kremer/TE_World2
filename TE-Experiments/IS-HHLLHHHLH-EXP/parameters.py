...
# Used permutation '110011101', which corresponds to 'HHLLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'