...
# Used permutation '1001110011', which corresponds to 'HLLHHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'