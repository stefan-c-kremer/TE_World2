...
# Used permutation '1011010001', which corresponds to 'HLHHLHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'