...
# Used permutation '0010111000', which corresponds to 'LLHLHHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'