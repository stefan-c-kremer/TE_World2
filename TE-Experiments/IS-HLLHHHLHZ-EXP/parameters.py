...
# Used permutation '100111012', which corresponds to 'HLLHHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'