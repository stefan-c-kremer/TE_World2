...
# Used permutation '000111011', which corresponds to 'LLLHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'