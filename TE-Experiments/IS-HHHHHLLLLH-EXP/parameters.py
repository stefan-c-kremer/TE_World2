...
# Used permutation '1111100001', which corresponds to 'HHHHHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'