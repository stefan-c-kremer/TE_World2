...
# Used permutation '000011011', which corresponds to 'LLLLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'