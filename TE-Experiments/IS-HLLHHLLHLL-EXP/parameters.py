...
# Used permutation '1001100100', which corresponds to 'HLLHHLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'