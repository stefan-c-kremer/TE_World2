...
# Used permutation '1101001001', which corresponds to 'HHLHLLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'