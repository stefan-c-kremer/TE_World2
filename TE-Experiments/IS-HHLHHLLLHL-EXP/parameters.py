...
# Used permutation '1101100010', which corresponds to 'HHLHHLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'