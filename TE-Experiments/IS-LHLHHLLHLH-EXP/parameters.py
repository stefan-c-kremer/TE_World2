...
# Used permutation '0101100101', which corresponds to 'LHLHHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'