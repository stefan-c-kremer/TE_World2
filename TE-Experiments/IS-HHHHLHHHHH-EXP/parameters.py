...
# Used permutation '1111011111', which corresponds to 'HHHHLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'