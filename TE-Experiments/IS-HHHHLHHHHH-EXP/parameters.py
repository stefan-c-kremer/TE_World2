...
# Used permutation '1111011111', which corresponds to 'HHHHLHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'