...
# Used permutation '000010100', which corresponds to 'LLLLHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'