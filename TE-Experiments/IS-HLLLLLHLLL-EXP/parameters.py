...
# Used permutation '1000001000', which corresponds to 'HLLLLLHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'