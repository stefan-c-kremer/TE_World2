...
# Used permutation '010000101', which corresponds to 'LHLLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'