...
# Used permutation '001010010', which corresponds to 'LLHLHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'