...
# Used permutation '1110101011', which corresponds to 'HHHLHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'