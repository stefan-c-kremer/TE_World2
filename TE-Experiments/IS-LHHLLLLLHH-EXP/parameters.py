...
# Used permutation '0110000011', which corresponds to 'LHHLLLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'