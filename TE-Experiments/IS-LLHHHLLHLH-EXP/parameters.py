...
# Used permutation '0011100101', which corresponds to 'LLHHHLLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'