...
# Used permutation '100101001', which corresponds to 'HLLHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'