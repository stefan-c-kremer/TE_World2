...
# Used permutation '001110010', which corresponds to 'LLHHHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'