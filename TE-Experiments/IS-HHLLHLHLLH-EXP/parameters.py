...
# Used permutation '1100101001', which corresponds to 'HHLLHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'