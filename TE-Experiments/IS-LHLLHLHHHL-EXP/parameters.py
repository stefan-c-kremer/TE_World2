...
# Used permutation '0100101110', which corresponds to 'LHLLHLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'