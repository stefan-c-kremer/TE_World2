...
# Used permutation '0010111111', which corresponds to 'LLHLHHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'