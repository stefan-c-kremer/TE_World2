...
# Used permutation '1001010100', which corresponds to 'HLLHLHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'