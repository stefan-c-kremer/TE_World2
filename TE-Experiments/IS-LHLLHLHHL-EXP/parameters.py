...
# Used permutation '010010110', which corresponds to 'LHLLHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'