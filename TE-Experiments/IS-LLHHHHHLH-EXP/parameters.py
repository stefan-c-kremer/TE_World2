...
# Used permutation '001111101', which corresponds to 'LLHHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'