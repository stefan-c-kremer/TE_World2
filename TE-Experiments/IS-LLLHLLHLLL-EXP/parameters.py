...
# Used permutation '0001001000', which corresponds to 'LLLHLLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'