...
# Used permutation '000011002', which corresponds to 'LLLLHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'