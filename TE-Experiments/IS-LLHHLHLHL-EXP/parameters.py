...
# Used permutation '001101010', which corresponds to 'LLHHLHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'