...
# Used permutation '1111010111', which corresponds to 'HHHHLHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'