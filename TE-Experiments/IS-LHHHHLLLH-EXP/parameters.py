...
# Used permutation '011110001', which corresponds to 'LHHHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'