...
# Used permutation '1101110111', which corresponds to 'HHLHHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'