...
# Used permutation '001101101', which corresponds to 'LLHHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'