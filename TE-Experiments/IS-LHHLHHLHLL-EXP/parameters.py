...
# Used permutation '0110110100', which corresponds to 'LHHLHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'