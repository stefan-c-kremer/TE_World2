...
# Used permutation '0000000111', which corresponds to 'LLLLLLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'