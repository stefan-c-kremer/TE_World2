...
# Used permutation '011111111', which corresponds to 'LHHHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'