...
# Used permutation '000001111', which corresponds to 'LLLLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'