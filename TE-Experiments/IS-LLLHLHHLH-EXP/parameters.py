...
# Used permutation '000101101', which corresponds to 'LLLHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'