...
# Used permutation '001101012', which corresponds to 'LLHHLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'