...
# Used permutation '1001000000', which corresponds to 'HLLHLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'