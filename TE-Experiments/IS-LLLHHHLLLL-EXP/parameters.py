...
# Used permutation '0001110000', which corresponds to 'LLLHHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'