...
# Used permutation '010010011', which corresponds to 'LHLLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'