...
# Used permutation '0101010010', which corresponds to 'LHLHLHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'