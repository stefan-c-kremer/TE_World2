...
# Used permutation '1110100001', which corresponds to 'HHHLHLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'