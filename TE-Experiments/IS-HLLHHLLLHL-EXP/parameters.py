...
# Used permutation '1001100010', which corresponds to 'HLLHHLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'