...
# Used permutation '1010010100', which corresponds to 'HLHLLHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'