...
# Used permutation '0101101101', which corresponds to 'LHLHHLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'