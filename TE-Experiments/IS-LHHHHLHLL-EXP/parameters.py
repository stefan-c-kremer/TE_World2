...
# Used permutation '011110100', which corresponds to 'LHHHHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'