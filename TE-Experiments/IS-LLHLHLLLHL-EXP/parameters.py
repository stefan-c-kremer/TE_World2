...
# Used permutation '0010100010', which corresponds to 'LLHLHLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'