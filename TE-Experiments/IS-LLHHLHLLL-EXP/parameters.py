...
# Used permutation '001101000', which corresponds to 'LLHHLHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'