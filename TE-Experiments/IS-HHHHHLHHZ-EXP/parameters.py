...
# Used permutation '111110112', which corresponds to 'HHHHHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'