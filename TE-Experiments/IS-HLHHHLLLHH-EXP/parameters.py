...
# Used permutation '1011100011', which corresponds to 'HLHHHLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'