...
# Used permutation '1110110110', which corresponds to 'HHHLHHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'