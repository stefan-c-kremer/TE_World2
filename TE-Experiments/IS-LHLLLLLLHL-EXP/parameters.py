...
# Used permutation '0100000010', which corresponds to 'LHLLLLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'