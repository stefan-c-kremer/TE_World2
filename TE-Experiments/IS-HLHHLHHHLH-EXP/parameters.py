...
# Used permutation '1011011101', which corresponds to 'HLHHLHHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'