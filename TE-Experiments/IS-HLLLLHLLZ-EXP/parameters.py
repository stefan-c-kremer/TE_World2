...
# Used permutation '100001002', which corresponds to 'HLLLLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'