...
# Used permutation '1111111101', which corresponds to 'HHHHHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'