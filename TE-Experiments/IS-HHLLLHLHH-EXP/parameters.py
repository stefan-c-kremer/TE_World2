...
# Used permutation '110001011', which corresponds to 'HHLLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'