...
# Used permutation '0010011001', which corresponds to 'LLHLLHHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'