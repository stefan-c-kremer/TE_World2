...
# Used permutation '110110111', which corresponds to 'HHLHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'