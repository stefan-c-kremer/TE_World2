...
# Used permutation '111111002', which corresponds to 'HHHHHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'