...
# Used permutation '0111101001', which corresponds to 'LHHHHLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'