...
# Used permutation '1100000000', which corresponds to 'HHLLLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'