...
# Used permutation '111111110', which corresponds to 'HHHHHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'