...
# Used permutation '1000101010', which corresponds to 'HLLLHLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'