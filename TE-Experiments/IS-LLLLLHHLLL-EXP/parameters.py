...
# Used permutation '0000011000', which corresponds to 'LLLLLHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'