...
# Used permutation '101001002', which corresponds to 'HLHLLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'