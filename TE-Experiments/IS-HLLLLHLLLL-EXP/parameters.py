...
# Used permutation '1000010000', which corresponds to 'HLLLLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'