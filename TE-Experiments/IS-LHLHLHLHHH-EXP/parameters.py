...
# Used permutation '0101010111', which corresponds to 'LHLHLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'