...
# Used permutation '001001112', which corresponds to 'LLHLLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'