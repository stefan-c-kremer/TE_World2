...
# Used permutation '0001001111', which corresponds to 'LLLHLLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'