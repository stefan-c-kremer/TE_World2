...
# Used permutation '1011000011', which corresponds to 'HLHHLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'