...
# Used permutation '001001012', which corresponds to 'LLHLLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'