...
# Used permutation '1111101110', which corresponds to 'HHHHHLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'