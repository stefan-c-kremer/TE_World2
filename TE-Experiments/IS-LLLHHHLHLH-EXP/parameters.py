...
# Used permutation '0001110101', which corresponds to 'LLLHHHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'