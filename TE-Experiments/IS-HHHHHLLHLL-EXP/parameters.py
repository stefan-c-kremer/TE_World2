...
# Used permutation '1111100100', which corresponds to 'HHHHHLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'