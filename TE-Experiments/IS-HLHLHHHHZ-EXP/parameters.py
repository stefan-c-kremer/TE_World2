...
# Used permutation '101011112', which corresponds to 'HLHLHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'