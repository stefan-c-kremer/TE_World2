...
# Used permutation '110010102', which corresponds to 'HHLLHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'