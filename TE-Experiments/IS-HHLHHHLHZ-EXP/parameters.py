...
# Used permutation '110111012', which corresponds to 'HHLHHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'