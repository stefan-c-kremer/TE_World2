...
# Used permutation '000010112', which corresponds to 'LLLLHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'