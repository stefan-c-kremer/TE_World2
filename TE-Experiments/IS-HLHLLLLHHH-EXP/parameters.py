...
# Used permutation '1010000111', which corresponds to 'HLHLLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'