...
# Used permutation '1001011000', which corresponds to 'HLLHLHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'