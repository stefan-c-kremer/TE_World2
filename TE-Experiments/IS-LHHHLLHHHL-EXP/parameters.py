...
# Used permutation '0111001110', which corresponds to 'LHHHLLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'