...
# Used permutation '011110112', which corresponds to 'LHHHHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'