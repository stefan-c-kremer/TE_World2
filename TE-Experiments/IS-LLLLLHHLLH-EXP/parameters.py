...
# Used permutation '0000011001', which corresponds to 'LLLLLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'