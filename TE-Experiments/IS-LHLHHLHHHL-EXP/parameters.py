...
# Used permutation '0101101110', which corresponds to 'LHLHHLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'