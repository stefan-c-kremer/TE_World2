...
# Used permutation '001101001', which corresponds to 'LLHHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'