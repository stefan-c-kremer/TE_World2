...
# Used permutation '001011012', which corresponds to 'LLHLHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'