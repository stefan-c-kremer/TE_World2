...
# Used permutation '111001110', which corresponds to 'HHHLLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'