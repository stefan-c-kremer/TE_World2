...
# Used permutation '000110002', which corresponds to 'LLLHHLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'