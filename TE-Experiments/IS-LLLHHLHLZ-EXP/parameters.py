...
# Used permutation '000110102', which corresponds to 'LLLHHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'