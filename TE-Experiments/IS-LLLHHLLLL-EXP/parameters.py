...
# Used permutation '000110000', which corresponds to 'LLLHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'