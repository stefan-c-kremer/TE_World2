...
# Used permutation '1100010011', which corresponds to 'HHLLLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'