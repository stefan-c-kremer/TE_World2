...
# Used permutation '100000002', which corresponds to 'HLLLLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'