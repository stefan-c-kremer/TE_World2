...
# Used permutation '101000110', which corresponds to 'HLHLLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'