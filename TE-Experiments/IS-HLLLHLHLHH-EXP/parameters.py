...
# Used permutation '1000101011', which corresponds to 'HLLLHLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'