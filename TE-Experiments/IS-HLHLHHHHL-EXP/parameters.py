...
# Used permutation '101011110', which corresponds to 'HLHLHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'