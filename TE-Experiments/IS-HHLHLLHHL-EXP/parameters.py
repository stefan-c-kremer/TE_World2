...
# Used permutation '110100110', which corresponds to 'HHLHLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'