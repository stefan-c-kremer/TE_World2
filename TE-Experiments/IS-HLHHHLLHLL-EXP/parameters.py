...
# Used permutation '1011100100', which corresponds to 'HLHHHLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'