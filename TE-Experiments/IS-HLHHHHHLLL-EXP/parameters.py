...
# Used permutation '1011111000', which corresponds to 'HLHHHHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'