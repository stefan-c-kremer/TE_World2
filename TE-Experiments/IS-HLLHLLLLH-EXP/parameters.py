...
# Used permutation '100100001', which corresponds to 'HLLHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'