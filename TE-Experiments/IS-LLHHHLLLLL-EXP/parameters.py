...
# Used permutation '0011100000', which corresponds to 'LLHHHLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'