...
# Used permutation '1100101000', which corresponds to 'HHLLHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'