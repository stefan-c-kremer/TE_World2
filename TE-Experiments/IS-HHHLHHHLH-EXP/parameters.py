...
# Used permutation '111011101', which corresponds to 'HHHLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'