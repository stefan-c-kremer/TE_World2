...
# Used permutation '1100111101', which corresponds to 'HHLLHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'