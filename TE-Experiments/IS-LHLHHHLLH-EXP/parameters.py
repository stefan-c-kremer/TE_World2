...
# Used permutation '010111001', which corresponds to 'LHLHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'