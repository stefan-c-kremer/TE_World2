...
# Used permutation '1001010001', which corresponds to 'HLLHLHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'