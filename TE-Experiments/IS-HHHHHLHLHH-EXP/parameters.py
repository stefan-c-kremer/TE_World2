...
# Used permutation '1111101011', which corresponds to 'HHHHHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'