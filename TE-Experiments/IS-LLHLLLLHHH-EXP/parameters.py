...
# Used permutation '0010000111', which corresponds to 'LLHLLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'