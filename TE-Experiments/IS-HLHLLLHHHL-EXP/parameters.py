...
# Used permutation '1010001110', which corresponds to 'HLHLLLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'