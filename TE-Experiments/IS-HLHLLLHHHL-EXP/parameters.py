...
# Used permutation '1010001110', which corresponds to 'HLHLLLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'