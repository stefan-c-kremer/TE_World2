...
# Used permutation '1010101011', which corresponds to 'HLHLHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'