...
# Used permutation '0101101001', which corresponds to 'LHLHHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'