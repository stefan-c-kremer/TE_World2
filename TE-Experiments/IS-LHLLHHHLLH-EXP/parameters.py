...
# Used permutation '0100111001', which corresponds to 'LHLLHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'