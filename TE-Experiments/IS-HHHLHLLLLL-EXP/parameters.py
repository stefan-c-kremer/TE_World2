...
# Used permutation '1110100000', which corresponds to 'HHHLHLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'