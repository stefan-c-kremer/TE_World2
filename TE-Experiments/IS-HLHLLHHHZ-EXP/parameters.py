...
# Used permutation '101001112', which corresponds to 'HLHLLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'