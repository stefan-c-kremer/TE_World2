...
# Used permutation '1011111101', which corresponds to 'HLHHHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'