...
# Used permutation '0111100001', which corresponds to 'LHHHHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'