...
# Used permutation '0101000000', which corresponds to 'LHLHLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'