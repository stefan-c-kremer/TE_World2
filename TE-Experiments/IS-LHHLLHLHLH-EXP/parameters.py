...
# Used permutation '0110010101', which corresponds to 'LHHLLHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'