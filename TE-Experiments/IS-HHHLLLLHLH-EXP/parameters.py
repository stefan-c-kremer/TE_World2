...
# Used permutation '1110000101', which corresponds to 'HHHLLLLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'