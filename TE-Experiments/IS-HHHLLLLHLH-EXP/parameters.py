...
# Used permutation '1110000101', which corresponds to 'HHHLLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'