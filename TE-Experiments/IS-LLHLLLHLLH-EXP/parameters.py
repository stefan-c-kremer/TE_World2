...
# Used permutation '0010001001', which corresponds to 'LLHLLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'