...
# Used permutation '1100011000', which corresponds to 'HHLLLHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'