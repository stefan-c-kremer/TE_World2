...
# Used permutation '001100111', which corresponds to 'LLHHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'