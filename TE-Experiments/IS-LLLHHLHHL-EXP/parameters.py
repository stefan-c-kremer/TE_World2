...
# Used permutation '000110110', which corresponds to 'LLLHHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'