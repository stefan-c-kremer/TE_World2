...
# Used permutation '011100101', which corresponds to 'LHHHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'