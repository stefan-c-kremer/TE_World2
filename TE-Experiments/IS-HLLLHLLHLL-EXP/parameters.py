...
# Used permutation '1000100100', which corresponds to 'HLLLHLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'