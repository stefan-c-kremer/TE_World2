...
# Used permutation '1010101000', which corresponds to 'HLHLHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'