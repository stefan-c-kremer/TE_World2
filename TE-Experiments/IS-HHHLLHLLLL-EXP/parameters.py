...
# Used permutation '1110010000', which corresponds to 'HHHLLHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'