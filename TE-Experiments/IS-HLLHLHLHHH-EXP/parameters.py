...
# Used permutation '1001010111', which corresponds to 'HLLHLHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'