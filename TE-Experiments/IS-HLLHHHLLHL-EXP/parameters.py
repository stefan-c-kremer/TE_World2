...
# Used permutation '1001110010', which corresponds to 'HLLHHHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'