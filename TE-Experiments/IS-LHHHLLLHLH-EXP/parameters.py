...
# Used permutation '0111000101', which corresponds to 'LHHHLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'