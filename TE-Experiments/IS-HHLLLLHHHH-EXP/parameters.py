...
# Used permutation '1100001111', which corresponds to 'HHLLLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'