...
# Used permutation '011101000', which corresponds to 'LHHHLHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'