...
# Used permutation '0010011100', which corresponds to 'LLHLLHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'