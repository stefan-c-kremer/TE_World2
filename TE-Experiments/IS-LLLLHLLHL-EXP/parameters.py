...
# Used permutation '000010010', which corresponds to 'LLLLHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'