...
# Used permutation '1100110010', which corresponds to 'HHLLHHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'