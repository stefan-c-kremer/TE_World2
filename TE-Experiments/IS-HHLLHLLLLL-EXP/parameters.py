...
# Used permutation '1100100000', which corresponds to 'HHLLHLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'