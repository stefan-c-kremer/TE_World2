...
# Used permutation '1010001100', which corresponds to 'HLHLLLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'