...
# Used permutation '0110101111', which corresponds to 'LHHLHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'