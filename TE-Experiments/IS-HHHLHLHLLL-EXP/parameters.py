...
# Used permutation '1110101000', which corresponds to 'HHHLHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'