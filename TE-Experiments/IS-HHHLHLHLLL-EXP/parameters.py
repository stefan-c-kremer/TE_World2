...
# Used permutation '1110101000', which corresponds to 'HHHLHLHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'