...
# Used permutation '1100010100', which corresponds to 'HHLLLHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'