...
# Used permutation '110110101', which corresponds to 'HHLHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'