...
# Used permutation '1100011100', which corresponds to 'HHLLLHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'