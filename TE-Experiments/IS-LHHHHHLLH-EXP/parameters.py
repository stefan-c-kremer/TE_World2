...
# Used permutation '011111001', which corresponds to 'LHHHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'