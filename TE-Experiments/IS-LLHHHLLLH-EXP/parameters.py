...
# Used permutation '001110001', which corresponds to 'LLHHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'