...
# Used permutation '1010101001', which corresponds to 'HLHLHLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'