...
# Used permutation '001111102', which corresponds to 'LLHHHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'