...
# Used permutation '1101011011', which corresponds to 'HHLHLHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'