...
# Used permutation '1100110111', which corresponds to 'HHLLHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'