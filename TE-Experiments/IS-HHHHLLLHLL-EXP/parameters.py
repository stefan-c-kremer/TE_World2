...
# Used permutation '1111000100', which corresponds to 'HHHHLLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'