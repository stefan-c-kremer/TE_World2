...
# Used permutation '1110001000', which corresponds to 'HHHLLLHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'