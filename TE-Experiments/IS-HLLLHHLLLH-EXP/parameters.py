...
# Used permutation '1000110001', which corresponds to 'HLLLHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'