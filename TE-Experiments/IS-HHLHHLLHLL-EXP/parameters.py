...
# Used permutation '1101100100', which corresponds to 'HHLHHLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'