...
# Used permutation '011101002', which corresponds to 'LHHHLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'