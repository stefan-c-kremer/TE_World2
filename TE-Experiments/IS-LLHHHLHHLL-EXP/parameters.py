...
# Used permutation '0011101100', which corresponds to 'LLHHHLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'