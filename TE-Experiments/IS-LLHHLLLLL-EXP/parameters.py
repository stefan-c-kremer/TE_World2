...
# Used permutation '001100000', which corresponds to 'LLHHLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'