...
# Used permutation '110101000', which corresponds to 'HHLHLHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'