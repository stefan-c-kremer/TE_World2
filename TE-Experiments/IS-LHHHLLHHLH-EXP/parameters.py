...
# Used permutation '0111001101', which corresponds to 'LHHHLLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'