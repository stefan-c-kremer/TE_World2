...
# Used permutation '1011110000', which corresponds to 'HLHHHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'