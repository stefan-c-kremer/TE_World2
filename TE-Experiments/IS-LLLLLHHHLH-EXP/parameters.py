...
# Used permutation '0000011101', which corresponds to 'LLLLLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'