...
# Used permutation '0101101100', which corresponds to 'LHLHHLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'