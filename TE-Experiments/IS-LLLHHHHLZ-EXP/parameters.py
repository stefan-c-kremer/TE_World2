...
# Used permutation '000111102', which corresponds to 'LLLHHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'