...
# Used permutation '1110011001', which corresponds to 'HHHLLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'