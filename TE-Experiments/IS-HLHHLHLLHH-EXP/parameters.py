...
# Used permutation '1011010011', which corresponds to 'HLHHLHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'