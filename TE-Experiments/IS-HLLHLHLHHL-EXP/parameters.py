...
# Used permutation '1001010110', which corresponds to 'HLLHLHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'