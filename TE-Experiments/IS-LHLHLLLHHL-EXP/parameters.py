...
# Used permutation '0101000110', which corresponds to 'LHLHLLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'