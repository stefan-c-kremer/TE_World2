...
# Used permutation '0100110111', which corresponds to 'LHLLHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'