...
# Used permutation '0010010101', which corresponds to 'LLHLLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'