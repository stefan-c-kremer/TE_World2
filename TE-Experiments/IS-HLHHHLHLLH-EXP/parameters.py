...
# Used permutation '1011101001', which corresponds to 'HLHHHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'