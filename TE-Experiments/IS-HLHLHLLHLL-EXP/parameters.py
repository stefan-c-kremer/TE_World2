...
# Used permutation '1010100100', which corresponds to 'HLHLHLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'