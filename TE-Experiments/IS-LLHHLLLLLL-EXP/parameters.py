...
# Used permutation '0011000000', which corresponds to 'LLHHLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'