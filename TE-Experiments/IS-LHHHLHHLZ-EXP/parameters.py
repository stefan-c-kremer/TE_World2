...
# Used permutation '011101102', which corresponds to 'LHHHLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'