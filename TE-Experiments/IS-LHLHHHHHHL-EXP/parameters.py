...
# Used permutation '0101111110', which corresponds to 'LHLHHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'