...
# Used permutation '1010100001', which corresponds to 'HLHLHLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'