...
# Used permutation '010100001', which corresponds to 'LHLHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'