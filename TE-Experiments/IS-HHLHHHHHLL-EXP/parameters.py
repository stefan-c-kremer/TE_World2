...
# Used permutation '1101111100', which corresponds to 'HHLHHHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'