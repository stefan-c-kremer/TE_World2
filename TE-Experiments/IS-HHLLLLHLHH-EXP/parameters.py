...
# Used permutation '1100001011', which corresponds to 'HHLLLLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'