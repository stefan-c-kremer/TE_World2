...
# Used permutation '0000101010', which corresponds to 'LLLLHLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'