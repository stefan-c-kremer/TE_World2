...
# Used permutation '001011100', which corresponds to 'LLHLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'