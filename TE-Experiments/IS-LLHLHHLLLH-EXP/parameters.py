...
# Used permutation '0010110001', which corresponds to 'LLHLHHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'