...
# Used permutation '010101111', which corresponds to 'LHLHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'