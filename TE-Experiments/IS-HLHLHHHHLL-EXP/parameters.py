...
# Used permutation '1010111100', which corresponds to 'HLHLHHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'