...
# Used permutation '1101001101', which corresponds to 'HHLHLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'