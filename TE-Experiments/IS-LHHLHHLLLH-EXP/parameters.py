...
# Used permutation '0110110001', which corresponds to 'LHHLHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'