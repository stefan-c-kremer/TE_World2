...
# Used permutation '101011001', which corresponds to 'HLHLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'