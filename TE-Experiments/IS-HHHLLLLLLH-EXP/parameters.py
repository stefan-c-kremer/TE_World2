...
# Used permutation '1110000001', which corresponds to 'HHHLLLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'