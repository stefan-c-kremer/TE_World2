...
# Used permutation '1101110101', which corresponds to 'HHLHHHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'