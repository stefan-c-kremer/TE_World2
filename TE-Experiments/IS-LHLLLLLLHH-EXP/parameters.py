...
# Used permutation '0100000011', which corresponds to 'LHLLLLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'