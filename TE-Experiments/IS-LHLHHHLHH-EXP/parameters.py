...
# Used permutation '010111011', which corresponds to 'LHLHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'