...
# Used permutation '1000010001', which corresponds to 'HLLLLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'