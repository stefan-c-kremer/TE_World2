...
# Used permutation '0111101111', which corresponds to 'LHHHHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'