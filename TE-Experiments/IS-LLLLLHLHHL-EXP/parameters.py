...
# Used permutation '0000010110', which corresponds to 'LLLLLHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'