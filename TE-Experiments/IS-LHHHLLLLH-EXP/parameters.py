...
# Used permutation '011100001', which corresponds to 'LHHHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'