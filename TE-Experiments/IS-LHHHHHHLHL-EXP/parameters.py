...
# Used permutation '0111111010', which corresponds to 'LHHHHHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'