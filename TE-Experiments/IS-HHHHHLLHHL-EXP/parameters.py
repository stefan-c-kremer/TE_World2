...
# Used permutation '1111100110', which corresponds to 'HHHHHLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'