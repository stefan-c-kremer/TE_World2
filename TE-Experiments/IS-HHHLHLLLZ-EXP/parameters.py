...
# Used permutation '111010002', which corresponds to 'HHHLHLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'