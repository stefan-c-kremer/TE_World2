...
# Used permutation '0010001010', which corresponds to 'LLHLLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'