...
# Used permutation '011010011', which corresponds to 'LHHLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'