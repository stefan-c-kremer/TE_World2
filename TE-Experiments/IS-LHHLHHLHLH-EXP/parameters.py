...
# Used permutation '0110110101', which corresponds to 'LHHLHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'