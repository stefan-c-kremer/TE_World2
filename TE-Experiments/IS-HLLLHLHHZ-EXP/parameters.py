...
# Used permutation '100010112', which corresponds to 'HLLLHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'