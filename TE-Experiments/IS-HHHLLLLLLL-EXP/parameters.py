...
# Used permutation '1110000000', which corresponds to 'HHHLLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'