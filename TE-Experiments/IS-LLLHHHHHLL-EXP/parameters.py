...
# Used permutation '0001111100', which corresponds to 'LLLHHHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'