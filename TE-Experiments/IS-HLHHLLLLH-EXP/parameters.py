...
# Used permutation '101100001', which corresponds to 'HLHHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'