...
# Used permutation '011000101', which corresponds to 'LHHLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'