...
# Used permutation '1111111001', which corresponds to 'HHHHHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'