...
# Used permutation '0111000100', which corresponds to 'LHHHLLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'