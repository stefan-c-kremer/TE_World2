...
# Used permutation '0100100100', which corresponds to 'LHLLHLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'