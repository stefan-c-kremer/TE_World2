...
# Used permutation '111011100', which corresponds to 'HHHLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'