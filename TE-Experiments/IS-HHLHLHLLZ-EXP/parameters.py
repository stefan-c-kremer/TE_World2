...
# Used permutation '110101002', which corresponds to 'HHLHLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'