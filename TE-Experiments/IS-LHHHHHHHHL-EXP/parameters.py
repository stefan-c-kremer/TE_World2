...
# Used permutation '0111111110', which corresponds to 'LHHHHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'