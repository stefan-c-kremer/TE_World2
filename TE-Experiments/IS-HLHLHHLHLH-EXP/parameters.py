...
# Used permutation '1010110101', which corresponds to 'HLHLHHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'