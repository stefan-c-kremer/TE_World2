...
# Used permutation '0001011010', which corresponds to 'LLLHLHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'