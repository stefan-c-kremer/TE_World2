...
# Used permutation '000001100', which corresponds to 'LLLLLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'