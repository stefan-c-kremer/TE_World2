...
# Used permutation '011110000', which corresponds to 'LHHHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'