...
# Used permutation '0111100111', which corresponds to 'LHHHHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'