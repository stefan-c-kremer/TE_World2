...
# Used permutation '1000000110', which corresponds to 'HLLLLLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'