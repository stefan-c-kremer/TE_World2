...
# Used permutation '1110001001', which corresponds to 'HHHLLLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'