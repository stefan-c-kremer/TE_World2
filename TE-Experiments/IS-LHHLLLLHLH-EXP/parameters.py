...
# Used permutation '0110000101', which corresponds to 'LHHLLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'