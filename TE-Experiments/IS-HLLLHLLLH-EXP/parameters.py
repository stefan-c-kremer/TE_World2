...
# Used permutation '100010001', which corresponds to 'HLLLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'