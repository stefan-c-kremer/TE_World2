...
# Used permutation '101101011', which corresponds to 'HLHHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'