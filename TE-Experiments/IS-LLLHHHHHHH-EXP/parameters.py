...
# Used permutation '0001111111', which corresponds to 'LLLHHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'