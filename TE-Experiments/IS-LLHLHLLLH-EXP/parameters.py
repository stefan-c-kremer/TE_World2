...
# Used permutation '001010001', which corresponds to 'LLHLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'