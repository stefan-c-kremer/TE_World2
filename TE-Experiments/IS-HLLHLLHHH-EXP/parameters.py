...
# Used permutation '100100111', which corresponds to 'HLLHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'