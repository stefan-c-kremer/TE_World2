...
# Used permutation '0011001010', which corresponds to 'LLHHLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'