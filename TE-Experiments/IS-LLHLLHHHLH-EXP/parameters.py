...
# Used permutation '0010011101', which corresponds to 'LLHLLHHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'