...
# Used permutation '100101010', which corresponds to 'HLLHLHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'