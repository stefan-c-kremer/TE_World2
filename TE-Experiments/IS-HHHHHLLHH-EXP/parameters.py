...
# Used permutation '111110011', which corresponds to 'HHHHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'