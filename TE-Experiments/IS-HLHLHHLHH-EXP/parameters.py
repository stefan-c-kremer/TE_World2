...
# Used permutation '101011011', which corresponds to 'HLHLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'