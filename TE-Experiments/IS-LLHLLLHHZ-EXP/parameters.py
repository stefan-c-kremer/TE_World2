...
# Used permutation '001000112', which corresponds to 'LLHLLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'