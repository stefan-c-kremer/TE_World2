...
# Used permutation '111101011', which corresponds to 'HHHHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'