...
# Used permutation '101110101', which corresponds to 'HLHHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'