...
# Used permutation '0010111010', which corresponds to 'LLHLHHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'