...
# Used permutation '111011012', which corresponds to 'HHHLHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'