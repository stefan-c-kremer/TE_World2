...
# Used permutation '1001000101', which corresponds to 'HLLHLLLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'