...
# Used permutation '0110011010', which corresponds to 'LHHLLHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'