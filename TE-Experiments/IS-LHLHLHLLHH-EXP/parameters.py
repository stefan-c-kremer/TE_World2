...
# Used permutation '0101010011', which corresponds to 'LHLHLHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'