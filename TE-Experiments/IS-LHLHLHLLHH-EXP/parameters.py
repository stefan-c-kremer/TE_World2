...
# Used permutation '0101010011', which corresponds to 'LHLHLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'