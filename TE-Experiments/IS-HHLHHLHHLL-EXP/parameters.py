...
# Used permutation '1101101100', which corresponds to 'HHLHHLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'