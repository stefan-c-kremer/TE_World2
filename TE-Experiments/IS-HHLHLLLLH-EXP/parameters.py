...
# Used permutation '110100001', which corresponds to 'HHLHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'