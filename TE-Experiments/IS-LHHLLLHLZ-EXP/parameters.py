...
# Used permutation '011000102', which corresponds to 'LHHLLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'