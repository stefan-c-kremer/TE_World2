...
# Used permutation '0010101001', which corresponds to 'LLHLHLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'