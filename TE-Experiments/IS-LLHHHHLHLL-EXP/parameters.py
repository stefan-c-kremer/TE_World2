...
# Used permutation '0011110100', which corresponds to 'LLHHHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'