...
# Used permutation '0100011011', which corresponds to 'LHLLLHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'