...
# Used permutation '1001111000', which corresponds to 'HLLHHHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'