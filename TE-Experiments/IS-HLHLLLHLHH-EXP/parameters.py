...
# Used permutation '1010001011', which corresponds to 'HLHLLLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'