...
# Used permutation '001011102', which corresponds to 'LLHLHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'