...
# Used permutation '1101110010', which corresponds to 'HHLHHHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'