...
# Used permutation '100001011', which corresponds to 'HLLLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'