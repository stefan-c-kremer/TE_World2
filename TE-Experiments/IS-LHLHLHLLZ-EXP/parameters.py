...
# Used permutation '010101002', which corresponds to 'LHLHLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'