...
# Used permutation '0100001010', which corresponds to 'LHLLLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'