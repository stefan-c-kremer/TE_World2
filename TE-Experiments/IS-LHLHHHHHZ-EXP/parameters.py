...
# Used permutation '010111112', which corresponds to 'LHLHHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'