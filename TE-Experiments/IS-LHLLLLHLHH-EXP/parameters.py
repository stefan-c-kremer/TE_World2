...
# Used permutation '0100001011', which corresponds to 'LHLLLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'