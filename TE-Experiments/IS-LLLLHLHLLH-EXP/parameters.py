...
# Used permutation '0000101001', which corresponds to 'LLLLHLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'