...
# Used permutation '1101000000', which corresponds to 'HHLHLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'