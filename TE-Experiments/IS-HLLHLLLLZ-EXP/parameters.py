...
# Used permutation '100100002', which corresponds to 'HLLHLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'