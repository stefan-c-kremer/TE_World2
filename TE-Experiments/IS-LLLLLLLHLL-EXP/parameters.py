...
# Used permutation '0000000100', which corresponds to 'LLLLLLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'