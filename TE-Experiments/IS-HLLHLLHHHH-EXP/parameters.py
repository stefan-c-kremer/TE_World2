...
# Used permutation '1001001111', which corresponds to 'HLLHLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'