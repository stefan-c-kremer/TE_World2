...
# Used permutation '0101001111', which corresponds to 'LHLHLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'