...
# Used permutation '1011000111', which corresponds to 'HLHHLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'