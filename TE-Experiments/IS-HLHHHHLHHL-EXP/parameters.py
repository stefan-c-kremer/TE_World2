...
# Used permutation '1011110110', which corresponds to 'HLHHHHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'