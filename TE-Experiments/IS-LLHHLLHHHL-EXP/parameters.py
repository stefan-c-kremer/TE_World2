...
# Used permutation '0011001110', which corresponds to 'LLHHLLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'