...
# Used permutation '111000011', which corresponds to 'HHHLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'