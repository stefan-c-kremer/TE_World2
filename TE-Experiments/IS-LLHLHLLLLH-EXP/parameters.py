...
# Used permutation '0010100001', which corresponds to 'LLHLHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'