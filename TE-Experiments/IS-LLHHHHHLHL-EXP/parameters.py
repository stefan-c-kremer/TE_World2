...
# Used permutation '0011111010', which corresponds to 'LLHHHHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'