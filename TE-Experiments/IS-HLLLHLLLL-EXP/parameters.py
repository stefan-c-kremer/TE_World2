...
# Used permutation '100010000', which corresponds to 'HLLLHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'