...
# Used permutation '1001101010', which corresponds to 'HLLHHLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'