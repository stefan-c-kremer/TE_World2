...
# Used permutation '010011100', which corresponds to 'LHLLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'