...
# Used permutation '101111011', which corresponds to 'HLHHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'