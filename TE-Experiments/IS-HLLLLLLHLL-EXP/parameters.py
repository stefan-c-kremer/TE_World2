...
# Used permutation '1000000100', which corresponds to 'HLLLLLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'