...
# Used permutation '1110111000', which corresponds to 'HHHLHHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'