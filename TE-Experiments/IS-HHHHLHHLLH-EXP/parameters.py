...
# Used permutation '1111011001', which corresponds to 'HHHHLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'