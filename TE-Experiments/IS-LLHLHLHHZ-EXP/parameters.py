...
# Used permutation '001010112', which corresponds to 'LLHLHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'