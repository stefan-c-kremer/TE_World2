...
# Used permutation '1110000110', which corresponds to 'HHHLLLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'