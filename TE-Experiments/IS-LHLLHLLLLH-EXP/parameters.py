...
# Used permutation '0100100001', which corresponds to 'LHLLHLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'