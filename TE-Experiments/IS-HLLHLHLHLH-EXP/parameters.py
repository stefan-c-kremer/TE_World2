...
# Used permutation '1001010101', which corresponds to 'HLLHLHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'