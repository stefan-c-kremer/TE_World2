...
# Used permutation '0100101101', which corresponds to 'LHLLHLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'