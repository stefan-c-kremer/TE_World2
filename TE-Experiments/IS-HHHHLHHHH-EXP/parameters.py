...
# Used permutation '111101111', which corresponds to 'HHHHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'