...
# Used permutation '011110012', which corresponds to 'LHHHHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'