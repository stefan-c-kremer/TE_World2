...
# Used permutation '010011112', which corresponds to 'LHLLHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'