...
# Used permutation '1111111110', which corresponds to 'HHHHHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'