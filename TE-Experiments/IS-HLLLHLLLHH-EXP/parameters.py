...
# Used permutation '1000100011', which corresponds to 'HLLLHLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'