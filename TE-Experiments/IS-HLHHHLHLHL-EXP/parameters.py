...
# Used permutation '1011101010', which corresponds to 'HLHHHLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'