...
# Used permutation '111000010', which corresponds to 'HHHLLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'