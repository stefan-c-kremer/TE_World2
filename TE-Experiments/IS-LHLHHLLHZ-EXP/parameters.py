...
# Used permutation '010110012', which corresponds to 'LHLHHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'