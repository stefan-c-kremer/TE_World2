...
# Used permutation '1011110111', which corresponds to 'HLHHHHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'