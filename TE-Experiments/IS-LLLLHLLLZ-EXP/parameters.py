...
# Used permutation '000010002', which corresponds to 'LLLLHLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'