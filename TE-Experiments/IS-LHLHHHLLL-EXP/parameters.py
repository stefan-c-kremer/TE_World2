...
# Used permutation '010111000', which corresponds to 'LHLHHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'