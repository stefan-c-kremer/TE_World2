...
# Used permutation '1110100111', which corresponds to 'HHHLHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'