...
# Used permutation '0100100000', which corresponds to 'LHLLHLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'