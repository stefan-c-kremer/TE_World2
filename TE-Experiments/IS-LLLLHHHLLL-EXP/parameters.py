...
# Used permutation '0000111000', which corresponds to 'LLLLHHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'