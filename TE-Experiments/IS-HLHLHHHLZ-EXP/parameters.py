...
# Used permutation '101011102', which corresponds to 'HLHLHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'