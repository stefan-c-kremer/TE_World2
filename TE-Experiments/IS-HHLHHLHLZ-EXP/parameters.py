...
# Used permutation '110110102', which corresponds to 'HHLHHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'