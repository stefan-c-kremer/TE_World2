...
# Used permutation '0110101101', which corresponds to 'LHHLHLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'