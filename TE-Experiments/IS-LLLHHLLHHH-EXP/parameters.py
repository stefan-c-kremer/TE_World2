...
# Used permutation '0001100111', which corresponds to 'LLLHHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'