...
# Used permutation '1011010000', which corresponds to 'HLHHLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'