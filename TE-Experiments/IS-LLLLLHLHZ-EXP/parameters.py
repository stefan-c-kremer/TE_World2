...
# Used permutation '000001012', which corresponds to 'LLLLLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'