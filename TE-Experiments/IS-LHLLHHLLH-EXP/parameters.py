...
# Used permutation '010011001', which corresponds to 'LHLLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'