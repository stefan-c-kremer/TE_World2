...
# Used permutation '001010101', which corresponds to 'LLHLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'