...
# Used permutation '0000111010', which corresponds to 'LLLLHHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'