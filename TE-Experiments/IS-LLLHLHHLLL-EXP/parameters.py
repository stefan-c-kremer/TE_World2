...
# Used permutation '0001011000', which corresponds to 'LLLHLHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'