...
# Used permutation '0111110101', which corresponds to 'LHHHHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'