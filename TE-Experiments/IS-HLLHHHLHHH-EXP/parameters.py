...
# Used permutation '1001110111', which corresponds to 'HLLHHHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'