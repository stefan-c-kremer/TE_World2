...
# Used permutation '110010110', which corresponds to 'HHLLHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'