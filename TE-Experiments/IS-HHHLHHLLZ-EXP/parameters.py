...
# Used permutation '111011002', which corresponds to 'HHHLHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'