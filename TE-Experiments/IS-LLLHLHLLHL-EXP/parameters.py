...
# Used permutation '0001010010', which corresponds to 'LLLHLHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'