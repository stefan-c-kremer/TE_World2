...
# Used permutation '0100011111', which corresponds to 'LHLLLHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'