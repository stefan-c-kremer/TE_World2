...
# Used permutation '1011100101', which corresponds to 'HLHHHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'