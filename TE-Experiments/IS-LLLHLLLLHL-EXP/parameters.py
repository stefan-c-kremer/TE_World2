...
# Used permutation '0001000010', which corresponds to 'LLLHLLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'