...
# Used permutation '1111010011', which corresponds to 'HHHHLHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'