...
# Used permutation '0001110111', which corresponds to 'LLLHHHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'