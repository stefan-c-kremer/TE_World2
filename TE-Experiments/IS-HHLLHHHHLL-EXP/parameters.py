...
# Used permutation '1100111100', which corresponds to 'HHLLHHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'