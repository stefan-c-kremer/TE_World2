...
# Used permutation '1010011011', which corresponds to 'HLHLLHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'