...
# Used permutation '0101100011', which corresponds to 'LHLHHLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'