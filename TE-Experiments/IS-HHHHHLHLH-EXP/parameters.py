...
# Used permutation '111110101', which corresponds to 'HHHHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'