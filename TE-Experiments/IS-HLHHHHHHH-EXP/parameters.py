...
# Used permutation '101111111', which corresponds to 'HLHHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'