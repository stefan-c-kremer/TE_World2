...
# Used permutation '0000010000', which corresponds to 'LLLLLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'