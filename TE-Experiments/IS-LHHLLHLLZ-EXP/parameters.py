...
# Used permutation '011001002', which corresponds to 'LHHLLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'