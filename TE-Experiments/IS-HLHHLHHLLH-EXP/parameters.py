...
# Used permutation '1011011001', which corresponds to 'HLHHLHHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'