...
# Used permutation '100000112', which corresponds to 'HLLLLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'