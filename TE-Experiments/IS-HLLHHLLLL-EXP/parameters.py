...
# Used permutation '100110000', which corresponds to 'HLLHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'