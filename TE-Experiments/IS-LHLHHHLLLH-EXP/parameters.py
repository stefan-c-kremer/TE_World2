...
# Used permutation '0101110001', which corresponds to 'LHLHHHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'