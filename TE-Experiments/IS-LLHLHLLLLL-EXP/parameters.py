...
# Used permutation '0010100000', which corresponds to 'LLHLHLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'