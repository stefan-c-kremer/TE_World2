...
# Used permutation '0011010001', which corresponds to 'LLHHLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'