...
# Used permutation '010101110', which corresponds to 'LHLHLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'