...
# Used permutation '001110000', which corresponds to 'LLHHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'