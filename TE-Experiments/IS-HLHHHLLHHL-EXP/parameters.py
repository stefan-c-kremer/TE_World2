...
# Used permutation '1011100110', which corresponds to 'HLHHHLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'