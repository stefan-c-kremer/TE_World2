...
# Used permutation '1100111001', which corresponds to 'HHLLHHHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'