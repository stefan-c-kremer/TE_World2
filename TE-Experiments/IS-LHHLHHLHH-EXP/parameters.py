...
# Used permutation '011011011', which corresponds to 'LHHLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'