...
# Used permutation '1111001100', which corresponds to 'HHHHLLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'