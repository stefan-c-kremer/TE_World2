...
# Used permutation '1000100110', which corresponds to 'HLLLHLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'