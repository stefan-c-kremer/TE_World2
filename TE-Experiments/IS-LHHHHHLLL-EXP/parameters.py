...
# Used permutation '011111000', which corresponds to 'LHHHHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'