...
# Used permutation '1011101110', which corresponds to 'HLHHHLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'