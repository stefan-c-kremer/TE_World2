...
# Used permutation '000010011', which corresponds to 'LLLLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'