...
# Used permutation '101100102', which corresponds to 'HLHHLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'