...
# Used permutation '0001110011', which corresponds to 'LLLHHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'