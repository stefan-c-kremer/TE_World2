...
# Used permutation '110111102', which corresponds to 'HHLHHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'