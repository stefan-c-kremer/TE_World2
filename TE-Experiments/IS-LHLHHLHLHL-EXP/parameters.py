...
# Used permutation '0101101010', which corresponds to 'LHLHHLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'