...
# Used permutation '100001001', which corresponds to 'HLLLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'