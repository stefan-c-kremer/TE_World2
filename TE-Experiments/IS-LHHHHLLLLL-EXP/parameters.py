...
# Used permutation '0111100000', which corresponds to 'LHHHHLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'