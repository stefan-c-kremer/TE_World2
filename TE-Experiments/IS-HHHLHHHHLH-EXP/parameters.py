...
# Used permutation '1110111101', which corresponds to 'HHHLHHHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'