...
# Used permutation '0100010100', which corresponds to 'LHLLLHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'