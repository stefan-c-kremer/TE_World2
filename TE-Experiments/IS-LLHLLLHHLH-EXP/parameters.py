...
# Used permutation '0010001101', which corresponds to 'LLHLLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'