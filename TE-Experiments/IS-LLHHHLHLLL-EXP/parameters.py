...
# Used permutation '0011101000', which corresponds to 'LLHHHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'