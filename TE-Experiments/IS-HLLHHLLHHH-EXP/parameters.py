...
# Used permutation '1001100111', which corresponds to 'HLLHHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'