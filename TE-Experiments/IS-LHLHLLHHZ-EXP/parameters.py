...
# Used permutation '010100112', which corresponds to 'LHLHLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'