...
# Used permutation '0100110011', which corresponds to 'LHLLHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'