...
# Used permutation '000111012', which corresponds to 'LLLHHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'