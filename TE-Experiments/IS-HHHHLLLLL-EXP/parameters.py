...
# Used permutation '111100000', which corresponds to 'HHHHLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'