...
# Used permutation '1110011000', which corresponds to 'HHHLLHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'