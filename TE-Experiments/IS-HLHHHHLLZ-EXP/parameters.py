...
# Used permutation '101111002', which corresponds to 'HLHHHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'