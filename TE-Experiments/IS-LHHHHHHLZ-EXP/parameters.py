...
# Used permutation '011111102', which corresponds to 'LHHHHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'