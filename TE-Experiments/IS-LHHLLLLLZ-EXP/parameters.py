...
# Used permutation '011000002', which corresponds to 'LHHLLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'