...
# Used permutation '1000101110', which corresponds to 'HLLLHLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'