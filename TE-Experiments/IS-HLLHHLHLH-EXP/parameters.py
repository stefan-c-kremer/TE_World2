...
# Used permutation '100110101', which corresponds to 'HLLHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'