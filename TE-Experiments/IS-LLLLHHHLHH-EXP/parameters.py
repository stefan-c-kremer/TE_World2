...
# Used permutation '0000111011', which corresponds to 'LLLLHHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'