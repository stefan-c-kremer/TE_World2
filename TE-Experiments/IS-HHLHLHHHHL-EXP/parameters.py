...
# Used permutation '1101011110', which corresponds to 'HHLHLHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'