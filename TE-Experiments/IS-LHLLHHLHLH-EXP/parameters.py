...
# Used permutation '0100110101', which corresponds to 'LHLLHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'