...
# Used permutation '100010011', which corresponds to 'HLLLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'