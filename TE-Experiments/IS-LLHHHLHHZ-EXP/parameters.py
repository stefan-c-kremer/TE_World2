...
# Used permutation '001110112', which corresponds to 'LLHHHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'