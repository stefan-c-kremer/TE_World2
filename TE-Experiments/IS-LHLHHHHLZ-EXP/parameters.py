...
# Used permutation '010111102', which corresponds to 'LHLHHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'