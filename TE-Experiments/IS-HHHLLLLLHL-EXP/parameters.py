...
# Used permutation '1110000010', which corresponds to 'HHHLLLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'