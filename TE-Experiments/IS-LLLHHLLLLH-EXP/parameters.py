...
# Used permutation '0001100001', which corresponds to 'LLLHHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'