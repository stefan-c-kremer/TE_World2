...
# Used permutation '0001100001', which corresponds to 'LLLHHLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'