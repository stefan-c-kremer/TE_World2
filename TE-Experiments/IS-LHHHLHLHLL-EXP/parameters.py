...
# Used permutation '0111010100', which corresponds to 'LHHHLHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'