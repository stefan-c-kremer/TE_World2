...
# Used permutation '1111100011', which corresponds to 'HHHHHLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'