...
# Used permutation '1110100100', which corresponds to 'HHHLHLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'