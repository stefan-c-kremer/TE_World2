...
# Used permutation '0010001000', which corresponds to 'LLHLLLHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'