...
# Used permutation '1000011001', which corresponds to 'HLLLLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'