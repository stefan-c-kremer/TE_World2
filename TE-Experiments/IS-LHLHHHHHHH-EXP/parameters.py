...
# Used permutation '0101111111', which corresponds to 'LHLHHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'