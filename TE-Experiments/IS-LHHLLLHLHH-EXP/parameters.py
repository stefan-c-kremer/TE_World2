...
# Used permutation '0110001011', which corresponds to 'LHHLLLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'