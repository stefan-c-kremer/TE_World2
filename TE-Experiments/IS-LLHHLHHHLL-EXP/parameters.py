...
# Used permutation '0011011100', which corresponds to 'LLHHLHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'