...
# Used permutation '0100011100', which corresponds to 'LHLLLHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'