...
# Used permutation '0100011100', which corresponds to 'LHLLLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'