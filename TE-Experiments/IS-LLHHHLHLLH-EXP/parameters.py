...
# Used permutation '0011101001', which corresponds to 'LLHHHLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'