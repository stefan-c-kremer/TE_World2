...
# Used permutation '1100011001', which corresponds to 'HHLLLHHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'