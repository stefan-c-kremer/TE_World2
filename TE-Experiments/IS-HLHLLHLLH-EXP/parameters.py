...
# Used permutation '101001001', which corresponds to 'HLHLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'