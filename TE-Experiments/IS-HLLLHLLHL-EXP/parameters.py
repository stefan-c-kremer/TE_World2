...
# Used permutation '100010010', which corresponds to 'HLLLHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'