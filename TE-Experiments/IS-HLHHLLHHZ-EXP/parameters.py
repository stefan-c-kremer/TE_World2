...
# Used permutation '101100112', which corresponds to 'HLHHLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'