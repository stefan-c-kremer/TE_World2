...
# Used permutation '0110010001', which corresponds to 'LHHLLHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'