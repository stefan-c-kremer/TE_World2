...
# Used permutation '0111001001', which corresponds to 'LHHHLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'