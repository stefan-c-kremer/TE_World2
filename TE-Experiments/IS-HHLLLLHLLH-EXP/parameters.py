...
# Used permutation '1100001001', which corresponds to 'HHLLLLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'