...
# Used permutation '0101111100', which corresponds to 'LHLHHHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'