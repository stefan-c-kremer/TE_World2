...
# Used permutation '0000100100', which corresponds to 'LLLLHLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'