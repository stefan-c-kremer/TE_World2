...
# Used permutation '101011000', which corresponds to 'HLHLHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'