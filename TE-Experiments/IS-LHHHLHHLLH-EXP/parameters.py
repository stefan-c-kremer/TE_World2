...
# Used permutation '0111011001', which corresponds to 'LHHHLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'