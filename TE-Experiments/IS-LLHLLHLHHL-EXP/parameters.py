...
# Used permutation '0010010110', which corresponds to 'LLHLLHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'