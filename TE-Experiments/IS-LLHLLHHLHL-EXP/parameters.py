...
# Used permutation '0010011010', which corresponds to 'LLHLLHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'