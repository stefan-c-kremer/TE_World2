...
# Used permutation '111110000', which corresponds to 'HHHHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'