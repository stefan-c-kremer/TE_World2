...
# Used permutation '111100112', which corresponds to 'HHHHLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'