...
# Used permutation '100010101', which corresponds to 'HLLLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'