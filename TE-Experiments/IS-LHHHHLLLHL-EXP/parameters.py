...
# Used permutation '0111100010', which corresponds to 'LHHHHLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'