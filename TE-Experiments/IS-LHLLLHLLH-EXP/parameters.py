...
# Used permutation '010001001', which corresponds to 'LHLLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'