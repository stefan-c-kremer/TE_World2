...
# Used permutation '0000001001', which corresponds to 'LLLLLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'