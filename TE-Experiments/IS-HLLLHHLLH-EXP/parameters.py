...
# Used permutation '100011001', which corresponds to 'HLLLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'