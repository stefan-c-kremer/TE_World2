...
# Used permutation '1100000001', which corresponds to 'HHLLLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'