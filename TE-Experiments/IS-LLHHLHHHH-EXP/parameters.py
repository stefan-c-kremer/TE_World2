...
# Used permutation '001101111', which corresponds to 'LLHHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'