...
# Used permutation '0000010011', which corresponds to 'LLLLLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'