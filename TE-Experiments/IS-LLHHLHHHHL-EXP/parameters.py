...
# Used permutation '0011011110', which corresponds to 'LLHHLHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'