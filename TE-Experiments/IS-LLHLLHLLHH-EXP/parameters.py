...
# Used permutation '0010010011', which corresponds to 'LLHLLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'