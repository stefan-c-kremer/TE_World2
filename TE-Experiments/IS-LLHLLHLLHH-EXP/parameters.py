...
# Used permutation '0010010011', which corresponds to 'LLHLLHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'