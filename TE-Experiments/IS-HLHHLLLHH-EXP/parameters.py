...
# Used permutation '101100011', which corresponds to 'HLHHLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'