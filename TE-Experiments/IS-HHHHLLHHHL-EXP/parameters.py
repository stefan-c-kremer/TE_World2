...
# Used permutation '1111001110', which corresponds to 'HHHHLLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'