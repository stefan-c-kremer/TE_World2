...
# Used permutation '101010011', which corresponds to 'HLHLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'