...
# Used permutation '1001111101', which corresponds to 'HLLHHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'