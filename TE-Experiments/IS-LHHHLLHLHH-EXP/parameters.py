...
# Used permutation '0111001011', which corresponds to 'LHHHLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'