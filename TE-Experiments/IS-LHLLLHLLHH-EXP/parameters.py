...
# Used permutation '0100010011', which corresponds to 'LHLLLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'