...
# Used permutation '100000111', which corresponds to 'HLLLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'