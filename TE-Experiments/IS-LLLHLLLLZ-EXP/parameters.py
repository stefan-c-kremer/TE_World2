...
# Used permutation '000100002', which corresponds to 'LLLHLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'