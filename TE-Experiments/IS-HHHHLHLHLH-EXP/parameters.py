...
# Used permutation '1111010101', which corresponds to 'HHHHLHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'