...
# Used permutation '001000000', which corresponds to 'LLHLLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'