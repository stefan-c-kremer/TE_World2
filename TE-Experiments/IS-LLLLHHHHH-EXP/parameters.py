...
# Used permutation '000011111', which corresponds to 'LLLLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'