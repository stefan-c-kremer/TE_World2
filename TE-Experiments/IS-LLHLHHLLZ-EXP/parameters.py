...
# Used permutation '001011002', which corresponds to 'LLHLHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'