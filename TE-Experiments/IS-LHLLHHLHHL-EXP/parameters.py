...
# Used permutation '0100110110', which corresponds to 'LHLLHHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'