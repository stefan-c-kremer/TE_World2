...
# Used permutation '0101001101', which corresponds to 'LHLHLLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'