...
# Used permutation '0101001101', which corresponds to 'LHLHLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'