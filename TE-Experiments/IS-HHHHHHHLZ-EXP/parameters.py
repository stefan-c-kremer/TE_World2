...
# Used permutation '111111102', which corresponds to 'HHHHHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'