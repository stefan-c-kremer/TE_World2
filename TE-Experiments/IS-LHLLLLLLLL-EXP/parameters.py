...
# Used permutation '0100000000', which corresponds to 'LHLLLLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'