...
# Used permutation '011101012', which corresponds to 'LHHHLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'