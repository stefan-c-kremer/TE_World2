...
# Used permutation '1001001001', which corresponds to 'HLLHLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'