...
# Used permutation '1001010010', which corresponds to 'HLLHLHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'