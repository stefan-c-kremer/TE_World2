...
# Used permutation '1101010111', which corresponds to 'HHLHLHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'