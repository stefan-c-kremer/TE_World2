...
# Used permutation '011011001', which corresponds to 'LHHLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'