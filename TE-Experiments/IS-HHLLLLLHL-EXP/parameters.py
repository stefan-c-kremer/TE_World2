...
# Used permutation '110000010', which corresponds to 'HHLLLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'