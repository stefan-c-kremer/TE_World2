...
# Used permutation '0110001000', which corresponds to 'LHHLLLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'