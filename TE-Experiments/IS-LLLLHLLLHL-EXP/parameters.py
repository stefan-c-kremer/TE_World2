...
# Used permutation '0000100010', which corresponds to 'LLLLHLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'