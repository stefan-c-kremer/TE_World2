...
# Used permutation '0100100010', which corresponds to 'LHLLHLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'