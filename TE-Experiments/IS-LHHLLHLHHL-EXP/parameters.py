...
# Used permutation '0110010110', which corresponds to 'LHHLLHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'