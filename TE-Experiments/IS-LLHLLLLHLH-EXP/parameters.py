...
# Used permutation '0010000101', which corresponds to 'LLHLLLLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'