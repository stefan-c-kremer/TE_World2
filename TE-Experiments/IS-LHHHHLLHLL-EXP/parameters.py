...
# Used permutation '0111100100', which corresponds to 'LHHHHLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'