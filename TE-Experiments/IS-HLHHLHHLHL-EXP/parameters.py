...
# Used permutation '1011011010', which corresponds to 'HLHHLHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'