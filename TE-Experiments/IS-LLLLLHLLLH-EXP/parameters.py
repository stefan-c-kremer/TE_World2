...
# Used permutation '0000010001', which corresponds to 'LLLLLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'