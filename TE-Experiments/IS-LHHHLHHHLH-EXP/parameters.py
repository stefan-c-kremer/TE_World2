...
# Used permutation '0111011101', which corresponds to 'LHHHLHHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'