...
# Used permutation '110100100', which corresponds to 'HHLHLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'