...
# Used permutation '0000101110', which corresponds to 'LLLLHLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'