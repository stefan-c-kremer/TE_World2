...
# Used permutation '0101010001', which corresponds to 'LHLHLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'