...
# Used permutation '0100101100', which corresponds to 'LHLLHLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'