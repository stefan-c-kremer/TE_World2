...
# Used permutation '010100110', which corresponds to 'LHLHLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'