...
# Used permutation '1011010110', which corresponds to 'HLHHLHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'