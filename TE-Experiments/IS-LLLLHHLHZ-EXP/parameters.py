...
# Used permutation '000011012', which corresponds to 'LLLLHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'