...
# Used permutation '0101110010', which corresponds to 'LHLHHHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'