...
# Used permutation '1000100001', which corresponds to 'HLLLHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'