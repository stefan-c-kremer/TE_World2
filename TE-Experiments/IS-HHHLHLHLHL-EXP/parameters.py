...
# Used permutation '1110101010', which corresponds to 'HHHLHLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'