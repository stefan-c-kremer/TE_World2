...
# Used permutation '0010011110', which corresponds to 'LLHLLHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'