...
# Used permutation '0100001110', which corresponds to 'LHLLLLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'