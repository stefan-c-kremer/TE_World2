...
# Used permutation '000011110', which corresponds to 'LLLLHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'