...
# Used permutation '100001101', which corresponds to 'HLLLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'