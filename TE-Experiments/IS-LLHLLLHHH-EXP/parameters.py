...
# Used permutation '001000111', which corresponds to 'LLHLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'