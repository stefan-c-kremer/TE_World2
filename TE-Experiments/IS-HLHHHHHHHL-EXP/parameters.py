...
# Used permutation '1011111110', which corresponds to 'HLHHHHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'