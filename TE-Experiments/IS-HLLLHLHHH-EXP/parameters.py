...
# Used permutation '100010111', which corresponds to 'HLLLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'