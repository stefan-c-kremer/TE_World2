...
# Used permutation '0010000010', which corresponds to 'LLHLLLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'