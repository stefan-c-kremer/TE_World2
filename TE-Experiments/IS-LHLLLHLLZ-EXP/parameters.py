...
# Used permutation '010001002', which corresponds to 'LHLLLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'