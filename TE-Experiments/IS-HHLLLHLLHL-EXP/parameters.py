...
# Used permutation '1100010010', which corresponds to 'HHLLLHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'