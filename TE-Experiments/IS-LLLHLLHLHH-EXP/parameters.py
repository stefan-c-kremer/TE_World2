...
# Used permutation '0001001011', which corresponds to 'LLLHLLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'