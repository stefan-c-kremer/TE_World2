...
# Used permutation '1010110010', which corresponds to 'HLHLHHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'