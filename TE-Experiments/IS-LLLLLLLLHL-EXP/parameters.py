...
# Used permutation '0000000010', which corresponds to 'LLLLLLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'