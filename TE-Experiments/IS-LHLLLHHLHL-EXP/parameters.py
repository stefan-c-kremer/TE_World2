...
# Used permutation '0100011010', which corresponds to 'LHLLLHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'