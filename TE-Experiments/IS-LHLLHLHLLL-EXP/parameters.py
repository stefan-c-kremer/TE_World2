...
# Used permutation '0100101000', which corresponds to 'LHLLHLHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'