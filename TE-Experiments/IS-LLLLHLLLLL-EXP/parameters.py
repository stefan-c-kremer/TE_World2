...
# Used permutation '0000100000', which corresponds to 'LLLLHLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'