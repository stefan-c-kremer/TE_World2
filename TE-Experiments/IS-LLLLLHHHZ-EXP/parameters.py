...
# Used permutation '000001112', which corresponds to 'LLLLLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'