...
# Used permutation '1001101100', which corresponds to 'HLLHHLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'