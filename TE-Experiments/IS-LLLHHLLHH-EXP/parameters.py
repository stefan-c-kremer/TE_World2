...
# Used permutation '000110011', which corresponds to 'LLLHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'