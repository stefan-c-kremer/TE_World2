...
# Used permutation '0001000101', which corresponds to 'LLLHLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'