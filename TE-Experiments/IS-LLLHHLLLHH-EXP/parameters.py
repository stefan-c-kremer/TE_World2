...
# Used permutation '0001100011', which corresponds to 'LLLHHLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'