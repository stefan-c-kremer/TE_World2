...
# Used permutation '1010110110', which corresponds to 'HLHLHHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'