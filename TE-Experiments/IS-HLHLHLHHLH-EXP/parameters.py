...
# Used permutation '1010101101', which corresponds to 'HLHLHLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'