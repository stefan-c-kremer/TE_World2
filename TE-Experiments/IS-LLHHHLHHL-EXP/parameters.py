...
# Used permutation '001110110', which corresponds to 'LLHHHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'