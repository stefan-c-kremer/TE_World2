...
# Used permutation '0110101000', which corresponds to 'LHHLHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'