...
# Used permutation '1001110000', which corresponds to 'HLLHHHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'