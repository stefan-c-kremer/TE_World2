...
# Used permutation '111011110', which corresponds to 'HHHLHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'