...
# Used permutation '1101001000', which corresponds to 'HHLHLLHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'