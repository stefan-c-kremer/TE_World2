...
# Used permutation '110111001', which corresponds to 'HHLHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'