...
# Used permutation '011010101', which corresponds to 'LHHLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'