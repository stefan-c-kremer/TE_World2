...
# Used permutation '1101101000', which corresponds to 'HHLHHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'