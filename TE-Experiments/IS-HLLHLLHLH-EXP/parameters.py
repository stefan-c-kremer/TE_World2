...
# Used permutation '100100101', which corresponds to 'HLLHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'