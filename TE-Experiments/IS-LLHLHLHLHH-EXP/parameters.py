...
# Used permutation '0010101011', which corresponds to 'LLHLHLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'