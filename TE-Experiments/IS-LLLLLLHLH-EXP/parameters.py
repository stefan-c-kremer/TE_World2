...
# Used permutation '000000101', which corresponds to 'LLLLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'