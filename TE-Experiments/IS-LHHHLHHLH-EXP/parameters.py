...
# Used permutation '011101101', which corresponds to 'LHHHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'