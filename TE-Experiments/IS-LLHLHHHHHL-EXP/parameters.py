...
# Used permutation '0010111110', which corresponds to 'LLHLHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'