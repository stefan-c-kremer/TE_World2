...
# Used permutation '1001101011', which corresponds to 'HLLHHLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'