...
# Used permutation '1100111010', which corresponds to 'HHLLHHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'