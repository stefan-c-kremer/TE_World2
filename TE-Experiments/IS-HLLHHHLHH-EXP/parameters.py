...
# Used permutation '100111011', which corresponds to 'HLLHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'