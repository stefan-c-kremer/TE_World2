...
# Used permutation '0001011111', which corresponds to 'LLLHLHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'