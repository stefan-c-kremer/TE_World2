...
# Used permutation '100011002', which corresponds to 'HLLLHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'