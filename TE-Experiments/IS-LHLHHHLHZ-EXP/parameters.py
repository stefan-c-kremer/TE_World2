...
# Used permutation '010111012', which corresponds to 'LHLHHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'