...
# Used permutation '1000111010', which corresponds to 'HLLLHHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'