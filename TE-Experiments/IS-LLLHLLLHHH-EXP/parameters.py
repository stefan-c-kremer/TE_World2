...
# Used permutation '0001000111', which corresponds to 'LLLHLLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'