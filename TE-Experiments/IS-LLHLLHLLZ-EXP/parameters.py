...
# Used permutation '001001002', which corresponds to 'LLHLLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'