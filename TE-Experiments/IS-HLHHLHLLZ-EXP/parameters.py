...
# Used permutation '101101002', which corresponds to 'HLHHLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'