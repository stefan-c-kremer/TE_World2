...
# Used permutation '111110012', which corresponds to 'HHHHHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'