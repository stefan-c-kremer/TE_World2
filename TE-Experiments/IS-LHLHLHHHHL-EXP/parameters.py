...
# Used permutation '0101011110', which corresponds to 'LHLHLHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'