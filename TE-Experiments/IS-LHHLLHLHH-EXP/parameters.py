...
# Used permutation '011001011', which corresponds to 'LHHLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'