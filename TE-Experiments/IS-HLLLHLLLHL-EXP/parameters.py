...
# Used permutation '1000100010', which corresponds to 'HLLLHLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'