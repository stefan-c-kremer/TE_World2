...
# Used permutation '110101011', which corresponds to 'HHLHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'