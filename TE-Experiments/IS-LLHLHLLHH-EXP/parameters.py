...
# Used permutation '001010011', which corresponds to 'LLHLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'