...
# Used permutation '1110011101', which corresponds to 'HHHLLHHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'