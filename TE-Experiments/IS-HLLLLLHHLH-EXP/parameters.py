...
# Used permutation '1000001101', which corresponds to 'HLLLLLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'