...
# Used permutation '1001000111', which corresponds to 'HLLHLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'