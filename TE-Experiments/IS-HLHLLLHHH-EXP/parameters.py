...
# Used permutation '101000111', which corresponds to 'HLHLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'