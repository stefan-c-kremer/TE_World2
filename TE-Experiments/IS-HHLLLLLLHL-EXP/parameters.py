...
# Used permutation '1100000010', which corresponds to 'HHLLLLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'