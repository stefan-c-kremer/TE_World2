...
# Used permutation '1100110011', which corresponds to 'HHLLHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'