...
# Used permutation '0110101100', which corresponds to 'LHHLHLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'