...
# Used permutation '111100001', which corresponds to 'HHHHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'