...
# Used permutation '1100110101', which corresponds to 'HHLLHHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'