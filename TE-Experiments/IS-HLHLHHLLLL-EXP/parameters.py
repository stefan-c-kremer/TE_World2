...
# Used permutation '1010110000', which corresponds to 'HLHLHHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'