...
# Used permutation '000100101', which corresponds to 'LLLHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'