...
# Used permutation '1010001101', which corresponds to 'HLHLLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'