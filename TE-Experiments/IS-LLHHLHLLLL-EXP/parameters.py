...
# Used permutation '0011010000', which corresponds to 'LLHHLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'