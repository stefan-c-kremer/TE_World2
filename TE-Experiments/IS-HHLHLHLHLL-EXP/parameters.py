...
# Used permutation '1101010100', which corresponds to 'HHLHLHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'