...
# Used permutation '110011000', which corresponds to 'HHLLHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'