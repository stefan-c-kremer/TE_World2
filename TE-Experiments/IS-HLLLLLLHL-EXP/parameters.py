...
# Used permutation '100000010', which corresponds to 'HLLLLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'