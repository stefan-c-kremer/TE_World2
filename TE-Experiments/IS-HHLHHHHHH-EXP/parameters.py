...
# Used permutation '110111111', which corresponds to 'HHLHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'