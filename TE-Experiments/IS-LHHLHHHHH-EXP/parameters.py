...
# Used permutation '011011111', which corresponds to 'LHHLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'