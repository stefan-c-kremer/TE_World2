...
# Used permutation '0011101101', which corresponds to 'LLHHHLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'