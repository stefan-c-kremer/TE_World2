...
# Used permutation '000010111', which corresponds to 'LLLLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'