...
# Used permutation '0011110101', which corresponds to 'LLHHHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'