...
# Used permutation '111101001', which corresponds to 'HHHHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'