...
# Used permutation '1000110010', which corresponds to 'HLLLHHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'