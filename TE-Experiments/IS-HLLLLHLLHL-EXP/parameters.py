...
# Used permutation '1000010010', which corresponds to 'HLLLLHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'