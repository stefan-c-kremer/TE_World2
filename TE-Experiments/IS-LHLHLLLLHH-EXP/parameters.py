...
# Used permutation '0101000011', which corresponds to 'LHLHLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'