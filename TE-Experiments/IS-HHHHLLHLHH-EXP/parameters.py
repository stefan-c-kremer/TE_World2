...
# Used permutation '1111001011', which corresponds to 'HHHHLLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'