...
# Used permutation '001101112', which corresponds to 'LLHHLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'