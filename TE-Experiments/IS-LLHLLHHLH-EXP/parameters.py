...
# Used permutation '001001101', which corresponds to 'LLHLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'