...
# Used permutation '1010111111', which corresponds to 'HLHLHHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'