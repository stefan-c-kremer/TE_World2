...
# Used permutation '1011110001', which corresponds to 'HLHHHHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'