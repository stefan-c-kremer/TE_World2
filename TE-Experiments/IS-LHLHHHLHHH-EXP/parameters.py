...
# Used permutation '0101110111', which corresponds to 'LHLHHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'