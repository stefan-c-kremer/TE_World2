...
# Used permutation '0011011000', which corresponds to 'LLHHLHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'