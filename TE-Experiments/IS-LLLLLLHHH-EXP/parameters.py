...
# Used permutation '000000111', which corresponds to 'LLLLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'