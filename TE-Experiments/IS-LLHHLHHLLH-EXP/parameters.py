...
# Used permutation '0011011001', which corresponds to 'LLHHLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'