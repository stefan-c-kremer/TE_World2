...
# Used permutation '0000001000', which corresponds to 'LLLLLLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'