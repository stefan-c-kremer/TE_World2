...
# Used permutation '0110000010', which corresponds to 'LHHLLLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'