...
# Used permutation '010010112', which corresponds to 'LHLLHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'