...
# Used permutation '0111110011', which corresponds to 'LHHHHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'