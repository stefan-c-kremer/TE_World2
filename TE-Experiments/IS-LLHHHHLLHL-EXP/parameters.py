...
# Used permutation '0011110010', which corresponds to 'LLHHHHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'