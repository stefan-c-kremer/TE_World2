...
# Used permutation '011010111', which corresponds to 'LHHLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'