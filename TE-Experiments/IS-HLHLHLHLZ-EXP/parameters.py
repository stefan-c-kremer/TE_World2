...
# Used permutation '101010102', which corresponds to 'HLHLHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'