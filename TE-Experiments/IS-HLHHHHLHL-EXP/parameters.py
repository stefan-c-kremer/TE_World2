...
# Used permutation '101111010', which corresponds to 'HLHHHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'