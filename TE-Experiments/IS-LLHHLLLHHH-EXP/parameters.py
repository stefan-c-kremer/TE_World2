...
# Used permutation '0011000111', which corresponds to 'LLHHLLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'