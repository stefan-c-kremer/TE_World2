...
# Used permutation '0101101011', which corresponds to 'LHLHHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'