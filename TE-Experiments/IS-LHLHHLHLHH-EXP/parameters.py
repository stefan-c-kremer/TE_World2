...
# Used permutation '0101101011', which corresponds to 'LHLHHLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'