...
# Used permutation '101000002', which corresponds to 'HLHLLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'