...
# Used permutation '111000111', which corresponds to 'HHHLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'