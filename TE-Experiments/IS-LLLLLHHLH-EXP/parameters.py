...
# Used permutation '000001101', which corresponds to 'LLLLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'