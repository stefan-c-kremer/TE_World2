...
# Used permutation '0000100011', which corresponds to 'LLLLHLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'