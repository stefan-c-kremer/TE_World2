...
# Used permutation '001011101', which corresponds to 'LLHLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'