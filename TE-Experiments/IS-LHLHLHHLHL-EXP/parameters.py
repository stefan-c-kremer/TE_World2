...
# Used permutation '0101011010', which corresponds to 'LHLHLHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'