...
# Used permutation '1011000001', which corresponds to 'HLHHLLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'