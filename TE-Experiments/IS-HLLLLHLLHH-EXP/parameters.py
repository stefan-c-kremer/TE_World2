...
# Used permutation '1000010011', which corresponds to 'HLLLLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'