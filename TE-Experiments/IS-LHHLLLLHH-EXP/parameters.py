...
# Used permutation '011000011', which corresponds to 'LHHLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'