...
# Used permutation '1110001100', which corresponds to 'HHHLLLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'