...
# Used permutation '1010101111', which corresponds to 'HLHLHLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'