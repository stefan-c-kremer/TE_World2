...
# Used permutation '1011010111', which corresponds to 'HLHHLHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'