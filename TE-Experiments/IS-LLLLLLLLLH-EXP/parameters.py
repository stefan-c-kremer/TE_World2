...
# Used permutation '0000000001', which corresponds to 'LLLLLLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'