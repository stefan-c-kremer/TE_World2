...
# Used permutation '1101010110', which corresponds to 'HHLHLHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'