...
# Used permutation '0110001110', which corresponds to 'LHHLLLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'