...
# Used permutation '0110001110', which corresponds to 'LHHLLLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'