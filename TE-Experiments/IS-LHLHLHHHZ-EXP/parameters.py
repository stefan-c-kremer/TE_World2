...
# Used permutation '010101112', which corresponds to 'LHLHLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'