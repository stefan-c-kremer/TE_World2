...
# Used permutation '0100000110', which corresponds to 'LHLLLLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'