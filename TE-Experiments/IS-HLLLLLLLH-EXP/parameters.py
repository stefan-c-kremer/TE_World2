...
# Used permutation '100000001', which corresponds to 'HLLLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'