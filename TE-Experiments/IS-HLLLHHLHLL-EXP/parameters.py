...
# Used permutation '1000110100', which corresponds to 'HLLLHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'