...
# Used permutation '0101001110', which corresponds to 'LHLHLLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'