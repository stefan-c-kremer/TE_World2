...
# Used permutation '1100000111', which corresponds to 'HHLLLLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'