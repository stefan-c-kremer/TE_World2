...
# Used permutation '0011001001', which corresponds to 'LLHHLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'