...
# Used permutation '0011110000', which corresponds to 'LLHHHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'