...
# Used permutation '0011110000', which corresponds to 'LLHHHHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'