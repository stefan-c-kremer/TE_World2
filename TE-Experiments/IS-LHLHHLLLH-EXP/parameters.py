...
# Used permutation '010110001', which corresponds to 'LHLHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'