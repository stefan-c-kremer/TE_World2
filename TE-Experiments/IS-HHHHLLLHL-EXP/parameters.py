...
# Used permutation '111100010', which corresponds to 'HHHHLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'