...
# Used permutation '1001001101', which corresponds to 'HLLHLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'