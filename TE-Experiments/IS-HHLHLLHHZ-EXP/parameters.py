...
# Used permutation '110100112', which corresponds to 'HHLHLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'