...
# Used permutation '001100101', which corresponds to 'LLHHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'