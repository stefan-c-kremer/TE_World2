...
# Used permutation '010100002', which corresponds to 'LHLHLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'