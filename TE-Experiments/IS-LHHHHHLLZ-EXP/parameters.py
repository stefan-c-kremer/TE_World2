...
# Used permutation '011111002', which corresponds to 'LHHHHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'