...
# Used permutation '011110101', which corresponds to 'LHHHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'