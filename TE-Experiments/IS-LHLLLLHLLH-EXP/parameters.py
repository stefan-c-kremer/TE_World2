...
# Used permutation '0100001001', which corresponds to 'LHLLLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'