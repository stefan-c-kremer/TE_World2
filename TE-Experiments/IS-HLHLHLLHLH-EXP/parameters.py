...
# Used permutation '1010100101', which corresponds to 'HLHLHLLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'