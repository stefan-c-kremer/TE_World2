...
# Used permutation '0010111100', which corresponds to 'LLHLHHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'