...
# Used permutation '1010000101', which corresponds to 'HLHLLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'