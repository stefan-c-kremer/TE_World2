...
# Used permutation '0111000001', which corresponds to 'LHHHLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'