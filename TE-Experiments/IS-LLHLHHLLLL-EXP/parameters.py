...
# Used permutation '0010110000', which corresponds to 'LLHLHHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'