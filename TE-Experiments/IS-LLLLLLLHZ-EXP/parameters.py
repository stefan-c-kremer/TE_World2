...
# Used permutation '000000012', which corresponds to 'LLLLLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'