...
# Used permutation '0011111101', which corresponds to 'LLHHHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'