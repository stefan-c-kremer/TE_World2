...
# Used permutation '011000111', which corresponds to 'LHHLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'