...
# Used permutation '110011111', which corresponds to 'HHLLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'