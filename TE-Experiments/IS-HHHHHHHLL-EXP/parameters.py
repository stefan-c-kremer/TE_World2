...
# Used permutation '111111100', which corresponds to 'HHHHHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'