...
# Used permutation '1010110111', which corresponds to 'HLHLHHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'