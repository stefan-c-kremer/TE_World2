...
# Used permutation '101010111', which corresponds to 'HLHLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'