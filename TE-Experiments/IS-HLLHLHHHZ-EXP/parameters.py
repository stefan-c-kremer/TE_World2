...
# Used permutation '100101112', which corresponds to 'HLLHLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'