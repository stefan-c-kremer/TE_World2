...
# Used permutation '110110012', which corresponds to 'HHLHHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'