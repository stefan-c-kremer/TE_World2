...
# Used permutation '1001111010', which corresponds to 'HLLHHHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'