...
# Used permutation '0100101001', which corresponds to 'LHLLHLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'