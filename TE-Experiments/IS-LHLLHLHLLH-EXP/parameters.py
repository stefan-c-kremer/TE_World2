...
# Used permutation '0100101001', which corresponds to 'LHLLHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'