...
# Used permutation '101100111', which corresponds to 'HLHHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'