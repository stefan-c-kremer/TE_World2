...
# Used permutation '1000001011', which corresponds to 'HLLLLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'