...
# Used permutation '0110010000', which corresponds to 'LHHLLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'