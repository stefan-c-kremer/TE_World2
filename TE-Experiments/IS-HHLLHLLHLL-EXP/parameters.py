...
# Used permutation '1100100100', which corresponds to 'HHLLHLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'