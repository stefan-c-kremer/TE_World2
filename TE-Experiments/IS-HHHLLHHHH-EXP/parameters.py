...
# Used permutation '111001111', which corresponds to 'HHHLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'