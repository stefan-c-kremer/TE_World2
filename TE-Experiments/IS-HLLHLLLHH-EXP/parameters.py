...
# Used permutation '100100011', which corresponds to 'HLLHLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'