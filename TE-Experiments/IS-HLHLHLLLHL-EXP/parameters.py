...
# Used permutation '1010100010', which corresponds to 'HLHLHLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'