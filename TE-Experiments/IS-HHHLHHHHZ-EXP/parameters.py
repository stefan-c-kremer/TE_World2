...
# Used permutation '111011112', which corresponds to 'HHHLHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'