...
# Used permutation '1111001111', which corresponds to 'HHHHLLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'