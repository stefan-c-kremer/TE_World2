...
# Used permutation '1010100011', which corresponds to 'HLHLHLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'