...
# Used permutation '1000010100', which corresponds to 'HLLLLHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'