...
# Used permutation '1010011000', which corresponds to 'HLHLLHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'