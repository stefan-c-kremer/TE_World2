...
# Used permutation '1100011111', which corresponds to 'HHLLLHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'