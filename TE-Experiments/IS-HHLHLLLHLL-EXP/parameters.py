...
# Used permutation '1101000100', which corresponds to 'HHLHLLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'