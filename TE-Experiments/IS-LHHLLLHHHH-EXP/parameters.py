...
# Used permutation '0110001111', which corresponds to 'LHHLLLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'