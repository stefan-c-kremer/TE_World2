...
# Used permutation '1001001000', which corresponds to 'HLLHLLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'