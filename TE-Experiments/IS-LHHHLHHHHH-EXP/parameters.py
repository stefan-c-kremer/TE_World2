...
# Used permutation '0111011111', which corresponds to 'LHHHLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'