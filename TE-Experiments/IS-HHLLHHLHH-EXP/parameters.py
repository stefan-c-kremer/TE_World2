...
# Used permutation '110011011', which corresponds to 'HHLLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'