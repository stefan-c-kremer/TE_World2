...
# Used permutation '010010101', which corresponds to 'LHLLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'