...
# Used permutation '0010111011', which corresponds to 'LLHLHHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'