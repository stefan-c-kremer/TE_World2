...
# Used permutation '0000110011', which corresponds to 'LLLLHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'