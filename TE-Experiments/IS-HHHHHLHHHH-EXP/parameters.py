...
# Used permutation '1111101111', which corresponds to 'HHHHHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'