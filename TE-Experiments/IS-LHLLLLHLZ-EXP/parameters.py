...
# Used permutation '010000102', which corresponds to 'LHLLLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'