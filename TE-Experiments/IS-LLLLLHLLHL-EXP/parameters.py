...
# Used permutation '0000010010', which corresponds to 'LLLLLHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'