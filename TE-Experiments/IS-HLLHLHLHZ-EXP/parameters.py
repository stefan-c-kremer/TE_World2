...
# Used permutation '100101012', which corresponds to 'HLLHLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'