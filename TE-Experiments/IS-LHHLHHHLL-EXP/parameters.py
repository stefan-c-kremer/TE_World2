...
# Used permutation '011011100', which corresponds to 'LHHLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'