...
# Used permutation '1010010010', which corresponds to 'HLHLLHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'