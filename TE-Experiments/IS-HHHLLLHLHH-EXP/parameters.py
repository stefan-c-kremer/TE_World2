...
# Used permutation '1110001011', which corresponds to 'HHHLLLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'