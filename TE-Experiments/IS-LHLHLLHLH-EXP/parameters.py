...
# Used permutation '010100101', which corresponds to 'LHLHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'