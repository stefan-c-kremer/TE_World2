...
# Used permutation '110101111', which corresponds to 'HHLHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'