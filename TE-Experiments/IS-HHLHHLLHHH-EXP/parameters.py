...
# Used permutation '1101100111', which corresponds to 'HHLHHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'