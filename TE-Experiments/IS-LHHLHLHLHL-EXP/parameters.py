...
# Used permutation '0110101010', which corresponds to 'LHHLHLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'