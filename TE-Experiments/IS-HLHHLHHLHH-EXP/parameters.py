...
# Used permutation '1011011011', which corresponds to 'HLHHLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'