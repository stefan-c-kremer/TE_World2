...
# Used permutation '110000011', which corresponds to 'HHLLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'