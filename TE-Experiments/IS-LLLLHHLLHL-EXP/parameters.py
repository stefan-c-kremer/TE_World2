...
# Used permutation '0000110010', which corresponds to 'LLLLHHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'