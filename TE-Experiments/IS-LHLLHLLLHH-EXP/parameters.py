...
# Used permutation '0100100011', which corresponds to 'LHLLHLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'