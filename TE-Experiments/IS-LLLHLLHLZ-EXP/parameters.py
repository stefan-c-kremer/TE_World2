...
# Used permutation '000100102', which corresponds to 'LLLHLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'