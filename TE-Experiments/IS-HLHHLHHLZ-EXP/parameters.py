...
# Used permutation '101101102', which corresponds to 'HLHHLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'