...
# Used permutation '101001010', which corresponds to 'HLHLLHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'