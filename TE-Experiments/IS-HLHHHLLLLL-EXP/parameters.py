...
# Used permutation '1011100000', which corresponds to 'HLHHHLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'