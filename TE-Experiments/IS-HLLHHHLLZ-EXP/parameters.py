...
# Used permutation '100111002', which corresponds to 'HLLHHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'