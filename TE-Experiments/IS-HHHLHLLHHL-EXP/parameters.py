...
# Used permutation '1110100110', which corresponds to 'HHHLHLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'