...
# Used permutation '100110102', which corresponds to 'HLLHHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'