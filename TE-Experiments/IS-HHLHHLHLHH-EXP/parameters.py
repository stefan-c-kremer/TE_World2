...
# Used permutation '1101101011', which corresponds to 'HHLHHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'