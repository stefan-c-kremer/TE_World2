...
# Used permutation '1000111100', which corresponds to 'HLLLHHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'