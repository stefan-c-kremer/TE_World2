...
# Used permutation '101101111', which corresponds to 'HLHHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'