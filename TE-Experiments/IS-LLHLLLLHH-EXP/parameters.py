...
# Used permutation '001000011', which corresponds to 'LLHLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'