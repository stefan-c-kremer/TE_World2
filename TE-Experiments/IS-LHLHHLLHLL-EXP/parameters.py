...
# Used permutation '0101100100', which corresponds to 'LHLHHLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'