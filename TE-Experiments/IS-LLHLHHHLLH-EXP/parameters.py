...
# Used permutation '0010111001', which corresponds to 'LLHLHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'