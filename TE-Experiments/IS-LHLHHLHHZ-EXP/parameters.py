...
# Used permutation '010110112', which corresponds to 'LHLHHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'