...
# Used permutation '1011110010', which corresponds to 'HLHHHHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'