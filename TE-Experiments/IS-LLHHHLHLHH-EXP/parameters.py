...
# Used permutation '0011101011', which corresponds to 'LLHHHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'