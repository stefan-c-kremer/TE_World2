...
# Used permutation '1011100010', which corresponds to 'HLHHHLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'