...
# Used permutation '011000001', which corresponds to 'LHHLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'