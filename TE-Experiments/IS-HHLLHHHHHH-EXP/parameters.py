...
# Used permutation '1100111111', which corresponds to 'HHLLHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'