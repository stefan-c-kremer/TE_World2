...
# Used permutation '010100000', which corresponds to 'LHLHLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'