...
# Used permutation '100101101', which corresponds to 'HLLHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'