...
# Used permutation '001110011', which corresponds to 'LLHHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'