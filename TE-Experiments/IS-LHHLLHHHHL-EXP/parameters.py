...
# Used permutation '0110011110', which corresponds to 'LHHLLHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'