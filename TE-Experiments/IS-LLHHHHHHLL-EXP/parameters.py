...
# Used permutation '0011111100', which corresponds to 'LLHHHHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'