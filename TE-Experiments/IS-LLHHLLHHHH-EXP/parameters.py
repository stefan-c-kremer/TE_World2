...
# Used permutation '0011001111', which corresponds to 'LLHHLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'