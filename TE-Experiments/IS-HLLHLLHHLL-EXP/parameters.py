...
# Used permutation '1001001100', which corresponds to 'HLLHLLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'