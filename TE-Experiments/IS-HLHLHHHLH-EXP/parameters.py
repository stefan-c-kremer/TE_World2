...
# Used permutation '101011101', which corresponds to 'HLHLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'