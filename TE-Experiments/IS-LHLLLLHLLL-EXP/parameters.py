...
# Used permutation '0100001000', which corresponds to 'LHLLLLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'