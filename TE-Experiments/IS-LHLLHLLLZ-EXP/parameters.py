...
# Used permutation '010010002', which corresponds to 'LHLLHLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'