...
# Used permutation '010001000', which corresponds to 'LHLLLHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'