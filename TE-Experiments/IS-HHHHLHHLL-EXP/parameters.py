...
# Used permutation '111101100', which corresponds to 'HHHHLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'