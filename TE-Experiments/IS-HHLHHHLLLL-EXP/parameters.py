...
# Used permutation '1101110000', which corresponds to 'HHLHHHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'