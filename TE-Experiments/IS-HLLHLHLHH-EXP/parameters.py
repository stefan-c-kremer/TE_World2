...
# Used permutation '100101011', which corresponds to 'HLLHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'