...
# Used permutation '1001011001', which corresponds to 'HLLHLHHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'