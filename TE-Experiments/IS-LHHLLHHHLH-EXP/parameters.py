...
# Used permutation '0110011101', which corresponds to 'LHHLLHHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'