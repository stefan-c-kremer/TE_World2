...
# Used permutation '1001101000', which corresponds to 'HLLHHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'