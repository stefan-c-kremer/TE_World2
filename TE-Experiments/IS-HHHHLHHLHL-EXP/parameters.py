...
# Used permutation '1111011010', which corresponds to 'HHHHLHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'