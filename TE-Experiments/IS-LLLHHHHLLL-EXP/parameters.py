...
# Used permutation '0001111000', which corresponds to 'LLLHHHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'