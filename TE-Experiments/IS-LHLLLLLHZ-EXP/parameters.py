...
# Used permutation '010000012', which corresponds to 'LHLLLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'