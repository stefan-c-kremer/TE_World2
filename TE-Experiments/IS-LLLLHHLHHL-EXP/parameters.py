...
# Used permutation '0000110110', which corresponds to 'LLLLHHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'