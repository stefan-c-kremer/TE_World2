...
# Used permutation '100111100', which corresponds to 'HLLHHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'