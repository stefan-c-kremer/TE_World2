...
# Used permutation '0001101110', which corresponds to 'LLLHHLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'