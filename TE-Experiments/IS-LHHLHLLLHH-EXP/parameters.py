...
# Used permutation '0110100011', which corresponds to 'LHHLHLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'