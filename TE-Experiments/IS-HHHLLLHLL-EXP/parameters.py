...
# Used permutation '111000100', which corresponds to 'HHHLLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'