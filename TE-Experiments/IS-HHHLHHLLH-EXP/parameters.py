...
# Used permutation '111011001', which corresponds to 'HHHLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'