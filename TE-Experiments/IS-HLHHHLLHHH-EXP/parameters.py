...
# Used permutation '1011100111', which corresponds to 'HLHHHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'