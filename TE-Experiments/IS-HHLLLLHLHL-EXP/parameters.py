...
# Used permutation '1100001010', which corresponds to 'HHLLLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'