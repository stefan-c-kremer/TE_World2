...
# Used permutation '0110010010', which corresponds to 'LHHLLHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'