...
# Used permutation '1011111010', which corresponds to 'HLHHHHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'