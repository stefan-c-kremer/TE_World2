...
# Used permutation '1110011100', which corresponds to 'HHHLLHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'