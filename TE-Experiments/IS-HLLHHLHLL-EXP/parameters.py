...
# Used permutation '100110100', which corresponds to 'HLLHHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'