...
# Used permutation '1000111110', which corresponds to 'HLLLHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'