...
# Used permutation '0011010100', which corresponds to 'LLHHLHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'