...
# Used permutation '0101111011', which corresponds to 'LHLHHHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'