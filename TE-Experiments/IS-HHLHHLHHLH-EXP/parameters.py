...
# Used permutation '1101101101', which corresponds to 'HHLHHLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'