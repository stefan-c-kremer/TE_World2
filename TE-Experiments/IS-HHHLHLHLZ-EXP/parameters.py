...
# Used permutation '111010102', which corresponds to 'HHHLHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'