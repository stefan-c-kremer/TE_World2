...
# Used permutation '1111100010', which corresponds to 'HHHHHLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'