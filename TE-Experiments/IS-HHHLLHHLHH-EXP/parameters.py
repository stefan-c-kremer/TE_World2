...
# Used permutation '1110011011', which corresponds to 'HHHLLHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'