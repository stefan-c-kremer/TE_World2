...
# Used permutation '010000000', which corresponds to 'LHLLLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'