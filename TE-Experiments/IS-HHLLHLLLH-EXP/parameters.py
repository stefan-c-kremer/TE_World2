...
# Used permutation '110010001', which corresponds to 'HHLLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'