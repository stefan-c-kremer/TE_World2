...
# Used permutation '0101011000', which corresponds to 'LHLHLHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'