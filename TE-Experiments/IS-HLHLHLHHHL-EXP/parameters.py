...
# Used permutation '1010101110', which corresponds to 'HLHLHLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'