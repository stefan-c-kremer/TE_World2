...
# Used permutation '1000110000', which corresponds to 'HLLLHHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'