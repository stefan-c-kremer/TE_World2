...
# Used permutation '0011010110', which corresponds to 'LLHHLHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'