...
# Used permutation '1001001010', which corresponds to 'HLLHLLHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'