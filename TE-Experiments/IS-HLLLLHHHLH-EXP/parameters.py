...
# Used permutation '1000011101', which corresponds to 'HLLLLHHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'