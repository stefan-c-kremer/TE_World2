...
# Used permutation '0110000111', which corresponds to 'LHHLLLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'