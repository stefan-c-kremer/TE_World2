...
# Used permutation '110100102', which corresponds to 'HHLHLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'