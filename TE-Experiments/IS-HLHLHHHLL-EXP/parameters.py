...
# Used permutation '101011100', which corresponds to 'HLHLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'