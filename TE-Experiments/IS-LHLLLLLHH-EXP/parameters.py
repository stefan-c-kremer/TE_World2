...
# Used permutation '010000011', which corresponds to 'LHLLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'