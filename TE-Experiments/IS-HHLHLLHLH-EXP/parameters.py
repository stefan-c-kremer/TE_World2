...
# Used permutation '110100101', which corresponds to 'HHLHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'