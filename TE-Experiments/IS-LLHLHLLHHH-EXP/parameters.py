...
# Used permutation '0010100111', which corresponds to 'LLHLHLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'