...
# Used permutation '1100001101', which corresponds to 'HHLLLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'