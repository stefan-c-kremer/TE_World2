...
# Used permutation '1100001101', which corresponds to 'HHLLLLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'