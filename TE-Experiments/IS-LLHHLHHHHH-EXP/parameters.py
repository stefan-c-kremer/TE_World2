...
# Used permutation '0011011111', which corresponds to 'LLHHLHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'