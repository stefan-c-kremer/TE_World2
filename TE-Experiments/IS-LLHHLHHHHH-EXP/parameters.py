...
# Used permutation '0011011111', which corresponds to 'LLHHLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'