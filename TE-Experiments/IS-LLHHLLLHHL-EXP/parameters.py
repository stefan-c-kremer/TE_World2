...
# Used permutation '0011000110', which corresponds to 'LLHHLLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'