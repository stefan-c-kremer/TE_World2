...
# Used permutation '111100100', which corresponds to 'HHHHLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'