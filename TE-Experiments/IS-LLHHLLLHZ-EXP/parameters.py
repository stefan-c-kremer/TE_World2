...
# Used permutation '001100012', which corresponds to 'LLHHLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'