...
# Used permutation '0010000001', which corresponds to 'LLHLLLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'