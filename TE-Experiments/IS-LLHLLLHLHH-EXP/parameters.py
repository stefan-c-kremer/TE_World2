...
# Used permutation '0010001011', which corresponds to 'LLHLLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'