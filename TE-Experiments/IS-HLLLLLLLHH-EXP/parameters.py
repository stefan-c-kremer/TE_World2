...
# Used permutation '1000000011', which corresponds to 'HLLLLLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'