...
# Used permutation '1000000011', which corresponds to 'HLLLLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'