...
# Used permutation '111111000', which corresponds to 'HHHHHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'