...
# Used permutation '1010111001', which corresponds to 'HLHLHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'