...
# Used permutation '1111010000', which corresponds to 'HHHHLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'