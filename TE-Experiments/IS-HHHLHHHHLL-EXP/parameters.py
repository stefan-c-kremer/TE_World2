...
# Used permutation '1110111100', which corresponds to 'HHHLHHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'