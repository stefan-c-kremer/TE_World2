...
# Used permutation '0110100001', which corresponds to 'LHHLHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'