...
# Used permutation '010010010', which corresponds to 'LHLLHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'