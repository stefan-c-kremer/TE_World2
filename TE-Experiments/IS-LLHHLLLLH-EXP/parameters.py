...
# Used permutation '001100001', which corresponds to 'LLHHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'