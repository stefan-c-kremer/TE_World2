...
# Used permutation '1011001010', which corresponds to 'HLHHLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'