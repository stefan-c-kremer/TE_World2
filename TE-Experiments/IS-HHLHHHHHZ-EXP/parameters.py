...
# Used permutation '110111112', which corresponds to 'HHLHHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'