...
# Used permutation '001111002', which corresponds to 'LLHHHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'