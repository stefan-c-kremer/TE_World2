...
# Used permutation '0001110100', which corresponds to 'LLLHHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'