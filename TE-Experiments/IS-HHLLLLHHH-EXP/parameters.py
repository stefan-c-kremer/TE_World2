...
# Used permutation '110000111', which corresponds to 'HHLLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'