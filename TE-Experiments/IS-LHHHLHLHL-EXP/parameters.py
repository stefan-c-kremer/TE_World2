...
# Used permutation '011101010', which corresponds to 'LHHHLHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'