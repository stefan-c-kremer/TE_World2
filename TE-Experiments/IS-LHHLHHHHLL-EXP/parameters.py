...
# Used permutation '0110111100', which corresponds to 'LHHLHHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'