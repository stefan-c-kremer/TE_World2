...
# Used permutation '011100002', which corresponds to 'LHHHLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'