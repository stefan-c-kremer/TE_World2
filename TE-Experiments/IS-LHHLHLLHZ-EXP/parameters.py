...
# Used permutation '011010012', which corresponds to 'LHHLHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'