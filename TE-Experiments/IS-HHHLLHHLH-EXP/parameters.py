...
# Used permutation '111001101', which corresponds to 'HHHLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'