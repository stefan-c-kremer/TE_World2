...
# Used permutation '1011000010', which corresponds to 'HLHHLLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'