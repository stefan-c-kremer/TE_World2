...
# Used permutation '1011101100', which corresponds to 'HLHHHLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'