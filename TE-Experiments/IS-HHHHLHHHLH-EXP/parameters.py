...
# Used permutation '1111011101', which corresponds to 'HHHHLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'