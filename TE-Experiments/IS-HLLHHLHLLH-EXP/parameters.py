...
# Used permutation '1001101001', which corresponds to 'HLLHHLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'