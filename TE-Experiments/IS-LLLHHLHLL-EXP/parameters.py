...
# Used permutation '000110100', which corresponds to 'LLLHHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'