...
# Used permutation '0101110011', which corresponds to 'LHLHHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'