...
# Used permutation '1000101101', which corresponds to 'HLLLHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'