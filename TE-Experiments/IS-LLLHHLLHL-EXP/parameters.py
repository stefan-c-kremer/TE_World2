...
# Used permutation '000110010', which corresponds to 'LLLHHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'