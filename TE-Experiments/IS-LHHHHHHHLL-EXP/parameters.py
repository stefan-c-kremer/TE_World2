...
# Used permutation '0111111100', which corresponds to 'LHHHHHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'