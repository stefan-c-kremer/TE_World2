...
# Used permutation '0110110010', which corresponds to 'LHHLHHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'