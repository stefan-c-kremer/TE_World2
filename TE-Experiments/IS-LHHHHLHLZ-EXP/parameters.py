...
# Used permutation '011110102', which corresponds to 'LHHHHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'