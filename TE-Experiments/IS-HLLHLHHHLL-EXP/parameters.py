...
# Used permutation '1001011100', which corresponds to 'HLLHLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'