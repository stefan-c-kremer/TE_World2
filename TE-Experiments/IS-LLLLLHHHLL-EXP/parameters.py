...
# Used permutation '0000011100', which corresponds to 'LLLLLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'