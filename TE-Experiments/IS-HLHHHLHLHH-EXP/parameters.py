...
# Used permutation '1011101011', which corresponds to 'HLHHHLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'