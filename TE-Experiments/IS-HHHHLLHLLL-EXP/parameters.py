...
# Used permutation '1111001000', which corresponds to 'HHHHLLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'