...
# Used permutation '111101102', which corresponds to 'HHHHLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'