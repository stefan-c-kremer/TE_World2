...
# Used permutation '0101010110', which corresponds to 'LHLHLHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'