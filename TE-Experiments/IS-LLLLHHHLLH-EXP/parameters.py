...
# Used permutation '0000111001', which corresponds to 'LLLLHHHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'