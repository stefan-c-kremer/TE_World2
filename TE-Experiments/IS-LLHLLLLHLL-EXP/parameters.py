...
# Used permutation '0010000100', which corresponds to 'LLHLLLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'