...
# Used permutation '110100011', which corresponds to 'HHLHLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'