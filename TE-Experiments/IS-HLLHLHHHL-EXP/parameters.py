...
# Used permutation '100101110', which corresponds to 'HLLHLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'