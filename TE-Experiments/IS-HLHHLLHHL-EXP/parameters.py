...
# Used permutation '101100110', which corresponds to 'HLHHLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'