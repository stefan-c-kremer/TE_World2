...
# Used permutation '0111110001', which corresponds to 'LHHHHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'