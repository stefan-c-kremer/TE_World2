...
# Used permutation '0111110001', which corresponds to 'LHHHHHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'