...
# Used permutation '0010110111', which corresponds to 'LLHLHHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'