...
# Used permutation '000100112', which corresponds to 'LLLHLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'