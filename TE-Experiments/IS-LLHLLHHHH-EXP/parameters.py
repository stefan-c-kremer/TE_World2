...
# Used permutation '001001111', which corresponds to 'LLHLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'