...
# Used permutation '1101100110', which corresponds to 'HHLHHLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'