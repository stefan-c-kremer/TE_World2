...
# Used permutation '0100011101', which corresponds to 'LHLLLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'