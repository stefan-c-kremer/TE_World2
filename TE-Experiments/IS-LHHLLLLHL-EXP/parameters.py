...
# Used permutation '011000010', which corresponds to 'LHHLLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'