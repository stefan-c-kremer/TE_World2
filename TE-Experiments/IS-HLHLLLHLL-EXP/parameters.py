...
# Used permutation '101000100', which corresponds to 'HLHLLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'