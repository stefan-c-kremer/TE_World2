...
# Used permutation '0100111110', which corresponds to 'LHLLHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'