...
# Used permutation '100000102', which corresponds to 'HLLLLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'