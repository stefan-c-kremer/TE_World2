...
# Used permutation '110111101', which corresponds to 'HHLHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'