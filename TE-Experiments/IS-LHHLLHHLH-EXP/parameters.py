...
# Used permutation '011001101', which corresponds to 'LHHLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'