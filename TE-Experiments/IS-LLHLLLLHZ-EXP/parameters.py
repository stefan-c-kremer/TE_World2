...
# Used permutation '001000012', which corresponds to 'LLHLLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'