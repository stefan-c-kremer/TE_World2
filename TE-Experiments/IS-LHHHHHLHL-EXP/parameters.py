...
# Used permutation '011111010', which corresponds to 'LHHHHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'