...
# Used permutation '001011001', which corresponds to 'LLHLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'