...
# Used permutation '110000110', which corresponds to 'HHLLLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'