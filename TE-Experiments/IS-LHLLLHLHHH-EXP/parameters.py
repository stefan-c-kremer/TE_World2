...
# Used permutation '0100010111', which corresponds to 'LHLLLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'