...
# Used permutation '1110010101', which corresponds to 'HHHLLHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'