...
# Used permutation '1111011011', which corresponds to 'HHHHLHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'