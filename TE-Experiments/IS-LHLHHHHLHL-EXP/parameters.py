...
# Used permutation '0101111010', which corresponds to 'LHLHHHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'