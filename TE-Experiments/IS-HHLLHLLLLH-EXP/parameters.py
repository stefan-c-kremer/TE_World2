...
# Used permutation '1100100001', which corresponds to 'HHLLHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'