...
# Used permutation '1010111110', which corresponds to 'HLHLHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'