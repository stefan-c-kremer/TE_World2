...
# Used permutation '0001000001', which corresponds to 'LLLHLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'