...
# Used permutation '1100010001', which corresponds to 'HHLLLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'