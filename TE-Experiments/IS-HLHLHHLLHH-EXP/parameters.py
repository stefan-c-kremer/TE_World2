...
# Used permutation '1010110011', which corresponds to 'HLHLHHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'