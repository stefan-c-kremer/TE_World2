...
# Used permutation '111010111', which corresponds to 'HHHLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'