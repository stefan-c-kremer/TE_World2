...
# Used permutation '100000011', which corresponds to 'HLLLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'