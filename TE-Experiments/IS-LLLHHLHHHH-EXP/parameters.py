...
# Used permutation '0001101111', which corresponds to 'LLLHHLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'