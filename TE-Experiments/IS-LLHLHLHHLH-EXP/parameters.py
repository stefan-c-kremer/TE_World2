...
# Used permutation '0010101101', which corresponds to 'LLHLHLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'