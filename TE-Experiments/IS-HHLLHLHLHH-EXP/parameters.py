...
# Used permutation '1100101011', which corresponds to 'HHLLHLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'