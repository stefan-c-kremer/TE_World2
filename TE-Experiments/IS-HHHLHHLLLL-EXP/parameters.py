...
# Used permutation '1110110000', which corresponds to 'HHHLHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'