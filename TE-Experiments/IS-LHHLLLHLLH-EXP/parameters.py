...
# Used permutation '0110001001', which corresponds to 'LHHLLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'