...
# Used permutation '1010001001', which corresponds to 'HLHLLLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'