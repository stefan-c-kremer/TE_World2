...
# Used permutation '101010112', which corresponds to 'HLHLHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'