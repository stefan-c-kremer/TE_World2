...
# Used permutation '1110110101', which corresponds to 'HHHLHHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'