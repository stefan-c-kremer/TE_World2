...
# Used permutation '110001112', which corresponds to 'HHLLLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'