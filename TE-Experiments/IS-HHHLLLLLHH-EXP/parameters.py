...
# Used permutation '1110000011', which corresponds to 'HHHLLLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'