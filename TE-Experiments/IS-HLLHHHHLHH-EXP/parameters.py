...
# Used permutation '1001111011', which corresponds to 'HLLHHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'