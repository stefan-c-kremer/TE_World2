...
# Used permutation '0000001101', which corresponds to 'LLLLLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'