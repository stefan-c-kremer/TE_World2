...
# Used permutation '000111112', which corresponds to 'LLLHHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'