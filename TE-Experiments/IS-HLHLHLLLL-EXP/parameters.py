...
# Used permutation '101010000', which corresponds to 'HLHLHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'