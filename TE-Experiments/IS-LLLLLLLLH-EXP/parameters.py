...
# Used permutation '000000001', which corresponds to 'LLLLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'