...
# Used permutation '1111110100', which corresponds to 'HHHHHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'