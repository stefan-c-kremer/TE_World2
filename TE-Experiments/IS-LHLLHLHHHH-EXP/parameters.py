...
# Used permutation '0100101111', which corresponds to 'LHLLHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'