...
# Used permutation '0111011011', which corresponds to 'LHHHLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'