...
# Used permutation '110000012', which corresponds to 'HHLLLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'