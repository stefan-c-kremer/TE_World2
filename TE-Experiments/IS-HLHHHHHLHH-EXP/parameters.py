...
# Used permutation '1011111011', which corresponds to 'HLHHHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'