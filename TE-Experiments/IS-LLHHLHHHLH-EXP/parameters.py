...
# Used permutation '0011011101', which corresponds to 'LLHHLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'