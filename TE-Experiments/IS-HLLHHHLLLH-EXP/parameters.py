...
# Used permutation '1001110001', which corresponds to 'HLLHHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'