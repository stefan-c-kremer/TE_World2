...
# Used permutation '1101100101', which corresponds to 'HHLHHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'