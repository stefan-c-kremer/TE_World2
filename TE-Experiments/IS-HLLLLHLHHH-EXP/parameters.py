...
# Used permutation '1000010111', which corresponds to 'HLLLLHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'