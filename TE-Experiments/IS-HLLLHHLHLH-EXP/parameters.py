...
# Used permutation '1000110101', which corresponds to 'HLLLHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'