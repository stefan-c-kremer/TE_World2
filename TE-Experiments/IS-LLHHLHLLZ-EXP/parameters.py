...
# Used permutation '001101002', which corresponds to 'LLHHLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'