...
# Used permutation '0100010000', which corresponds to 'LHLLLHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'