...
# Used permutation '1110001110', which corresponds to 'HHHLLLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'