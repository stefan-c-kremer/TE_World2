...
# Used permutation '011100102', which corresponds to 'LHHHLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'