...
# Used permutation '111010112', which corresponds to 'HHHLHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'