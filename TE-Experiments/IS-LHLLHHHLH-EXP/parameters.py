...
# Used permutation '010011101', which corresponds to 'LHLLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'