...
# Used permutation '111000112', which corresponds to 'HHHLLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'