...
# Used permutation '1001000011', which corresponds to 'HLLHLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'