...
# Used permutation '111000001', which corresponds to 'HHHLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'