...
# Used permutation '101101100', which corresponds to 'HLHHLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'