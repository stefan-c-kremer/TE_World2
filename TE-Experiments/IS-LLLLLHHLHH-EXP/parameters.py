...
# Used permutation '0000011011', which corresponds to 'LLLLLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'