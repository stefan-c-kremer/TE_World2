...
# Used permutation '0100000101', which corresponds to 'LHLLLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'