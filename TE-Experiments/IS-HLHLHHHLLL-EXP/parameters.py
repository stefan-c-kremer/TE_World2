...
# Used permutation '1010111000', which corresponds to 'HLHLHHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'