...
# Used permutation '0011010010', which corresponds to 'LLHHLHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'