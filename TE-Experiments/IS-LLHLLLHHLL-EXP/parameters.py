...
# Used permutation '0010001100', which corresponds to 'LLHLLLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'