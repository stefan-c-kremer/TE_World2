...
# Used permutation '1010000011', which corresponds to 'HLHLLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'