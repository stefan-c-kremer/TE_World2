...
# Used permutation '0000110001', which corresponds to 'LLLLHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'