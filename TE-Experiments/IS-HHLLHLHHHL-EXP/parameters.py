...
# Used permutation '1100101110', which corresponds to 'HHLLHLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'