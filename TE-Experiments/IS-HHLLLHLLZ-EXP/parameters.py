...
# Used permutation '110001002', which corresponds to 'HHLLLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'