...
# Used permutation '1110001111', which corresponds to 'HHHLLLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'