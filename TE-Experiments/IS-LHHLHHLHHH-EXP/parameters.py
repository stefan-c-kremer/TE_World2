...
# Used permutation '0110110111', which corresponds to 'LHHLHHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'