...
# Used permutation '110011002', which corresponds to 'HHLLHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'