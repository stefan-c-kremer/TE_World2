...
# Used permutation '100100100', which corresponds to 'HLLHLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'