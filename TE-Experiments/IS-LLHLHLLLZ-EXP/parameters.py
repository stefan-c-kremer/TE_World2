...
# Used permutation '001010002', which corresponds to 'LLHLHLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'