...
# Used permutation '1100001100', which corresponds to 'HHLLLLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'