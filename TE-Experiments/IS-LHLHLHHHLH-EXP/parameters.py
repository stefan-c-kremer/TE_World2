...
# Used permutation '0101011101', which corresponds to 'LHLHLHHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'