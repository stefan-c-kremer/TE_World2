...
# Used permutation '111001102', which corresponds to 'HHHLLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'