...
# Used permutation '1010000110', which corresponds to 'HLHLLLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'