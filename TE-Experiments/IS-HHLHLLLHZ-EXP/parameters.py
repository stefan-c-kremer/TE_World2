...
# Used permutation '110100012', which corresponds to 'HHLHLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'