...
# Used permutation '0000110000', which corresponds to 'LLLLHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'