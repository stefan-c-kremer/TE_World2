...
# Used permutation '0100101011', which corresponds to 'LHLLHLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'