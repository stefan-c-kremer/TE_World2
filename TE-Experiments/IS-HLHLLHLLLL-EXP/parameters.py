...
# Used permutation '1010010000', which corresponds to 'HLHLLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'