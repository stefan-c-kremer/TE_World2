...
# Used permutation '1101001100', which corresponds to 'HHLHLLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'