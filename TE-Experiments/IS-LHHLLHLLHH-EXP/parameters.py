...
# Used permutation '0110010011', which corresponds to 'LHHLLHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'