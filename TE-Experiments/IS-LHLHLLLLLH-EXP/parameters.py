...
# Used permutation '0101000001', which corresponds to 'LHLHLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'