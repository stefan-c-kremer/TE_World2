...
# Used permutation '1111101010', which corresponds to 'HHHHHLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'