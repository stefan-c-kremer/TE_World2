...
# Used permutation '0011000010', which corresponds to 'LLHHLLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'