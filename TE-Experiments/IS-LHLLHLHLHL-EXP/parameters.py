...
# Used permutation '0100101010', which corresponds to 'LHLLHLHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'