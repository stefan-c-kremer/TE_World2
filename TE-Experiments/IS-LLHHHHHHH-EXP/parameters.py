...
# Used permutation '001111111', which corresponds to 'LLHHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'