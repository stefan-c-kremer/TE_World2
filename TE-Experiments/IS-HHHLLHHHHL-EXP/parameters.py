...
# Used permutation '1110011110', which corresponds to 'HHHLLHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'