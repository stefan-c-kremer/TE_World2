...
# Used permutation '1111000000', which corresponds to 'HHHHLLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'