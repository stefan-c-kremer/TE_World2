...
# Used permutation '000111000', which corresponds to 'LLLHHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'