...
# Used permutation '1101001011', which corresponds to 'HHLHLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'