...
# Used permutation '011100100', which corresponds to 'LHHHLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'