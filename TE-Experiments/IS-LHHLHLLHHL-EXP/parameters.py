...
# Used permutation '0110100110', which corresponds to 'LHHLHLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'