...
# Used permutation '011111101', which corresponds to 'LHHHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'