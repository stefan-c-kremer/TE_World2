...
# Used permutation '1100010111', which corresponds to 'HHLLLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'