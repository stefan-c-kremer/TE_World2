...
# Used permutation '0101111001', which corresponds to 'LHLHHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'