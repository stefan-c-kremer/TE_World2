...
# Used permutation '0101111001', which corresponds to 'LHLHHHHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'