...
# Used permutation '1111111010', which corresponds to 'HHHHHHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'