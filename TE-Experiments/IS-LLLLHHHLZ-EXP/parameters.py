...
# Used permutation '000011102', which corresponds to 'LLLLHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'