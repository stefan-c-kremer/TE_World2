...
# Used permutation '0110111101', which corresponds to 'LHHLHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'