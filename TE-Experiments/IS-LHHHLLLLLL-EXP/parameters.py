...
# Used permutation '0111000000', which corresponds to 'LHHHLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'