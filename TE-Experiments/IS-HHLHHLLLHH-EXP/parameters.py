...
# Used permutation '1101100011', which corresponds to 'HHLHHLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'