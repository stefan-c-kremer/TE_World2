...
# Used permutation '1111000101', which corresponds to 'HHHHLLLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'