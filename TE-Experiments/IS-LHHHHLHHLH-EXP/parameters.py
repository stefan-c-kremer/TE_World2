...
# Used permutation '0111101101', which corresponds to 'LHHHHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'