...
# Used permutation '000010012', which corresponds to 'LLLLHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'