...
# Used permutation '0111001100', which corresponds to 'LHHHLLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'