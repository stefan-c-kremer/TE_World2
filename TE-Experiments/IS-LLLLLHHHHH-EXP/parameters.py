...
# Used permutation '0000011111', which corresponds to 'LLLLLHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'