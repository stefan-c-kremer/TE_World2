...
# Used permutation '1111110110', which corresponds to 'HHHHHHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'