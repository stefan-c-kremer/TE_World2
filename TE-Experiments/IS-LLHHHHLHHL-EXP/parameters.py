...
# Used permutation '0011110110', which corresponds to 'LLHHHHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'