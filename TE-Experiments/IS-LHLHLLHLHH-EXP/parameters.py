...
# Used permutation '0101001011', which corresponds to 'LHLHLLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'