...
# Used permutation '110001102', which corresponds to 'HHLLLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'