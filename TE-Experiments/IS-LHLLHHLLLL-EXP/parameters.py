...
# Used permutation '0100110000', which corresponds to 'LHLLHHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'