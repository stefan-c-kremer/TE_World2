...
# Used permutation '0001001010', which corresponds to 'LLLHLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'