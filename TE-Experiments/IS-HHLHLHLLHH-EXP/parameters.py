...
# Used permutation '1101010011', which corresponds to 'HHLHLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'