...
# Used permutation '000010001', which corresponds to 'LLLLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'