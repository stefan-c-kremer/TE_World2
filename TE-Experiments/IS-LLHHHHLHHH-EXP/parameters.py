...
# Used permutation '0011110111', which corresponds to 'LLHHHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'