...
# Used permutation '0110100101', which corresponds to 'LHHLHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'