...
# Used permutation '1001100000', which corresponds to 'HLLHHLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'