...
# Used permutation '010010111', which corresponds to 'LHLLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'