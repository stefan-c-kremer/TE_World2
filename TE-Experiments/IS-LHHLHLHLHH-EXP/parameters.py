...
# Used permutation '0110101011', which corresponds to 'LHHLHLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'