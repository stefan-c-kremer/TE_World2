...
# Used permutation '1111110111', which corresponds to 'HHHHHHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'