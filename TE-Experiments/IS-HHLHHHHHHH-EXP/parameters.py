...
# Used permutation '1101111111', which corresponds to 'HHLHHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'