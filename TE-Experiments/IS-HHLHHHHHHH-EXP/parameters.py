...
# Used permutation '1101111111', which corresponds to 'HHLHHHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'