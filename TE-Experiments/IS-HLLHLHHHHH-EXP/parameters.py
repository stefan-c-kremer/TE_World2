...
# Used permutation '1001011111', which corresponds to 'HLLHLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'