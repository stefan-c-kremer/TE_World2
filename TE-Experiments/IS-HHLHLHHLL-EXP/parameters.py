...
# Used permutation '110101100', which corresponds to 'HHLHLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'