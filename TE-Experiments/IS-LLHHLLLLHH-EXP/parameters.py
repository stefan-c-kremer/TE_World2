...
# Used permutation '0011000011', which corresponds to 'LLHHLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'