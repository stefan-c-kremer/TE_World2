...
# Used permutation '0000000101', which corresponds to 'LLLLLLLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'