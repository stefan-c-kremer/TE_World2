...
# Used permutation '101000010', which corresponds to 'HLHLLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'