...
# Used permutation '0101000111', which corresponds to 'LHLHLLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'