...
# Used permutation '1000001111', which corresponds to 'HLLLLLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'