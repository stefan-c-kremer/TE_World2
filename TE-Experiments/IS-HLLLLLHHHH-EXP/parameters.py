...
# Used permutation '1000001111', which corresponds to 'HLLLLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'