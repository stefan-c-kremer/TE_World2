...
# Used permutation '0001111101', which corresponds to 'LLLHHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'