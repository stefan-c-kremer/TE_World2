...
# Used permutation '0011111000', which corresponds to 'LLHHHHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'