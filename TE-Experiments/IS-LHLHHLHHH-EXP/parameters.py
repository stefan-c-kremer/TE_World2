...
# Used permutation '010110111', which corresponds to 'LHLHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'