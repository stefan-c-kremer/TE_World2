...
# Used permutation '101010012', which corresponds to 'HLHLHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'