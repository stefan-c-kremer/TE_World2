...
# Used permutation '1011010101', which corresponds to 'HLHHLHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'