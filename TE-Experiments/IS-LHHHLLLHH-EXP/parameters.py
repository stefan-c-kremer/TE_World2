...
# Used permutation '011100011', which corresponds to 'LHHHLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'