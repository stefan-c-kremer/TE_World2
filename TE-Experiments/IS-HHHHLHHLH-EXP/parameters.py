...
# Used permutation '111101101', which corresponds to 'HHHHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'