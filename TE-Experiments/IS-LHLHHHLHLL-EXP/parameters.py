...
# Used permutation '0101110100', which corresponds to 'LHLHHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'