...
# Used permutation '0111110000', which corresponds to 'LHHHHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'