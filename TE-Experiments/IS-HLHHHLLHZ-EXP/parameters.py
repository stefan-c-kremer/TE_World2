...
# Used permutation '101110012', which corresponds to 'HLHHHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'