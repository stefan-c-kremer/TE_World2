...
# Used permutation '1110101001', which corresponds to 'HHHLHLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'