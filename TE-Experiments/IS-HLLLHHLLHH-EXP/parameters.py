...
# Used permutation '1000110011', which corresponds to 'HLLLHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'