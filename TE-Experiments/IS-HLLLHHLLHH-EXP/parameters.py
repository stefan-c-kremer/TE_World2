...
# Used permutation '1000110011', which corresponds to 'HLLLHHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'