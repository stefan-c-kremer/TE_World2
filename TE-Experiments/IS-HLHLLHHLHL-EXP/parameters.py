...
# Used permutation '1010011010', which corresponds to 'HLHLLHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'