...
# Used permutation '100111101', which corresponds to 'HLLHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'