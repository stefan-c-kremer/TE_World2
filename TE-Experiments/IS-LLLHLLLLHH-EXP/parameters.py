...
# Used permutation '0001000011', which corresponds to 'LLLHLLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'