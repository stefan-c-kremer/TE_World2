...
# Used permutation '1111101101', which corresponds to 'HHHHHLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'