...
# Used permutation '001100002', which corresponds to 'LLHHLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'