...
# Used permutation '0000011110', which corresponds to 'LLLLLHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'