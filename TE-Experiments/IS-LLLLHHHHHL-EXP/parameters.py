...
# Used permutation '0000111110', which corresponds to 'LLLLHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'