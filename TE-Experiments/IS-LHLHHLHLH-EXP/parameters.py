...
# Used permutation '010110101', which corresponds to 'LHLHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'