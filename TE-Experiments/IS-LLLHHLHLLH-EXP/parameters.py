...
# Used permutation '0001101001', which corresponds to 'LLLHHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'