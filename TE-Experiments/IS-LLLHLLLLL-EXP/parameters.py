...
# Used permutation '000100000', which corresponds to 'LLLHLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'