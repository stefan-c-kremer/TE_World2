...
# Used permutation '0001111001', which corresponds to 'LLLHHHHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'