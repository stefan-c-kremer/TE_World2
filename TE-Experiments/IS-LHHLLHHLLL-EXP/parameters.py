...
# Used permutation '0110011000', which corresponds to 'LHHLLHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'