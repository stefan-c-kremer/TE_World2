...
# Used permutation '1101010000', which corresponds to 'HHLHLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'