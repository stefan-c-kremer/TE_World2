...
# Used permutation '1110110111', which corresponds to 'HHHLHHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'