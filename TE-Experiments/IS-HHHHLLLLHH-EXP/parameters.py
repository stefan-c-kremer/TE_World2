...
# Used permutation '1111000011', which corresponds to 'HHHHLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'