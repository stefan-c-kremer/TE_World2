...
# Used permutation '0011010101', which corresponds to 'LLHHLHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'