...
# Used permutation '1011110101', which corresponds to 'HLHHHHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'