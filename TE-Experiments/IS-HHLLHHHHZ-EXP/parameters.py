...
# Used permutation '110011112', which corresponds to 'HHLLHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'