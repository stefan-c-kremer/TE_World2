...
# Used permutation '0111101011', which corresponds to 'LHHHHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'