...
# Used permutation '000100111', which corresponds to 'LLLHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'