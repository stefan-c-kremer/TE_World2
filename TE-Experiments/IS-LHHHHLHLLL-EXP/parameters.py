...
# Used permutation '0111101000', which corresponds to 'LHHHHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'