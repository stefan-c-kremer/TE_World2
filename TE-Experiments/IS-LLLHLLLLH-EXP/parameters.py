...
# Used permutation '000100001', which corresponds to 'LLLHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'