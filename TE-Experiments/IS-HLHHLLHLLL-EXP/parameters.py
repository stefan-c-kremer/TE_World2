...
# Used permutation '1011001000', which corresponds to 'HLHHLLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'