...
# Used permutation '1000000111', which corresponds to 'HLLLLLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'