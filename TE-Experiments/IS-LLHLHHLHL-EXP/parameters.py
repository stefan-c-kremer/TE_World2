...
# Used permutation '001011010', which corresponds to 'LLHLHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'