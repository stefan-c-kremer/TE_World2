...
# Used permutation '001001102', which corresponds to 'LLHLLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'