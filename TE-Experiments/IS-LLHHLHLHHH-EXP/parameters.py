...
# Used permutation '0011010111', which corresponds to 'LLHHLHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'