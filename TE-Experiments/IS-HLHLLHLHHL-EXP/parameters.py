...
# Used permutation '1010010110', which corresponds to 'HLHLLHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'