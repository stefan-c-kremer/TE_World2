...
# Used permutation '1100110100', which corresponds to 'HHLLHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'