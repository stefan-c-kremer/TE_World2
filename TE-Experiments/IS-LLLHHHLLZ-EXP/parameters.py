...
# Used permutation '000111002', which corresponds to 'LLLHHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'