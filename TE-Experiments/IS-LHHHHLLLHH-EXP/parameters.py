...
# Used permutation '0111100011', which corresponds to 'LHHHHLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'