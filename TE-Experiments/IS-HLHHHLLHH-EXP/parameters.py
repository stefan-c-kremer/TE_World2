...
# Used permutation '101110011', which corresponds to 'HLHHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'