...
# Used permutation '0001101000', which corresponds to 'LLLHHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'