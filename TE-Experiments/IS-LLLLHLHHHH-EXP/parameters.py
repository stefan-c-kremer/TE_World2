...
# Used permutation '0000101111', which corresponds to 'LLLLHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'