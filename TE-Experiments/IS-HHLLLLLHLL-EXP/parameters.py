...
# Used permutation '1100000100', which corresponds to 'HHLLLLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'