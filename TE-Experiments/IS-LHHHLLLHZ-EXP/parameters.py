...
# Used permutation '011100012', which corresponds to 'LHHHLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'