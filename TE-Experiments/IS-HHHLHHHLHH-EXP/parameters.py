...
# Used permutation '1110111011', which corresponds to 'HHHLHHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'