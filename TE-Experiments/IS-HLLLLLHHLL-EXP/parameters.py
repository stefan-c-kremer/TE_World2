...
# Used permutation '1000001100', which corresponds to 'HLLLLLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'