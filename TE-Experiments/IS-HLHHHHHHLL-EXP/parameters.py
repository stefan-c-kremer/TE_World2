...
# Used permutation '1011111100', which corresponds to 'HLHHHHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'