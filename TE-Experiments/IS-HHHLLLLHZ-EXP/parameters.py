...
# Used permutation '111000012', which corresponds to 'HHHLLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'