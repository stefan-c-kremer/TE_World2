...
# Used permutation '1001011011', which corresponds to 'HLLHLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'