...
# Used permutation '1101001110', which corresponds to 'HHLHLLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'