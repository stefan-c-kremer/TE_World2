...
# Used permutation '1010011110', which corresponds to 'HLHLLHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'