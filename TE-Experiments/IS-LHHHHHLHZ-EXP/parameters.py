...
# Used permutation '011111012', which corresponds to 'LHHHHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'