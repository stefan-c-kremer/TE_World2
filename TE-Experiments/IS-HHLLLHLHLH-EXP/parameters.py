...
# Used permutation '1100010101', which corresponds to 'HHLLLHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'