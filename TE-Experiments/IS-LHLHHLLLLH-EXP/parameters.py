...
# Used permutation '0101100001', which corresponds to 'LHLHHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'