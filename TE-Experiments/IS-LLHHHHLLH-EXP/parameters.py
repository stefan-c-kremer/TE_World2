...
# Used permutation '001111001', which corresponds to 'LLHHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'