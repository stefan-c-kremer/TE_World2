...
# Used permutation '010101012', which corresponds to 'LHLHLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'