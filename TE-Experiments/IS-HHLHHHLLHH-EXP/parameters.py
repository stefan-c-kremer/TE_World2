...
# Used permutation '1101110011', which corresponds to 'HHLHHHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'