...
# Used permutation '0101011001', which corresponds to 'LHLHLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'