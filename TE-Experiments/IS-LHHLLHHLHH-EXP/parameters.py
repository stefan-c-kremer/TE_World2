...
# Used permutation '0110011011', which corresponds to 'LHHLLHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'