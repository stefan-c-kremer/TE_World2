...
# Used permutation '101011012', which corresponds to 'HLHLHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'