...
# Used permutation '001110101', which corresponds to 'LLHHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'