...
# Used permutation '1101110100', which corresponds to 'HHLHHHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'