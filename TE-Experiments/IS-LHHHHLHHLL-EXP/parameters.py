...
# Used permutation '0111101100', which corresponds to 'LHHHHLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'