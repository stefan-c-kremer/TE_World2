...
# Used permutation '100001012', which corresponds to 'HLLLLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'