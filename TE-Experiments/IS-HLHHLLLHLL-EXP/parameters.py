...
# Used permutation '1011000100', which corresponds to 'HLHHLLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'