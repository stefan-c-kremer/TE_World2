...
# Used permutation '111100111', which corresponds to 'HHHHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'