...
Kidnapping_Frequency = lambda live_aut, live_naut: 1 - 1/(1 + 0.1 * live_naut)  # The larger the number, the higher the probability of non-autonomous kidnapping the autonomous TEs
