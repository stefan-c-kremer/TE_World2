...
# Tests non-autonomous (i.e. SINE elements)
...
Kidnapping_Effectiveness = Kidnapping_Effectiveness = lambda live_aut: 0.001 * live_aut # The larger the number, the higher the probability of non-autonomous kidnapping the autonomous TEs
