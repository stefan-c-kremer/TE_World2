...
Kidnapping_Frequency = lambda live_aut: 1 - 1/(1 + 0.1 * live_aut)  # The larger the number, the higher the probability of non-autonomous kidnapping the autonomous TEs
