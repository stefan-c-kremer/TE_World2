...
# Used permutation '0111000010', which corresponds to 'LHHHLLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'