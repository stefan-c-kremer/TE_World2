...
# Used permutation '101110002', which corresponds to 'HLHHHLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'