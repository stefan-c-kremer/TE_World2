...
# Used permutation '0010001111', which corresponds to 'LLHLLLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'