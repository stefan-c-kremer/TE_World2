...
# Used permutation '010011012', which corresponds to 'LHLLHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'