...
# Used permutation '1001111111', which corresponds to 'HLLHHHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'