...
# Used permutation '1101101111', which corresponds to 'HHLHHLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'