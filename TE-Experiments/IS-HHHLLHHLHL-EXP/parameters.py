...
# Used permutation '1110011010', which corresponds to 'HHHLLHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'