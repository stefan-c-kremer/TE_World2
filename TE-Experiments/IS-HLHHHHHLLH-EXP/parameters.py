...
# Used permutation '1011111001', which corresponds to 'HLHHHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'