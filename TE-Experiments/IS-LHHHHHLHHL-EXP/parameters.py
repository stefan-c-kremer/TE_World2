...
# Used permutation '0111110110', which corresponds to 'LHHHHHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'