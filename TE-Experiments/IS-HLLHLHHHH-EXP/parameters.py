...
# Used permutation '100101111', which corresponds to 'HLLHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'