...
# Used permutation '111010010', which corresponds to 'HHHLHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'