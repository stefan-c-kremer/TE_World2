...
# Used permutation '000000112', which corresponds to 'LLLLLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'