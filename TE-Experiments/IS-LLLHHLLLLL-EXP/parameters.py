...
# Used permutation '0001100000', which corresponds to 'LLLHHLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'