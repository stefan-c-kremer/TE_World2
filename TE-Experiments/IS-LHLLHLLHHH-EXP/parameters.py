...
# Used permutation '0100100111', which corresponds to 'LHLLHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'