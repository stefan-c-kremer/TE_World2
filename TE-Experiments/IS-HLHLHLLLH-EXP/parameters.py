...
# Used permutation '101010001', which corresponds to 'HLHLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'