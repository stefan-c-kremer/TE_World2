...
# Used permutation '0101110110', which corresponds to 'LHLHHHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'