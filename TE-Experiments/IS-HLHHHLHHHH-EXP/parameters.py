...
# Used permutation '1011101111', which corresponds to 'HLHHHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'