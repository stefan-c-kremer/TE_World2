...
# Used permutation '1110010010', which corresponds to 'HHHLLHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'