...
# Used permutation '0000001110', which corresponds to 'LLLLLLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'