...
# Used permutation '101000102', which corresponds to 'HLHLLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'