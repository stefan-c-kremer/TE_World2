...
# Used permutation '1001000100', which corresponds to 'HLLHLLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'