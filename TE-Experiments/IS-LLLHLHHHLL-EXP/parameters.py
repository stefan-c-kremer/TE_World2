...
# Used permutation '0001011100', which corresponds to 'LLLHLHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'