...
# Used permutation '0001011100', which corresponds to 'LLLHLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'