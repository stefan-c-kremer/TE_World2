...
# Used permutation '0101000010', which corresponds to 'LHLHLLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'