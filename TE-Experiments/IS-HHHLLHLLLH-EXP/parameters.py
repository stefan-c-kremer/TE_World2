...
# Used permutation '1110010001', which corresponds to 'HHHLLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'