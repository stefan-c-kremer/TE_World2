...
# Used permutation '1110011111', which corresponds to 'HHHLLHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'