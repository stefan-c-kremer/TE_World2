...
# Used permutation '0100110010', which corresponds to 'LHLLHHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'