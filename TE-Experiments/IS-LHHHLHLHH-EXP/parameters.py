...
# Used permutation '011101011', which corresponds to 'LHHHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'