...
# Used permutation '1111001001', which corresponds to 'HHHHLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'