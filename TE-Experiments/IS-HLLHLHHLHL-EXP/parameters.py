...
# Used permutation '1001011010', which corresponds to 'HLLHLHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'