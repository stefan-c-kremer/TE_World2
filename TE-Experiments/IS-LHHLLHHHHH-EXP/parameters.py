...
# Used permutation '0110011111', which corresponds to 'LHHLLHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'