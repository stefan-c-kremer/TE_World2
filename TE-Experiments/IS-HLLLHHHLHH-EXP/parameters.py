...
# Used permutation '1000111011', which corresponds to 'HLLLHHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'