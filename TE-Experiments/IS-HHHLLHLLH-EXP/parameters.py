...
# Used permutation '111001001', which corresponds to 'HHHLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'