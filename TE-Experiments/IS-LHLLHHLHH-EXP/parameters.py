...
# Used permutation '010011011', which corresponds to 'LHLLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'