...
# Used permutation '1011110011', which corresponds to 'HLHHHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'