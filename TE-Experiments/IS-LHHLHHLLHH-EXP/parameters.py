...
# Used permutation '0110110011', which corresponds to 'LHHLHHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'