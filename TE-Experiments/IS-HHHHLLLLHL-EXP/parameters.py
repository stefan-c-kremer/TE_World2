...
# Used permutation '1111000010', which corresponds to 'HHHHLLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'