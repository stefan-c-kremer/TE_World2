...
# Used permutation '100110011', which corresponds to 'HLLHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'