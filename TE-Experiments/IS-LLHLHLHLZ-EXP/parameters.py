...
# Used permutation '001010102', which corresponds to 'LLHLHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'