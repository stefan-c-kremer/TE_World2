...
# Used permutation '0000110101', which corresponds to 'LLLLHHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'