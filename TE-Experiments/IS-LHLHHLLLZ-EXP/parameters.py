...
# Used permutation '010110002', which corresponds to 'LHLHHLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'