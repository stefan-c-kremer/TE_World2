...
# Used permutation '000010102', which corresponds to 'LLLLHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'