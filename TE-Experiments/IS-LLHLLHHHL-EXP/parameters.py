...
# Used permutation '001001110', which corresponds to 'LLHLLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'