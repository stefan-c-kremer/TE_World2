...
# Used permutation '010001011', which corresponds to 'LHLLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'