...
# Used permutation '110000002', which corresponds to 'HHLLLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'