...
# Used permutation '0100011110', which corresponds to 'LHLLLHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'