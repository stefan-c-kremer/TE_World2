...
# Used permutation '1101100001', which corresponds to 'HHLHHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'