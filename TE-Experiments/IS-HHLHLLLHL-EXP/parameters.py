...
# Used permutation '110100010', which corresponds to 'HHLHLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'