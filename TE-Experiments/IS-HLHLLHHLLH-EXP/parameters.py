...
# Used permutation '1010011001', which corresponds to 'HLHLLHHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'