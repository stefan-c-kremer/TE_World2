...
# Used permutation '0111010101', which corresponds to 'LHHHLHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'