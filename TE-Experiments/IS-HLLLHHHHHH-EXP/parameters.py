...
# Used permutation '1000111111', which corresponds to 'HLLLHHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'