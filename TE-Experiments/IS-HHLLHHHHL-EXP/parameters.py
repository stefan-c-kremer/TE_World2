...
# Used permutation '110011110', which corresponds to 'HHLLHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'