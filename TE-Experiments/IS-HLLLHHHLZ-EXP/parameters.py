...
# Used permutation '100011102', which corresponds to 'HLLLHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'