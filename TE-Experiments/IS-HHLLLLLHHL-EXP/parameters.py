...
# Used permutation '1100000110', which corresponds to 'HHLLLLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'