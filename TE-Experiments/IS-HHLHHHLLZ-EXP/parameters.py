...
# Used permutation '110111002', which corresponds to 'HHLHHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'