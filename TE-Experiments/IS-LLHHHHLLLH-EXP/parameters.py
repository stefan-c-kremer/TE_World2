...
# Used permutation '0011110001', which corresponds to 'LLHHHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'