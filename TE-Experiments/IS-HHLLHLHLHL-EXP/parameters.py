...
# Used permutation '1100101010', which corresponds to 'HHLLHLHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'