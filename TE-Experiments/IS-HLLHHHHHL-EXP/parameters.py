...
# Used permutation '100111110', which corresponds to 'HLLHHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'