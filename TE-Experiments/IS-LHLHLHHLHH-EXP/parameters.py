...
# Used permutation '0101011011', which corresponds to 'LHLHLHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'