...
# Used permutation '1000100101', which corresponds to 'HLLLHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'