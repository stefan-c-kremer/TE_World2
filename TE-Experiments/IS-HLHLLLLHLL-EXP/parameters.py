...
# Used permutation '1010000100', which corresponds to 'HLHLLLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'