...
# Used permutation '0111010111', which corresponds to 'LHHHLHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'