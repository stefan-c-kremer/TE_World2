...
# Used permutation '1011000000', which corresponds to 'HLHHLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'