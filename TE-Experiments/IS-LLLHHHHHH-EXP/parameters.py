...
# Used permutation '000111111', which corresponds to 'LLLHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'