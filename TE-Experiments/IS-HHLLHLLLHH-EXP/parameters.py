...
# Used permutation '1100100011', which corresponds to 'HHLLHLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'