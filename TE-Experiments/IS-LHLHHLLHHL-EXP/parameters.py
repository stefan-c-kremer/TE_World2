...
# Used permutation '0101100110', which corresponds to 'LHLHHLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'