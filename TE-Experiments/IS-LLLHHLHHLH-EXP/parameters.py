...
# Used permutation '0001101101', which corresponds to 'LLLHHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'