...
# Used permutation '0001110010', which corresponds to 'LLLHHHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'