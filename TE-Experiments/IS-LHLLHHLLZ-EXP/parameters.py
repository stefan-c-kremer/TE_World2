...
# Used permutation '010011002', which corresponds to 'LHLLHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'