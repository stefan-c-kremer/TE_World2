...
# Used permutation '1100010000', which corresponds to 'HHLLLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'