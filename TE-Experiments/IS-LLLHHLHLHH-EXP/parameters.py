...
# Used permutation '0001101011', which corresponds to 'LLLHHLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'