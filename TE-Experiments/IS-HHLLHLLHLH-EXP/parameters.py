...
# Used permutation '1100100101', which corresponds to 'HHLLHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'