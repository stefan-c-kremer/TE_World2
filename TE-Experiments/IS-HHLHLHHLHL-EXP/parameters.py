...
# Used permutation '1101011010', which corresponds to 'HHLHLHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'