...
# Used permutation '0111011110', which corresponds to 'LHHHLHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'