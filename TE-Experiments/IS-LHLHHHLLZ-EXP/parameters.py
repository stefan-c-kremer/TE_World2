...
# Used permutation '010111002', which corresponds to 'LHLHHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'