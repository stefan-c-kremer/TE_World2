...
# Used permutation '111110102', which corresponds to 'HHHHHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'