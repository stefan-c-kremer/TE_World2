...
# Used permutation '1101111101', which corresponds to 'HHLHHHHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'