...
# Used permutation '0100110001', which corresponds to 'LHLLHHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'