...
# Used permutation '1011101101', which corresponds to 'HLHHHLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'