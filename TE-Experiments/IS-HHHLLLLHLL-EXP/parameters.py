...
# Used permutation '1110000100', which corresponds to 'HHHLLLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'