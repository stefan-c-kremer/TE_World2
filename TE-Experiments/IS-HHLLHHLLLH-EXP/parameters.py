...
# Used permutation '1100110001', which corresponds to 'HHLLHHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'