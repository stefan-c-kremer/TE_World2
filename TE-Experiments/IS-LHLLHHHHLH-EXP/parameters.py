...
# Used permutation '0100111101', which corresponds to 'LHLLHHHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'