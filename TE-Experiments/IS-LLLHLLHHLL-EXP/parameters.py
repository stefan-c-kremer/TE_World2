...
# Used permutation '0001001100', which corresponds to 'LLLHLLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'