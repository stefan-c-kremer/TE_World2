...
# Used permutation '1111001101', which corresponds to 'HHHHLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'