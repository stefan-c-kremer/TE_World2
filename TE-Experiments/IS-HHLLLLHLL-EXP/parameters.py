...
# Used permutation '110000100', which corresponds to 'HHLLLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'