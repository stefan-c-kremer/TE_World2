...
# Used permutation '000101002', which corresponds to 'LLLHLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'