...
# Used permutation '010111111', which corresponds to 'LHLHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'