...
# Used permutation '0001100101', which corresponds to 'LLLHHLLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'