...
# Used permutation '0101010000', which corresponds to 'LHLHLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'