...
# Used permutation '000000011', which corresponds to 'LLLLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'