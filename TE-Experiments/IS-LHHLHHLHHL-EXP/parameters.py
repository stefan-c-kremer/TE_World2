...
# Used permutation '0110110110', which corresponds to 'LHHLHHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'