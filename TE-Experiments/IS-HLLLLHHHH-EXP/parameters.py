...
# Used permutation '100001111', which corresponds to 'HLLLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'