...
# Used permutation '001010100', which corresponds to 'LLHLHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'