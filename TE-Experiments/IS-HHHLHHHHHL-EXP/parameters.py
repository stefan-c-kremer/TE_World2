...
# Used permutation '1110111110', which corresponds to 'HHHLHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'