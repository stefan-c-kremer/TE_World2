...
# Used permutation '1000000000', which corresponds to 'HLLLLLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'