...
# Used permutation '1000101000', which corresponds to 'HLLLHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'