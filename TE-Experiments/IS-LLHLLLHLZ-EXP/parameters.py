...
# Used permutation '001000102', which corresponds to 'LLHLLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'