...
# Used permutation '111100012', which corresponds to 'HHHHLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'