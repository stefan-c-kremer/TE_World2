...
# Used permutation '010000111', which corresponds to 'LHLLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'