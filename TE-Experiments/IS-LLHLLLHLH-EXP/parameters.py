...
# Used permutation '001000101', which corresponds to 'LLHLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'