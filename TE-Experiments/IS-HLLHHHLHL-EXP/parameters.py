...
# Used permutation '100111010', which corresponds to 'HLLHHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'