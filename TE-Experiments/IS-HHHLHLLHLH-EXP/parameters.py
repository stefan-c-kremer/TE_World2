...
# Used permutation '1110100101', which corresponds to 'HHHLHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'