...
# Used permutation '1000100111', which corresponds to 'HLLLHLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'