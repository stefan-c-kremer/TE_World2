...
# Used permutation '010011102', which corresponds to 'LHLLHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'