...
# Used permutation '0110001100', which corresponds to 'LHHLLLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'