...
# Used permutation '1100110110', which corresponds to 'HHLLHHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'