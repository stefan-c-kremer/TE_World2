...
# Used permutation '1011100001', which corresponds to 'HLHHHLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'