...
# Used permutation '1101011000', which corresponds to 'HHLHLHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'