...
# Used permutation '101000011', which corresponds to 'HLHLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'