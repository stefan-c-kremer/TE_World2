...
# Used permutation '0110111110', which corresponds to 'LHHLHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'