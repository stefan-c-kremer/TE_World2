...
# Used permutation '000110012', which corresponds to 'LLLHHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'