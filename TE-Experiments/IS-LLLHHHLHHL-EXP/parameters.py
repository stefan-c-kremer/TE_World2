...
# Used permutation '0001110110', which corresponds to 'LLLHHHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'