...
# Used permutation '110011100', which corresponds to 'HHLLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'