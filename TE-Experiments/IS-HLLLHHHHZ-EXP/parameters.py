...
# Used permutation '100011112', which corresponds to 'HLLLHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'