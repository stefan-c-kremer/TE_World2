...
# Used permutation '0100011000', which corresponds to 'LHLLLHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'