...
# Used permutation '0110011001', which corresponds to 'LHHLLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'