...
# Used permutation '111111112', which corresponds to 'HHHHHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'