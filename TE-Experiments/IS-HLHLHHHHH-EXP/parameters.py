...
# Used permutation '101011111', which corresponds to 'HLHLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'