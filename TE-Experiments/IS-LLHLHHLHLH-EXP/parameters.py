...
# Used permutation '0010110101', which corresponds to 'LLHLHHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'