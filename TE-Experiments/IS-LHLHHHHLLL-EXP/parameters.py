...
# Used permutation '0101111000', which corresponds to 'LHLHHHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'