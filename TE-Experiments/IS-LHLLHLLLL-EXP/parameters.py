...
# Used permutation '010010000', which corresponds to 'LHLLHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'