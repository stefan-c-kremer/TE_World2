...
# Used permutation '0110011100', which corresponds to 'LHHLLHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'