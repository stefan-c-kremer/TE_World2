...
# Used permutation '0001000100', which corresponds to 'LLLHLLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'