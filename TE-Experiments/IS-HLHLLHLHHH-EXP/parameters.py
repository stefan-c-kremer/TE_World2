...
# Used permutation '1010010111', which corresponds to 'HLHLLHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'