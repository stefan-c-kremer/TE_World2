...
# Used permutation '0010010111', which corresponds to 'LLHLLHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'