...
# Used permutation '001001011', which corresponds to 'LLHLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'