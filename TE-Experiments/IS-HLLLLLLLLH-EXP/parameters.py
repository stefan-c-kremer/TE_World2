...
# Used permutation '1000000001', which corresponds to 'HLLLLLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'