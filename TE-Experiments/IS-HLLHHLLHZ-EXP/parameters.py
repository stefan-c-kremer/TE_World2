...
# Used permutation '100110012', which corresponds to 'HLLHHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'