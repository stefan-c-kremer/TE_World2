...
# Used permutation '0001000000', which corresponds to 'LLLHLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'