...
# Used permutation '101101012', which corresponds to 'HLHHLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'