...
# Used permutation '000001002', which corresponds to 'LLLLLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'