...
# Used permutation '010101101', which corresponds to 'LHLHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'