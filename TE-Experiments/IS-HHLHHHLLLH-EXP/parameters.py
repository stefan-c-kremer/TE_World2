...
# Used permutation '1101110001', which corresponds to 'HHLHHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'