...
# Used permutation '100001112', which corresponds to 'HLLLLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'