...
# Used permutation '0011100100', which corresponds to 'LLHHHLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'