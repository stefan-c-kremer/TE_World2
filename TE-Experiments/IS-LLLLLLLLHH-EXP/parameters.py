...
# Used permutation '0000000011', which corresponds to 'LLLLLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'