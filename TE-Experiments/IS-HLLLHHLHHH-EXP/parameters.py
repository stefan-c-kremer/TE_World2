...
# Used permutation '1000110111', which corresponds to 'HLLLHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'