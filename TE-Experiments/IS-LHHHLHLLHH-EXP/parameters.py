...
# Used permutation '0111010011', which corresponds to 'LHHHLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'