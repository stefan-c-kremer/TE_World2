...
# Used permutation '111111011', which corresponds to 'HHHHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'