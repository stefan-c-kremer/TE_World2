...
# Used permutation '111100101', which corresponds to 'HHHHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'