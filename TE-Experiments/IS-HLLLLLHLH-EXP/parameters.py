...
# Used permutation '100000101', which corresponds to 'HLLLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'