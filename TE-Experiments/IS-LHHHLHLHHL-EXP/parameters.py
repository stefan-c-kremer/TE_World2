...
# Used permutation '0111010110', which corresponds to 'LHHHLHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'