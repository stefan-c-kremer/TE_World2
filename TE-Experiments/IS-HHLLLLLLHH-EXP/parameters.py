...
# Used permutation '1100000011', which corresponds to 'HHLLLLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'