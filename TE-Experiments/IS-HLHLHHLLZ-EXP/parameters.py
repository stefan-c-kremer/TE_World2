...
# Used permutation '101011002', which corresponds to 'HLHLHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'