...
# Used permutation '010001102', which corresponds to 'LHLLLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'