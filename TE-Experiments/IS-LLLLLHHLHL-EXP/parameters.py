...
# Used permutation '0000011010', which corresponds to 'LLLLLHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'