...
# Used permutation '1111011110', which corresponds to 'HHHHLHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'