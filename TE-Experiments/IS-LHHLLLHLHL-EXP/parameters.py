...
# Used permutation '0110001010', which corresponds to 'LHHLLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'