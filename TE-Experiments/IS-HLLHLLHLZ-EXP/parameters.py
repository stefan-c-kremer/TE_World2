...
# Used permutation '100100102', which corresponds to 'HLLHLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'