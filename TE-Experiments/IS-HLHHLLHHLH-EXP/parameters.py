...
# Used permutation '1011001101', which corresponds to 'HLHHLLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'