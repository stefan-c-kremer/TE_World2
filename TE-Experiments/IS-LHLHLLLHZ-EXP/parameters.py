...
# Used permutation '010100012', which corresponds to 'LHLHLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'