...
# Used permutation '111000101', which corresponds to 'HHHLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'