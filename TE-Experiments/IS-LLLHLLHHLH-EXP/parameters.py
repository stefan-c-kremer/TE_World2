...
# Used permutation '0001001101', which corresponds to 'LLLHLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'