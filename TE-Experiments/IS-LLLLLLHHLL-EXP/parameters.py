...
# Used permutation '0000001100', which corresponds to 'LLLLLLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'