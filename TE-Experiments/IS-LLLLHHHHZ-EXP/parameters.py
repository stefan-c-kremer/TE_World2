...
# Used permutation '000011112', which corresponds to 'LLLLHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'