...
# Used permutation '0111010000', which corresponds to 'LHHHLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'