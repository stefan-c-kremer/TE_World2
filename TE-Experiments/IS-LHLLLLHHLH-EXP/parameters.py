...
# Used permutation '0100001101', which corresponds to 'LHLLLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'