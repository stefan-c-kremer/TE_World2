...
# Used permutation '011011010', which corresponds to 'LHHLHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'