...
# Used permutation '100110002', which corresponds to 'HLLHHLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'