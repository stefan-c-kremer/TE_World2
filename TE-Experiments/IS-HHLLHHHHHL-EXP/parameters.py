...
# Used permutation '1100111110', which corresponds to 'HHLLHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'