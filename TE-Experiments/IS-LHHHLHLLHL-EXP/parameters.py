...
# Used permutation '0111010010', which corresponds to 'LHHHLHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'