...
# Used permutation '101101112', which corresponds to 'HLHHLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'