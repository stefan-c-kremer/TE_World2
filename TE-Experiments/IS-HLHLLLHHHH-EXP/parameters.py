...
# Used permutation '1010001111', which corresponds to 'HLHLLLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'