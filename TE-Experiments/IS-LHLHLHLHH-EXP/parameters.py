...
# Used permutation '010101011', which corresponds to 'LHLHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'