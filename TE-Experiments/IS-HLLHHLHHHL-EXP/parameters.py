...
# Used permutation '1001101110', which corresponds to 'HLLHHLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'