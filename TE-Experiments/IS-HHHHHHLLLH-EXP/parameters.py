...
# Used permutation '1111110001', which corresponds to 'HHHHHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'