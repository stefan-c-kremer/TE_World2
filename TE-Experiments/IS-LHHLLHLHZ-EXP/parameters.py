...
# Used permutation '011001012', which corresponds to 'LHHLLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'