...
# Used permutation '1011001111', which corresponds to 'HLHHLLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'