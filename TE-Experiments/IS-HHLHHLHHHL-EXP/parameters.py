...
# Used permutation '1101101110', which corresponds to 'HHLHHLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'