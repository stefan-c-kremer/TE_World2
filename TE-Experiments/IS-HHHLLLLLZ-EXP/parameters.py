...
# Used permutation '111000002', which corresponds to 'HHHLLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'