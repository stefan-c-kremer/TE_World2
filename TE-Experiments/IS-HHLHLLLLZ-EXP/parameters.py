...
# Used permutation '110100002', which corresponds to 'HHLHLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'