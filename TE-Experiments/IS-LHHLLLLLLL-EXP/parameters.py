...
# Used permutation '0110000000', which corresponds to 'LHHLLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'