...
# Used permutation '0001010100', which corresponds to 'LLLHLHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'