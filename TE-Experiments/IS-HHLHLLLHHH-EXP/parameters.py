...
# Used permutation '1101000111', which corresponds to 'HHLHLLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'