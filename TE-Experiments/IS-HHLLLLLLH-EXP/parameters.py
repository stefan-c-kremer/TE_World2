...
# Used permutation '110000001', which corresponds to 'HHLLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'