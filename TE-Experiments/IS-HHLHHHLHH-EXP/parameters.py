...
# Used permutation '110111011', which corresponds to 'HHLHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'