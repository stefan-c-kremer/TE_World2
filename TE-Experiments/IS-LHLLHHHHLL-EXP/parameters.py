...
# Used permutation '0100111100', which corresponds to 'LHLLHHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'