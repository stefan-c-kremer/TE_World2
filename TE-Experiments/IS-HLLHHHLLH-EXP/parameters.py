...
# Used permutation '100111001', which corresponds to 'HLLHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'