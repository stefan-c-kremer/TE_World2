...
# Used permutation '110101001', which corresponds to 'HHLHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'