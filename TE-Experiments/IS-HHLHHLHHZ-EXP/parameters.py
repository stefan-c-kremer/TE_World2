...
# Used permutation '110110112', which corresponds to 'HHLHHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'