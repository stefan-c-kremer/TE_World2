...
# Used permutation '1100010110', which corresponds to 'HHLLLHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'