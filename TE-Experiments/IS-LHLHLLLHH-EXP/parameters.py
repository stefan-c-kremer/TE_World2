...
# Used permutation '010100011', which corresponds to 'LHLHLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'