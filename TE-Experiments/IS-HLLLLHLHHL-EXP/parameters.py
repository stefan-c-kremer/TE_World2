...
# Used permutation '1000010110', which corresponds to 'HLLLLHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'