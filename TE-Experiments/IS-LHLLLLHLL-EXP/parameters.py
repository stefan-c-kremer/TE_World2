...
# Used permutation '010000100', which corresponds to 'LHLLLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'