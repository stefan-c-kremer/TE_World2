...
# Used permutation '100101002', which corresponds to 'HLLHLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'