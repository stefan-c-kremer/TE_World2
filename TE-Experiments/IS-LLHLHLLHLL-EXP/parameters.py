...
# Used permutation '0010100100', which corresponds to 'LLHLHLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'