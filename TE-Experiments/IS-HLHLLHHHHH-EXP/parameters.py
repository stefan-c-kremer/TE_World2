...
# Used permutation '1010011111', which corresponds to 'HLHLLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'