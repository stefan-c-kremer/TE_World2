...
# Used permutation '0000100111', which corresponds to 'LLLLHLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'