...
# Used permutation '011000110', which corresponds to 'LHHLLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'