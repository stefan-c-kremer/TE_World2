...
# Used permutation '110010012', which corresponds to 'HHLLHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'