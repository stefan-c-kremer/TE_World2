...
# Used permutation '110101101', which corresponds to 'HHLHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'