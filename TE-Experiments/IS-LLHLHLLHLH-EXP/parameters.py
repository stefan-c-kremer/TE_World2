...
# Used permutation '0010100101', which corresponds to 'LLHLHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'