...
# Used permutation '000100012', which corresponds to 'LLLHLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'