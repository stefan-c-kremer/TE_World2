...
# Used permutation '111010101', which corresponds to 'HHHLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'