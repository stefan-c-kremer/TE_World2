...
# Used permutation '110000102', which corresponds to 'HHLLLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'