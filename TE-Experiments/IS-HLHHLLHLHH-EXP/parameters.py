...
# Used permutation '1011001011', which corresponds to 'HLHHLLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'