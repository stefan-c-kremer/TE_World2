...
# Used permutation '1011001011', which corresponds to 'HLHHLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'