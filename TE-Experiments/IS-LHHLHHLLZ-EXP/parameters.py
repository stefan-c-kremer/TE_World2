...
# Used permutation '011011002', which corresponds to 'LHHLHHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'