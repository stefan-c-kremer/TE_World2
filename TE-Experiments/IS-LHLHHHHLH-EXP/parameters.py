...
# Used permutation '010111101', which corresponds to 'LHLHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'