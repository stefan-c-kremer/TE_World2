...
# Used permutation '1110110010', which corresponds to 'HHHLHHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'