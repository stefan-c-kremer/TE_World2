...
# Used permutation '0010011000', which corresponds to 'LLHLLHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'