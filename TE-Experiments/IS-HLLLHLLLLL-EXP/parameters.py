...
# Used permutation '1000100000', which corresponds to 'HLLLHLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'