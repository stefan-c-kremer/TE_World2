...
# Used permutation '010110011', which corresponds to 'LHLHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'