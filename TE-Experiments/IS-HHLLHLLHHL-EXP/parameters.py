...
# Used permutation '1100100110', which corresponds to 'HHLLHLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'