...
# Used permutation '1010010011', which corresponds to 'HLHLLHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'