...
# Used permutation '000011001', which corresponds to 'LLLLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'