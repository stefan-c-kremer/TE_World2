...
# Used permutation '1111111111', which corresponds to 'HHHHHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'