...
# Used permutation '1101000001', which corresponds to 'HHLHLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'