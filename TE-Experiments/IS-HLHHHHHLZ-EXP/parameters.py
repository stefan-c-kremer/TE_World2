...
# Used permutation '101111102', which corresponds to 'HLHHHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'