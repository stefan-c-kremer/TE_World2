...
# Used permutation '1001101111', which corresponds to 'HLLHHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'