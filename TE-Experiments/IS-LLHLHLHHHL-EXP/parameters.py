...
# Used permutation '0010101110', which corresponds to 'LLHLHLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'