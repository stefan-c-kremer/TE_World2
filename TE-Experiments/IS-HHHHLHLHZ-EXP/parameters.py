...
# Used permutation '111101012', which corresponds to 'HHHHLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'