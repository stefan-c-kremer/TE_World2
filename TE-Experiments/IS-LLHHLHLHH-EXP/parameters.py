...
# Used permutation '001101011', which corresponds to 'LLHHLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'