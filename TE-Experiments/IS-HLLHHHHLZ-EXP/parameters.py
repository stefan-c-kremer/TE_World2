...
# Used permutation '100111102', which corresponds to 'HLLHHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'