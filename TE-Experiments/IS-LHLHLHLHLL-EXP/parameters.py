...
# Used permutation '0101010100', which corresponds to 'LHLHLHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'