...
# Used permutation '1111110101', which corresponds to 'HHHHHHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'