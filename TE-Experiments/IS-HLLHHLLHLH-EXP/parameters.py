...
# Used permutation '1001100101', which corresponds to 'HLLHHLLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'