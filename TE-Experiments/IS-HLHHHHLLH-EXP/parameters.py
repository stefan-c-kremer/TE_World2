...
# Used permutation '101111001', which corresponds to 'HLHHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'