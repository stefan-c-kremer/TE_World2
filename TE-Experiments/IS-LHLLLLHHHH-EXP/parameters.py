...
# Used permutation '0100001111', which corresponds to 'LHLLLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'