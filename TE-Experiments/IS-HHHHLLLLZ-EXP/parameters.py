...
# Used permutation '111100002', which corresponds to 'HHHHLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'