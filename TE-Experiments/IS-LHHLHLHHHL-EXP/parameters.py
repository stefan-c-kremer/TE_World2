...
# Used permutation '0110101110', which corresponds to 'LHHLHLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'