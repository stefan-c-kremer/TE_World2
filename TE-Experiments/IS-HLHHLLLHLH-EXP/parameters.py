...
# Used permutation '1011000101', which corresponds to 'HLHHLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'