...
# Used permutation '0101011100', which corresponds to 'LHLHLHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'