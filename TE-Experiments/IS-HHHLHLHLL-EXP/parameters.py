...
# Used permutation '111010100', which corresponds to 'HHHLHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'