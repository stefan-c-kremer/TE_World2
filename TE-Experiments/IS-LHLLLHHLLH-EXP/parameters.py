...
# Used permutation '0100011001', which corresponds to 'LHLLLHHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'