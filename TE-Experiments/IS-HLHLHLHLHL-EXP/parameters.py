...
# Used permutation '1010101010', which corresponds to 'HLHLHLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'