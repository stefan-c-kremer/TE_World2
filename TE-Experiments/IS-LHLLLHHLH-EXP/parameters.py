...
# Used permutation '010001101', which corresponds to 'LHLLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'