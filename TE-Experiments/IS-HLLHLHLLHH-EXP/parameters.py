...
# Used permutation '1001010011', which corresponds to 'HLLHLHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'