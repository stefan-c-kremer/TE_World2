...
# Used permutation '0101001000', which corresponds to 'LHLHLLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'