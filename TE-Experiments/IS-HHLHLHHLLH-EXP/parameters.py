...
# Used permutation '1101011001', which corresponds to 'HHLHLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'