...
# Used permutation '0011100110', which corresponds to 'LLHHHLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'