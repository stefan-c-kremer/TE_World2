...
# Used permutation '000011010', which corresponds to 'LLLLHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'