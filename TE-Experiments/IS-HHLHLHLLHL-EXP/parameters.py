...
# Used permutation '1101010010', which corresponds to 'HHLHLHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'