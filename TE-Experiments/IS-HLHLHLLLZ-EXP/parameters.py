...
# Used permutation '101010002', which corresponds to 'HLHLHLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'