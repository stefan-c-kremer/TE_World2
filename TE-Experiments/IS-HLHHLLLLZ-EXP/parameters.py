...
# Used permutation '101100002', which corresponds to 'HLHHLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'