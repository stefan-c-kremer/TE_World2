...
# Used permutation '0001111011', which corresponds to 'LLLHHHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'