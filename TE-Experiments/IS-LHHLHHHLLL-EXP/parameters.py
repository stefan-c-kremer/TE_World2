...
# Used permutation '0110111000', which corresponds to 'LHHLHHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'