...
# Used permutation '100110112', which corresponds to 'HLLHHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'