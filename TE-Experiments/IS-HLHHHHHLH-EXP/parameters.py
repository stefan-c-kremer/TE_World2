...
# Used permutation '101111101', which corresponds to 'HLHHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'