...
# Used permutation '000001001', which corresponds to 'LLLLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'