...
# Used permutation '000110001', which corresponds to 'LLLHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'