...
# Used permutation '011011102', which corresponds to 'LHHLHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'