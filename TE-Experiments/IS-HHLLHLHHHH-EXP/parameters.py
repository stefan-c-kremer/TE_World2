...
# Used permutation '1100101111', which corresponds to 'HHLLHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'