...
# Used permutation '0010101100', which corresponds to 'LLHLHLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'