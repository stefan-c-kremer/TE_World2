...
# Used permutation '0010101100', which corresponds to 'LLHLHLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'