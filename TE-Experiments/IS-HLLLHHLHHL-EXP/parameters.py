...
# Used permutation '1000110110', which corresponds to 'HLLLHHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'