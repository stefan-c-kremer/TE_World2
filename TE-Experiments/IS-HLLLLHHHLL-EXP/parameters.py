...
# Used permutation '1000011100', which corresponds to 'HLLLLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'