...
# Used permutation '000101012', which corresponds to 'LLLHLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'