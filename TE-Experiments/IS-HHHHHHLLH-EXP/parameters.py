...
# Used permutation '111111001', which corresponds to 'HHHHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'