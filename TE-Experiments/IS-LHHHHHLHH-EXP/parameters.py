...
# Used permutation '011111011', which corresponds to 'LHHHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'