...
# Used permutation '100111112', which corresponds to 'HLLHHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'