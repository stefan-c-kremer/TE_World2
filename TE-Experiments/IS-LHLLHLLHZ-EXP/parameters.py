...
# Used permutation '010010012', which corresponds to 'LHLLHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'