...
# Used permutation '011001102', which corresponds to 'LHHLLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'