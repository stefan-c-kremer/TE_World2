...
# Used permutation '1000111001', which corresponds to 'HLLLHHHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'