...
# Used permutation '1000111001', which corresponds to 'HLLLHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'