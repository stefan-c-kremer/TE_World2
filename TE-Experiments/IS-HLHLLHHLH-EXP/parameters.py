...
# Used permutation '101001101', which corresponds to 'HLHLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'