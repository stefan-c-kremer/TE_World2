...
# Used permutation '0001111010', which corresponds to 'LLLHHHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'