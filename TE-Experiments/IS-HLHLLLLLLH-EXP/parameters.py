...
# Used permutation '1010000001', which corresponds to 'HLHLLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'