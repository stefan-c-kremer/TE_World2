...
# Used permutation '111100011', which corresponds to 'HHHHLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'