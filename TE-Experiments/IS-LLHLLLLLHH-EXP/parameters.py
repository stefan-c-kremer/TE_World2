...
# Used permutation '0010000011', which corresponds to 'LLHLLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'