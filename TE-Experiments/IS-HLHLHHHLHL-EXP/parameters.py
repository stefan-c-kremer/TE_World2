...
# Used permutation '1010111010', which corresponds to 'HLHLHHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'