...
# Used permutation '1000001001', which corresponds to 'HLLLLLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'