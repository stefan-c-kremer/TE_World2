...
# Used permutation '1001100110', which corresponds to 'HLLHHLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'