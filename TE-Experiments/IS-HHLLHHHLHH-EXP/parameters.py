...
# Used permutation '1100111011', which corresponds to 'HHLLHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'