...
# Used permutation '1111010100', which corresponds to 'HHHHLHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'