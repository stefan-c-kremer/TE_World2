...
# Used permutation '111011011', which corresponds to 'HHHLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'