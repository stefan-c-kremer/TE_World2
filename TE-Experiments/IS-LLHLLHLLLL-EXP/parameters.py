...
# Used permutation '0010010000', which corresponds to 'LLHLLHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'