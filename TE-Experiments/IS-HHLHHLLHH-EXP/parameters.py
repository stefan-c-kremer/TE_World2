...
# Used permutation '110110011', which corresponds to 'HHLHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'