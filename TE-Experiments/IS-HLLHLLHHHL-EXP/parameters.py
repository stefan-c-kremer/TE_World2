...
# Used permutation '1001001110', which corresponds to 'HLLHLLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'