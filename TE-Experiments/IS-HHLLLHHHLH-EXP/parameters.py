...
# Used permutation '1100011101', which corresponds to 'HHLLLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'