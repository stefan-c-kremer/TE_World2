...
# Used permutation '1101101001', which corresponds to 'HHLHHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'