...
# Used permutation '011010010', which corresponds to 'LHHLHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'