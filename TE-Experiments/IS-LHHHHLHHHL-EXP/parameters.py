...
# Used permutation '0111101110', which corresponds to 'LHHHHLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'