...
# Used permutation '1100110000', which corresponds to 'HHLLHHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'