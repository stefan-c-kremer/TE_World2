...
# Used permutation '1101111001', which corresponds to 'HHLHHHHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'