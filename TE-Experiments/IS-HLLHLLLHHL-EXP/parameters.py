...
# Used permutation '1001000110', which corresponds to 'HLLHLLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'