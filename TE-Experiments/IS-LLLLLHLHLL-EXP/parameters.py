...
# Used permutation '0000010100', which corresponds to 'LLLLLHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'