...
# Used permutation '1100111000', which corresponds to 'HHLLHHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'