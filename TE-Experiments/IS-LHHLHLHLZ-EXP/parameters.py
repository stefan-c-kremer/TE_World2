...
# Used permutation '011010102', which corresponds to 'LHHLHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'