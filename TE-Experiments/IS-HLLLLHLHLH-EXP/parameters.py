...
# Used permutation '1000010101', which corresponds to 'HLLLLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'