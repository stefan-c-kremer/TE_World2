...
# Used permutation '1111000110', which corresponds to 'HHHHLLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'