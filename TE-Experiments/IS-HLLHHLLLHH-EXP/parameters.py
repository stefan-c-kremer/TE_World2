...
# Used permutation '1001100011', which corresponds to 'HLLHHLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'