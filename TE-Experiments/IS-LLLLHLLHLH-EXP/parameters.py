...
# Used permutation '0000100101', which corresponds to 'LLLLHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'