...
# Used permutation '0000101100', which corresponds to 'LLLLHLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'