...
# Used permutation '101000112', which corresponds to 'HLHLLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'