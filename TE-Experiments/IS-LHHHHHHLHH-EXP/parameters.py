...
# Used permutation '0111111011', which corresponds to 'LHHHHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'