...
# Used permutation '1010010101', which corresponds to 'HLHLLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'