...
# Used permutation '1110101111', which corresponds to 'HHHLHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'