...
# Used permutation '1000101111', which corresponds to 'HLLLHLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'