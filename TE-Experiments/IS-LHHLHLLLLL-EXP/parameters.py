...
# Used permutation '0110100000', which corresponds to 'LHHLHLLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'