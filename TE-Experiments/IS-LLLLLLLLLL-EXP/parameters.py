...
# Used permutation '0000000000', which corresponds to 'LLLLLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'