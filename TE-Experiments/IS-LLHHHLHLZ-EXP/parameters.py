...
# Used permutation '001110102', which corresponds to 'LLHHHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'