...
# Used permutation '1111011000', which corresponds to 'HHHHLHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'