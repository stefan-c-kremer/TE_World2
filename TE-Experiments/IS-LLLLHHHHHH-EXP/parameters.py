...
# Used permutation '0000111111', which corresponds to 'LLLLHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'