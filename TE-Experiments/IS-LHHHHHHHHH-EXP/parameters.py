...
# Used permutation '0111111111', which corresponds to 'LHHHHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'