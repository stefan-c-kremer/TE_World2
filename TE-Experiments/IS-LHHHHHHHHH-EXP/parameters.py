...
# Used permutation '0111111111', which corresponds to 'LHHHHHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'