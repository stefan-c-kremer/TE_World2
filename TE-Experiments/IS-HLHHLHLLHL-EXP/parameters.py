...
# Used permutation '1011010010', which corresponds to 'HLHHLHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'