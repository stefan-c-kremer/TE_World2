...
# Used permutation '1101111110', which corresponds to 'HHLHHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'