...
# Used permutation '001100102', which corresponds to 'LLHHLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'