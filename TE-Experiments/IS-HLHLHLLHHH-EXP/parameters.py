...
# Used permutation '1010100111', which corresponds to 'HLHLHLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'