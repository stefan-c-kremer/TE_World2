...
# Used permutation '0001010011', which corresponds to 'LLLHLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'