...
# Used permutation '0000010111', which corresponds to 'LLLLLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'