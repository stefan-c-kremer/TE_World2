...
# Used permutation '0010110010', which corresponds to 'LLHLHHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'