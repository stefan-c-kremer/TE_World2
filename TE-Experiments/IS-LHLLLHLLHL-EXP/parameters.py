...
# Used permutation '0100010010', which corresponds to 'LHLLLHLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'