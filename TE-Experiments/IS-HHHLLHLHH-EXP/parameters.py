...
# Used permutation '111001011', which corresponds to 'HHHLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'