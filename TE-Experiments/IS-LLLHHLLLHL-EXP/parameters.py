...
# Used permutation '0001100010', which corresponds to 'LLLHHLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'