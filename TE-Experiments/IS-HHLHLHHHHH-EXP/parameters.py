...
# Used permutation '1101011111', which corresponds to 'HHLHLHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'