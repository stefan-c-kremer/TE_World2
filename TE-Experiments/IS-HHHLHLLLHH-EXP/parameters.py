...
# Used permutation '1110100011', which corresponds to 'HHHLHLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'