...
# Used permutation '0111001111', which corresponds to 'LHHHLLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'