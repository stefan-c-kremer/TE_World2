...
# Used permutation '001001001', which corresponds to 'LLHLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'