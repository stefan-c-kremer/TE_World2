...
# Used permutation '0111001000', which corresponds to 'LHHHLLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'