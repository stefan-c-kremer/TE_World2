...
# Used permutation '011011112', which corresponds to 'LHHLHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'