...
# Used permutation '100011012', which corresponds to 'HLLLHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'