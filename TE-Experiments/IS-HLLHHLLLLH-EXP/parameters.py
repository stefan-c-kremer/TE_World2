...
# Used permutation '1001100001', which corresponds to 'HLLHHLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'