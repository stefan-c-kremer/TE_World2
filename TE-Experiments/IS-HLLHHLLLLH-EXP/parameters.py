...
# Used permutation '1001100001', which corresponds to 'HLLHHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'