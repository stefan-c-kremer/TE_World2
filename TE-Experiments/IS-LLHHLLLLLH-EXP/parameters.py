...
# Used permutation '0011000001', which corresponds to 'LLHHLLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'