...
# Used permutation '1010001010', which corresponds to 'HLHLLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'