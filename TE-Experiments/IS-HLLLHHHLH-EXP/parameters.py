...
# Used permutation '100011101', which corresponds to 'HLLLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'