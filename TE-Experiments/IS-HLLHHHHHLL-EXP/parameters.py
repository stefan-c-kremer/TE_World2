...
# Used permutation '1001111100', which corresponds to 'HLLHHHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'