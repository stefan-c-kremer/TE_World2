...
# Used permutation '0101100000', which corresponds to 'LHLHHLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'