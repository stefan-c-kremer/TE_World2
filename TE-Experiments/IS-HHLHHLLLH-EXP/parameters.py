...
# Used permutation '110110001', which corresponds to 'HHLHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'