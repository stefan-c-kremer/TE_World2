...
# Used permutation '1101111000', which corresponds to 'HHLHHHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'