...
# Used permutation '111000110', which corresponds to 'HHHLLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'