...
# Used permutation '0100111011', which corresponds to 'LHLLHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'