...
# Used permutation '0010011111', which corresponds to 'LLHLLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'