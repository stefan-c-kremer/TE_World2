...
# Used permutation '0010101111', which corresponds to 'LLHLHLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'