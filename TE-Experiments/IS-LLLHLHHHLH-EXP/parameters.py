...
# Used permutation '0001011101', which corresponds to 'LLLHLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'