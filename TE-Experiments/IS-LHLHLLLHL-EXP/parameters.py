...
# Used permutation '010100010', which corresponds to 'LHLHLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'