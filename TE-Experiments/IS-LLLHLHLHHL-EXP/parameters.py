...
# Used permutation '0001010110', which corresponds to 'LLLHLHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'