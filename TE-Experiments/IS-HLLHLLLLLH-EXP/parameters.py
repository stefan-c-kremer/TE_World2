...
# Used permutation '1001000001', which corresponds to 'HLLHLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'