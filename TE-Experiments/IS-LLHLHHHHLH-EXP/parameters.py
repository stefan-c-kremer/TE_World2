...
# Used permutation '0010111101', which corresponds to 'LLHLHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'