...
# Used permutation '0111101010', which corresponds to 'LHHHHLHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'