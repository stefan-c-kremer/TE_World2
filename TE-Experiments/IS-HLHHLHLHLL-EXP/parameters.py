...
# Used permutation '1011010100', which corresponds to 'HLHHLHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'