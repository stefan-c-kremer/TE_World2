...
# Used permutation '1110010111', which corresponds to 'HHHLLHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'