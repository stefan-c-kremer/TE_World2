...
# Used permutation '000000002', which corresponds to 'LLLLLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'