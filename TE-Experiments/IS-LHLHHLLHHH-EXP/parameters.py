...
# Used permutation '0101100111', which corresponds to 'LHLHHLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'