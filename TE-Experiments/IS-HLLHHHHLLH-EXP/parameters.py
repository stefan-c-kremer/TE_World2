...
# Used permutation '1001111001', which corresponds to 'HLLHHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'