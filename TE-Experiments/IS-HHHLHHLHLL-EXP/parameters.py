...
# Used permutation '1110110100', which corresponds to 'HHHLHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'