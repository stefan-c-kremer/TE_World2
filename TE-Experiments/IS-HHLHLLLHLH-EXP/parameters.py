...
# Used permutation '1101000101', which corresponds to 'HHLHLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'