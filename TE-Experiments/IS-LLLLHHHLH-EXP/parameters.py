...
# Used permutation '000011101', which corresponds to 'LLLLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'