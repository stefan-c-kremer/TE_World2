...
# Used permutation '100101102', which corresponds to 'HLLHLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'