...
# Used permutation '100011111', which corresponds to 'HLLLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'