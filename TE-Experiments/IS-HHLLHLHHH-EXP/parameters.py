...
# Used permutation '110010111', which corresponds to 'HHLLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'