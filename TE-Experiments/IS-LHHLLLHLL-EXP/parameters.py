...
# Used permutation '011000100', which corresponds to 'LHHLLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'