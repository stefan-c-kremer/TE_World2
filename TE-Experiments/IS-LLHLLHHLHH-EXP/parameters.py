...
# Used permutation '0010011011', which corresponds to 'LLHLLHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'