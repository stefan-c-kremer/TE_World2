...
# Used permutation '110010101', which corresponds to 'HHLLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'