...
# Used permutation '111001112', which corresponds to 'HHHLLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'