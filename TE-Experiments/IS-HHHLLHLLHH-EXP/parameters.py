...
# Used permutation '1110010011', which corresponds to 'HHHLLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'