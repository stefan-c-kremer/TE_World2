...
# Used permutation '1001011110', which corresponds to 'HLLHLHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'