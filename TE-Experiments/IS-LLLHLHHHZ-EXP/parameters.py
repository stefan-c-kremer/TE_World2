...
# Used permutation '000101112', which corresponds to 'LLLHLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'