...
# Used permutation '1111100101', which corresponds to 'HHHHHLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'