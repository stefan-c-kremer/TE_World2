...
# Used permutation '011011012', which corresponds to 'LHHLHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'