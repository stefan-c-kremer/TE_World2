...
# Used permutation '001000002', which corresponds to 'LLHLLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'