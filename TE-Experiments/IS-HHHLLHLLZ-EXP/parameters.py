...
# Used permutation '111001002', which corresponds to 'HHHLLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'