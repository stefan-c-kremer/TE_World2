...
# Used permutation '010010102', which corresponds to 'LHLLHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'