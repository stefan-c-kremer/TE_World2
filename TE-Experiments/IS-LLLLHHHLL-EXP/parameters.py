...
# Used permutation '000011100', which corresponds to 'LLLLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'