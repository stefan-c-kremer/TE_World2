...
# Used permutation '111010001', which corresponds to 'HHHLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'