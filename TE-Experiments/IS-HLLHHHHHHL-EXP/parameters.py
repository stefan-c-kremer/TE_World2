...
# Used permutation '1001111110', which corresponds to 'HLLHHHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'