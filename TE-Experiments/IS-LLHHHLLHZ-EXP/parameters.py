...
# Used permutation '001110012', which corresponds to 'LLHHHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'