...
# Used permutation '0100010001', which corresponds to 'LHLLLHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'