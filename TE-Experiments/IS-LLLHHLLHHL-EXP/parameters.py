...
# Used permutation '0001100110', which corresponds to 'LLLHHLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'