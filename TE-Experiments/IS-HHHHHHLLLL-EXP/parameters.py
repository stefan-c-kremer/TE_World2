...
# Used permutation '1111110000', which corresponds to 'HHHHHHLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'