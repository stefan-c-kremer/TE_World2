...
# Used permutation '0011001000', which corresponds to 'LLHHLLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'