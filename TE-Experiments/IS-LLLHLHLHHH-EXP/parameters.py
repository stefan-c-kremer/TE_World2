...
# Used permutation '0001010111', which corresponds to 'LLLHLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'