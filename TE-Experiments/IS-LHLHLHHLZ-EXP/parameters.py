...
# Used permutation '010101102', which corresponds to 'LHLHLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'