...
# Used permutation '111110111', which corresponds to 'HHHHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'