...
# Used permutation '1101000010', which corresponds to 'HHLHLLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'