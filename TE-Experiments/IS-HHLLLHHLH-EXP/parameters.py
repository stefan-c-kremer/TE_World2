...
# Used permutation '110001101', which corresponds to 'HHLLLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'