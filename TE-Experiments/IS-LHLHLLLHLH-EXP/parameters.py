...
# Used permutation '0101000101', which corresponds to 'LHLHLLLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'