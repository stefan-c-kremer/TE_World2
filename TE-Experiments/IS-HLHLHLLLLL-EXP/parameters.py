...
# Used permutation '1010100000', which corresponds to 'HLHLHLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'