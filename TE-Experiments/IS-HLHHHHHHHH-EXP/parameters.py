...
# Used permutation '1011111111', which corresponds to 'HLHHHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'