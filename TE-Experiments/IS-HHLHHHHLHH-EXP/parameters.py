...
# Used permutation '1101111011', which corresponds to 'HHLHHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'