...
# Used permutation '1111001010', which corresponds to 'HHHHLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'