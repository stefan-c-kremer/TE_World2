...
# Used permutation '0011111001', which corresponds to 'LLHHHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'