...
# Used permutation '1111010001', which corresponds to 'HHHHLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'