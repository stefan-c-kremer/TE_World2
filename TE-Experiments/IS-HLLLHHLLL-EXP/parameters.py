...
# Used permutation '100011000', which corresponds to 'HLLLHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'