...
# Used permutation '011010001', which corresponds to 'LHHLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'