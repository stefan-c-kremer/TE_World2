...
# Used permutation '101111000', which corresponds to 'HLHHHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'