...
# Used permutation '1110101101', which corresponds to 'HHHLHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'