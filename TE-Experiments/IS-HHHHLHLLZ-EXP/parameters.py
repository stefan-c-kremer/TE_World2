...
# Used permutation '111101002', which corresponds to 'HHHHLHLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'