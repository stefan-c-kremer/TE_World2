...
# Used permutation '100100112', which corresponds to 'HLLHLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'