...
# Used permutation '0010110110', which corresponds to 'LLHLHHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'