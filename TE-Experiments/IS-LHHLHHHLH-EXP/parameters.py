...
# Used permutation '011011101', which corresponds to 'LHHLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'