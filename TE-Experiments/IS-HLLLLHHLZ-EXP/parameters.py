...
# Used permutation '100001102', which corresponds to 'HLLLLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'