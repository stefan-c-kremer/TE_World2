...
# Used permutation '001111012', which corresponds to 'LLHHHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'