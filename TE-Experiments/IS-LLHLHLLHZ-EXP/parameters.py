...
# Used permutation '001010012', which corresponds to 'LLHLHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'