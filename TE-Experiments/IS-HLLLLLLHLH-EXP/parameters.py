...
# Used permutation '1000000101', which corresponds to 'HLLLLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'