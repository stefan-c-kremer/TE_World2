...
# Used permutation '110011102', which corresponds to 'HHLLHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'