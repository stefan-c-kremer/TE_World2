...
# Used permutation '1001101101', which corresponds to 'HLLHHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'