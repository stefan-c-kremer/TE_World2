...
# Used permutation '001101100', which corresponds to 'LLHHLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'