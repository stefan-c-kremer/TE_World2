...
# Used permutation '1100101100', which corresponds to 'HHLLHLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'