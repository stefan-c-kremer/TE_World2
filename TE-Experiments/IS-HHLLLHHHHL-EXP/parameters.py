...
# Used permutation '1100011110', which corresponds to 'HHLLLHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'