...
# Used permutation '011101100', which corresponds to 'LHHHLHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'