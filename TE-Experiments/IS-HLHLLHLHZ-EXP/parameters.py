...
# Used permutation '101001012', which corresponds to 'HLHLLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'