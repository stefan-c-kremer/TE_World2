...
# Used permutation '0010001110', which corresponds to 'LLHLLLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'