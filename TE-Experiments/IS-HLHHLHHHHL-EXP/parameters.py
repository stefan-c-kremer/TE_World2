...
# Used permutation '1011011110', which corresponds to 'HLHHLHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'