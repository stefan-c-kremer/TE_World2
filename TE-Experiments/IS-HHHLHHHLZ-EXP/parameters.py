...
# Used permutation '111011102', which corresponds to 'HHHLHHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'