...
# Used permutation '0111011000', which corresponds to 'LHHHLHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'