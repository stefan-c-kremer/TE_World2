...
# Used permutation '0110110000', which corresponds to 'LHHLHHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'