...
# Used permutation '1000111101', which corresponds to 'HLLLHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'