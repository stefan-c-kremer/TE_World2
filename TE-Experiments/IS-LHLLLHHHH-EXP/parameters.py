...
# Used permutation '010001111', which corresponds to 'LHLLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'