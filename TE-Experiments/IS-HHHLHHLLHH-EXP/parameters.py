...
# Used permutation '1110110011', which corresponds to 'HHHLHHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'