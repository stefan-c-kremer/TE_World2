...
# Used permutation '011110002', which corresponds to 'LHHHHLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'