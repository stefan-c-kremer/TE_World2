...
# Used permutation '1001000010', which corresponds to 'HLLHLLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'