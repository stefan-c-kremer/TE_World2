...
# Used permutation '000000100', which corresponds to 'LLLLLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'