...
# Used permutation '100100012', which corresponds to 'HLLHLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'