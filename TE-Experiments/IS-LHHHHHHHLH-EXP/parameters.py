...
# Used permutation '0111111101', which corresponds to 'LHHHHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'