...
# Used permutation '1101000110', which corresponds to 'HHLHLLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'