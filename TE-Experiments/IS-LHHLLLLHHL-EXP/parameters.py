...
# Used permutation '0110000110', which corresponds to 'LHHLLLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'