...
# Used permutation '0000111101', which corresponds to 'LLLLHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'