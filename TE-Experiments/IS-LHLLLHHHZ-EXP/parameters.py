...
# Used permutation '010001112', which corresponds to 'LHLLLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'