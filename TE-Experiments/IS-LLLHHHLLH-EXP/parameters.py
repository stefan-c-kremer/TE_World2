...
# Used permutation '000111001', which corresponds to 'LLLHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'