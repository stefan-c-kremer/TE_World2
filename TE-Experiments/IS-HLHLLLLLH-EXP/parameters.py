...
# Used permutation '101000001', which corresponds to 'HLHLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'