...
# Used permutation '0000110100', which corresponds to 'LLLLHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'