...
# Used permutation '1100000101', which corresponds to 'HHLLLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'