...
# Used permutation '1101011101', which corresponds to 'HHLHLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'