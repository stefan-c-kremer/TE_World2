...
# Used permutation '111111012', which corresponds to 'HHHHHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'