...
# Used permutation '1111000111', which corresponds to 'HHHHLLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'