...
# Used permutation '101001111', which corresponds to 'HLHLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'