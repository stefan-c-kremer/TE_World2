...
# Used permutation '0001011110', which corresponds to 'LLLHLHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'