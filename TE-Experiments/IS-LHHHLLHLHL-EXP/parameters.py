...
# Used permutation '0111001010', which corresponds to 'LHHHLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'