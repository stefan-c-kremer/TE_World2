...
# Used permutation '0011010011', which corresponds to 'LLHHLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'