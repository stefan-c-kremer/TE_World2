...
# Used permutation '0011010011', which corresponds to 'LLHHLHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'