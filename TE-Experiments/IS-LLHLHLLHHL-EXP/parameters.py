...
# Used permutation '0010100110', which corresponds to 'LLHLHLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'