...
# Used permutation '0110111001', which corresponds to 'LHHLHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'