...
# Used permutation '100000012', which corresponds to 'HLLLLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'