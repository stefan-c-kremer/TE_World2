...
# Used permutation '100110111', which corresponds to 'HLLHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'