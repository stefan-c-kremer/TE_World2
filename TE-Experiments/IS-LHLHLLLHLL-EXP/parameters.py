...
# Used permutation '0101000100', which corresponds to 'LHLHLLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'