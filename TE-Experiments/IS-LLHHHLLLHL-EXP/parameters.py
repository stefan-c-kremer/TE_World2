...
# Used permutation '0011100010', which corresponds to 'LLHHHLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'