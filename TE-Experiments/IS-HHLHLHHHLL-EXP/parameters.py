...
# Used permutation '1101011100', which corresponds to 'HHLHLHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'