...
# Used permutation '101111012', which corresponds to 'HLHHHHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'