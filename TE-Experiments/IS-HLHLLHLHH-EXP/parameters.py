...
# Used permutation '101001011', which corresponds to 'HLHLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'