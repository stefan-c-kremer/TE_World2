...
# Used permutation '0100111010', which corresponds to 'LHLLHHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'