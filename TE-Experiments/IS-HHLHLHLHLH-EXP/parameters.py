...
# Used permutation '1101010101', which corresponds to 'HHLHLHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'