...
# Used permutation '0101001010', which corresponds to 'LHLHLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'