...
# Used permutation '1010111101', which corresponds to 'HLHLHHHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'