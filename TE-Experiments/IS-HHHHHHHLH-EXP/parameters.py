...
# Used permutation '111111101', which corresponds to 'HHHHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'