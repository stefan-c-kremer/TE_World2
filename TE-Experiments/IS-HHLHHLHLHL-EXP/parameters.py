...
# Used permutation '1101101010', which corresponds to 'HHLHHLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'