...
# Used permutation '110000112', which corresponds to 'HHLLLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'