...
# Used permutation '0000101101', which corresponds to 'LLLLHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'