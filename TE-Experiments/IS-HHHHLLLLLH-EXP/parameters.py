...
# Used permutation '1111000001', which corresponds to 'HHHHLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'