...
# Used permutation '001010110', which corresponds to 'LLHLHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'