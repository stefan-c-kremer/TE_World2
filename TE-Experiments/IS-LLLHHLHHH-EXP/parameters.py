...
# Used permutation '000110111', which corresponds to 'LLLHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'