...
# Used permutation '010110102', which corresponds to 'LHLHHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'