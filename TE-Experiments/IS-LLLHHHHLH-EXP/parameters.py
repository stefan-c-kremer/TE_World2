...
# Used permutation '000111101', which corresponds to 'LLLHHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'