...
# Used permutation '1111110011', which corresponds to 'HHHHHHLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'