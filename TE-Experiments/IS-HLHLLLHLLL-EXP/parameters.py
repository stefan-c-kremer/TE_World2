...
# Used permutation '1010001000', which corresponds to 'HLHLLLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'