...
# Used permutation '010000112', which corresponds to 'LHLLLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'