...
# Used permutation '0110010100', which corresponds to 'LHHLLHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'