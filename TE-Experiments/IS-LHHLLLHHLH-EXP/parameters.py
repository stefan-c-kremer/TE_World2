...
# Used permutation '0110001101', which corresponds to 'LHHLLLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'