...
# Used permutation '1100100010', which corresponds to 'HHLLHLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'