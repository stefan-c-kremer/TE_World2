...
# Used permutation '0101100010', which corresponds to 'LHLHHLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'