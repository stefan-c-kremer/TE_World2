...
# Used permutation '001101102', which corresponds to 'LLHHLHHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'