...
# Used permutation '0011001011', which corresponds to 'LLHHLLHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'