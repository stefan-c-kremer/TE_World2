...
# Used permutation '1110001101', which corresponds to 'HHHLLLHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'