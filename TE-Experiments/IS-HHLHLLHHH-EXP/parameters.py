...
# Used permutation '110100111', which corresponds to 'HHLHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'