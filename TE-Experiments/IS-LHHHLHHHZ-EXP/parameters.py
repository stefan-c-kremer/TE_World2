...
# Used permutation '011101112', which corresponds to 'LHHHLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'