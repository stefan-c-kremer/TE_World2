...
# Used permutation '0011011011', which corresponds to 'LLHHLHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'