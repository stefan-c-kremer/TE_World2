...
# Used permutation '0110100111', which corresponds to 'LHHLHLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'