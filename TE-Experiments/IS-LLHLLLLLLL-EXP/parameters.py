...
# Used permutation '0010000000', which corresponds to 'LLHLLLLLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'