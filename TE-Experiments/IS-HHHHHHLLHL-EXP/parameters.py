...
# Used permutation '1111110010', which corresponds to 'HHHHHHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'