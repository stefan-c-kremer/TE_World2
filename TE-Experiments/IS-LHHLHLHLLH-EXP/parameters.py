...
# Used permutation '0110101001', which corresponds to 'LHHLHLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'