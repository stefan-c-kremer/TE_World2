...
# Used permutation '001001010', which corresponds to 'LLHLLHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'