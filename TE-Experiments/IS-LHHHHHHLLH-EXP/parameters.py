...
# Used permutation '0111111001', which corresponds to 'LHHHHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'