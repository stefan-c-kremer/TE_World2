...
# Used permutation '0111000011', which corresponds to 'LHHHLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'