...
# Used permutation '1011110100', which corresponds to 'HLHHHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'