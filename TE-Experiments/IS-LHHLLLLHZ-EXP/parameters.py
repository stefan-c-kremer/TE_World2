...
# Used permutation '011000012', which corresponds to 'LHHLLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'