...
# Used permutation '100010100', which corresponds to 'HLLLHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'