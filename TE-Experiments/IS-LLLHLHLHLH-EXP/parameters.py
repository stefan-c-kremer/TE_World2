...
# Used permutation '0001010101', which corresponds to 'LLLHLHLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'