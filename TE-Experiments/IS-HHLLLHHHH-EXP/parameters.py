...
# Used permutation '110001111', which corresponds to 'HHLLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'