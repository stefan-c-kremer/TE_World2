...
# Used permutation '0110111111', which corresponds to 'LHHLHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'