...
# Used permutation '1001110110', which corresponds to 'HLLHHHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'