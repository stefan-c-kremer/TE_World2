...
# Used permutation '1000011010', which corresponds to 'HLLLLHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'