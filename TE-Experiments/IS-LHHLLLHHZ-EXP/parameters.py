...
# Used permutation '011000112', which corresponds to 'LHHLLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'