...
# Used permutation '0001110001', which corresponds to 'LLLHHHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'