...
# Used permutation '000101001', which corresponds to 'LLLHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'