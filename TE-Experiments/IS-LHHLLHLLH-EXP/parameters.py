...
# Used permutation '011001001', which corresponds to 'LHHLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'