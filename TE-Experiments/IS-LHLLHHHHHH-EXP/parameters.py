...
# Used permutation '0100111111', which corresponds to 'LHLLHHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'