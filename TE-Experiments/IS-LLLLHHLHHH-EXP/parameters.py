...
# Used permutation '0000110111', which corresponds to 'LLLLHHLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'