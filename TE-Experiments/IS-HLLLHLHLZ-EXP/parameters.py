...
# Used permutation '100010102', which corresponds to 'HLLLHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'