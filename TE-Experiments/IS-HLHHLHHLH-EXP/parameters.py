...
# Used permutation '101101101', which corresponds to 'HLHHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'