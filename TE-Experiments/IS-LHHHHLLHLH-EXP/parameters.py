...
# Used permutation '0111100101', which corresponds to 'LHHHHLLHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'