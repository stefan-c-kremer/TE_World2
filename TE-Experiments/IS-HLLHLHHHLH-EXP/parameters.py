...
# Used permutation '1001011101', which corresponds to 'HLLHLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'