...
# Used permutation '0001011011', which corresponds to 'LLLHLHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'