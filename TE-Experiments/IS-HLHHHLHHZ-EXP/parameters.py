...
# Used permutation '101110112', which corresponds to 'HLHHHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'