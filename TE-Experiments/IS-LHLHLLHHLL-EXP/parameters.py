...
# Used permutation '0101001100', which corresponds to 'LHLHLLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'