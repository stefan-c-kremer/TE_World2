...
# Used permutation '1000011011', which corresponds to 'HLLLLHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'