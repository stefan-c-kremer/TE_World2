...
# Used permutation '0111110100', which corresponds to 'LHHHHHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'