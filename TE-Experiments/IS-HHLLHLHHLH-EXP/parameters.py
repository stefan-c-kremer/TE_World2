...
# Used permutation '1100101101', which corresponds to 'HHLLHLHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'