...
# Used permutation '101111112', which corresponds to 'HLHHHHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'