...
# Used permutation '0100010110', which corresponds to 'LHLLLHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'