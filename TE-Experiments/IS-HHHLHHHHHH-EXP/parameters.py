...
# Used permutation '1110111111', which corresponds to 'HHHLHHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'