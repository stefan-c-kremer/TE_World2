...
# Used permutation '1100011011', which corresponds to 'HHLLLHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'