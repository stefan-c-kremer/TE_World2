...
# Used permutation '100110001', which corresponds to 'HLLHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'