...
# Used permutation '110000101', which corresponds to 'HHLLLLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'