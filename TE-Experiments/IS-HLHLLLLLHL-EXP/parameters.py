...
# Used permutation '1010000010', which corresponds to 'HLHLLLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'