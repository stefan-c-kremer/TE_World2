...
# Used permutation '1010000010', which corresponds to 'HLHLLLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'