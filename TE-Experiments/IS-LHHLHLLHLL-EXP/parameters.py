...
# Used permutation '0110100100', which corresponds to 'LHHLHLLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'