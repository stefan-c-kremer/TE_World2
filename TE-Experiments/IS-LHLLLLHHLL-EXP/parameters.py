...
# Used permutation '0100001100', which corresponds to 'LHLLLLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'