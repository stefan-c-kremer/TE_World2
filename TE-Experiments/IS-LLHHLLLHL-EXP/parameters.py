...
# Used permutation '001100010', which corresponds to 'LLHHLLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'