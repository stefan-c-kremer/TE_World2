...
# Used permutation '0011000100', which corresponds to 'LLHHLLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'