...
# Used permutation '011010112', which corresponds to 'LHHLHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'