...
# Used permutation '1101001111', which corresponds to 'HHLHLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'