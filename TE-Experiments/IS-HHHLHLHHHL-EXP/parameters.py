...
# Used permutation '1110101110', which corresponds to 'HHHLHLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'