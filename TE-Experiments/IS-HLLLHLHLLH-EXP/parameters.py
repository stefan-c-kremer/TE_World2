...
# Used permutation '1000101001', which corresponds to 'HLLLHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'