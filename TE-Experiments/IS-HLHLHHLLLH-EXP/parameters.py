...
# Used permutation '1010110001', which corresponds to 'HLHLHHLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'