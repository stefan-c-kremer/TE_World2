...
# Used permutation '000110112', which corresponds to 'LLLHHLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'