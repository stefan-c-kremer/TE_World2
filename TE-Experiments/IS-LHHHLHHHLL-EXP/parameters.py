...
# Used permutation '0111011100', which corresponds to 'LHHHLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'