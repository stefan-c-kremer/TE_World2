...
# Used permutation '1101110110', which corresponds to 'HHLHHHLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'