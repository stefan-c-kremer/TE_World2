...
# Used permutation '0001011001', which corresponds to 'LLLHLHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'