...
# Used permutation '010000001', which corresponds to 'LHLLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'