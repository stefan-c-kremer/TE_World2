...
# Used permutation '1101001010', which corresponds to 'HHLHLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'