...
# Used permutation '1000011111', which corresponds to 'HLLLLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'