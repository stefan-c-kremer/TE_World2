...
# Used permutation '0101101000', which corresponds to 'LHLHHLHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'