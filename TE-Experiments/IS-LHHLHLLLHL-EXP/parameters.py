...
# Used permutation '0110100010', which corresponds to 'LHHLHLLLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'