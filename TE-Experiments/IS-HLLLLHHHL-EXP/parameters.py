...
# Used permutation '100001110', which corresponds to 'HLLLLHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'