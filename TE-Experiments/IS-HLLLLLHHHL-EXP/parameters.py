...
# Used permutation '1000001110', which corresponds to 'HLLLLLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'