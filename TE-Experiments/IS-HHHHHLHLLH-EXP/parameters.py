...
# Used permutation '1111101001', which corresponds to 'HHHHHLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'