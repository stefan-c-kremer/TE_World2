...
# Used permutation '1011011000', which corresponds to 'HLHHLHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'