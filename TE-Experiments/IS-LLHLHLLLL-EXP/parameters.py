...
# Used permutation '001010000', which corresponds to 'LLHLHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'