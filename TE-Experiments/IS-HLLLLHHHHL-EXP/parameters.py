...
# Used permutation '1000011110', which corresponds to 'HLLLLHHHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'