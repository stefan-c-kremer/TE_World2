...
# Used permutation '010100102', which corresponds to 'LHLHLLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'