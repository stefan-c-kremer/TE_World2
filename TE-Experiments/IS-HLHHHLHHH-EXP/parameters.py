...
# Used permutation '101110111', which corresponds to 'HLHHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'