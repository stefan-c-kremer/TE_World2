...
# Used permutation '0000101000', which corresponds to 'LLLLHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'