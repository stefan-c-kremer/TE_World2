...
# Used permutation '110010002', which corresponds to 'HHLLHLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'