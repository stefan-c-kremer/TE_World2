...
# Used permutation '1011011111', which corresponds to 'HLHHLHHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'