...
# Used permutation '1011011111', which corresponds to 'HLHHLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'