...
# Used permutation '101110102', which corresponds to 'HLHHHLHLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'