...
# Used permutation '111110001', which corresponds to 'HHHHHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'