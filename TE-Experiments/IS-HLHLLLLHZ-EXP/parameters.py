...
# Used permutation '101000012', which corresponds to 'HLHLLLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'