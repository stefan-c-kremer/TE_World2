...
# Used permutation '0000001011', which corresponds to 'LLLLLLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'