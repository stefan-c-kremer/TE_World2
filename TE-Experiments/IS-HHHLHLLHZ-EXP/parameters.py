...
# Used permutation '111010012', which corresponds to 'HHHLHLLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'