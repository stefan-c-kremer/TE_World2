...
# Used permutation '1111111100', which corresponds to 'HHHHHHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'