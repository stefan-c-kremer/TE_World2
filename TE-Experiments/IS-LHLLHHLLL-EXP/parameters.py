...
# Used permutation '010011000', which corresponds to 'LHLLHHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'