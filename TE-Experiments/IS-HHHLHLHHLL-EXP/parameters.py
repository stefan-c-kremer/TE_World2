...
# Used permutation '1110101100', which corresponds to 'HHHLHLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'