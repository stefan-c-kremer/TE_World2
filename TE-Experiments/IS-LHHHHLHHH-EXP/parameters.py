...
# Used permutation '011110111', which corresponds to 'LHHHHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'