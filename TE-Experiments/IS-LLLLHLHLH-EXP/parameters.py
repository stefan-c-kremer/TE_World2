...
# Used permutation '000010101', which corresponds to 'LLLLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'