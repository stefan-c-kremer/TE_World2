...
# Used permutation '1111011100', which corresponds to 'HHHHLHHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'