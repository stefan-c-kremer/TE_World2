...
# Used permutation '1111011100', which corresponds to 'HHHHLHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'