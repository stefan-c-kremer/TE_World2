...
# Used permutation '011100111', which corresponds to 'LHHHLLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'