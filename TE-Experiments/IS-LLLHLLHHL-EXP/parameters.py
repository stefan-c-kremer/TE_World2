...
# Used permutation '000100110', which corresponds to 'LLLHLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'