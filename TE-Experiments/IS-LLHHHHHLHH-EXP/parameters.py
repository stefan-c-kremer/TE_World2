...
# Used permutation '0011111011', which corresponds to 'LLHHHHHLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'