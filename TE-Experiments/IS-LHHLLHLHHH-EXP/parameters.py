...
# Used permutation '0110010111', which corresponds to 'LHHLLHLHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'