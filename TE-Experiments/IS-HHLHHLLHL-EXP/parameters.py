...
# Used permutation '110110010', which corresponds to 'HHLHHLLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'