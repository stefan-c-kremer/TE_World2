...
# Used permutation '101110110', which corresponds to 'HLHHHLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'