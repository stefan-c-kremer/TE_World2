...
# Used permutation '1111101000', which corresponds to 'HHHHHLHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'