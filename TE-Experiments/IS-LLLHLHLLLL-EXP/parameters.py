...
# Used permutation '0001010000', which corresponds to 'LLLHLHLLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'