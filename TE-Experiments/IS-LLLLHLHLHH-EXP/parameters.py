...
# Used permutation '0000101011', which corresponds to 'LLLLHLHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'