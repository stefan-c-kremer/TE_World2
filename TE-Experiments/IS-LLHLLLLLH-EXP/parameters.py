...
# Used permutation '001000001', which corresponds to 'LLHLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'