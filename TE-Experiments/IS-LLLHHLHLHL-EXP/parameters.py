...
# Used permutation '0001101010', which corresponds to 'LLLHHLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'