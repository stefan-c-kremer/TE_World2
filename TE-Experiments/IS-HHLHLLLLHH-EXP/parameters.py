...
# Used permutation '1101000011', which corresponds to 'HHLHLLLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'