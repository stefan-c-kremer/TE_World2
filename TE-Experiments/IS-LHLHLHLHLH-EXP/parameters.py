...
# Used permutation '0101010101', which corresponds to 'LHLHLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'