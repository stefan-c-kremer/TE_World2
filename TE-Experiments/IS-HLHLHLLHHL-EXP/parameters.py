...
# Used permutation '1010100110', which corresponds to 'HLHLHLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'