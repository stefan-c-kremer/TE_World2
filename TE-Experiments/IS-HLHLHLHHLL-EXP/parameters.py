...
# Used permutation '1010101100', which corresponds to 'HLHLHLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'