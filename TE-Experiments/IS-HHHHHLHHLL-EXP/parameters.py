...
# Used permutation '1111101100', which corresponds to 'HHHHHLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'