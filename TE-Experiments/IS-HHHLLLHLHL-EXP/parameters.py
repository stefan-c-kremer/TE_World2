...
# Used permutation '1110001010', which corresponds to 'HHHLLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'