...
# Used permutation '0011100001', which corresponds to 'LLHHHLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'