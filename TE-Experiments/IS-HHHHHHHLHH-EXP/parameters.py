...
# Used permutation '1111111011', which corresponds to 'HHHHHHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'