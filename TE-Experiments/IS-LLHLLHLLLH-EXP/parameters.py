...
# Used permutation '0010010001', which corresponds to 'LLHLLHLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'