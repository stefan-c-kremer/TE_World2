...
# Used permutation '0100000100', which corresponds to 'LHLLLLLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'