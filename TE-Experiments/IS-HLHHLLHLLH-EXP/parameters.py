...
# Used permutation '1011001001', which corresponds to 'HLHHLLHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'