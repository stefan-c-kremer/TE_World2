...
# Used permutation '110101112', which corresponds to 'HHLHLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'