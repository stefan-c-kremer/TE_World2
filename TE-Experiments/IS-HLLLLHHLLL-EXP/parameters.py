...
# Used permutation '1000011000', which corresponds to 'HLLLLHHLLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'