...
# Used permutation '1000001010', which corresponds to 'HLLLLLHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'