...
# Used permutation '1100011010', which corresponds to 'HHLLLHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'