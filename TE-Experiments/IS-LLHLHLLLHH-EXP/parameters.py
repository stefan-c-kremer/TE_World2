...
# Used permutation '0010100011', which corresponds to 'LLHLHLLLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'