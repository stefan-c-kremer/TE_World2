...
# Used permutation '0100000111', which corresponds to 'LHLLLLLHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'