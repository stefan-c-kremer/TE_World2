...
# Used permutation '0000001111', which corresponds to 'LLLLLLHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'