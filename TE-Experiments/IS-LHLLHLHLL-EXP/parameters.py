...
# Used permutation '010010100', which corresponds to 'LHLLHLHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'