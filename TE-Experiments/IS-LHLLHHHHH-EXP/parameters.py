...
# Used permutation '010011111', which corresponds to 'LHLLHHHHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'