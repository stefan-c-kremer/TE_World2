...
# Used permutation '0010110100', which corresponds to 'LLHLHHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'