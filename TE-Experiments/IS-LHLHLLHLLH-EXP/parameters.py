...
# Used permutation '0101001001', which corresponds to 'LHLHLLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'