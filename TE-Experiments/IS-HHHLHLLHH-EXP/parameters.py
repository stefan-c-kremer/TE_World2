...
# Used permutation '111010011', which corresponds to 'HHHLHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'