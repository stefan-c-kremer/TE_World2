...
# Used permutation '011001112', which corresponds to 'LHHLLHHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'