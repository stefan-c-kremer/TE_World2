...
# Used permutation '1010111011', which corresponds to 'HLHLHHHLHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'