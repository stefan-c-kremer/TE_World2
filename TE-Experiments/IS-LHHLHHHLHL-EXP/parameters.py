...
# Used permutation '0110111010', which corresponds to 'LHHLHHHLHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'