...
# Used permutation '110101012', which corresponds to 'HHLHLHLHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'