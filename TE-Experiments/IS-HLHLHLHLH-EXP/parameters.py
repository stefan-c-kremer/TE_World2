...
# Used permutation '101010101', which corresponds to 'HLHLHLHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'