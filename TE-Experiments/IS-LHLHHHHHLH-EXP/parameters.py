...
# Used permutation '0101111101', which corresponds to 'LHLHHHHHLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'