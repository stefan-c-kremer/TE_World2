...
# Used permutation '0010110011', which corresponds to 'LLHLHHLLHH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'