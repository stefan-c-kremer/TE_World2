...
# Used permutation '0001001001', which corresponds to 'LLLHLLHLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'