...
# Used permutation '0001111110', which corresponds to 'LLLHHHHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'