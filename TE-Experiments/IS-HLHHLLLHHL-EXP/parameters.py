...
# Used permutation '1011000110', which corresponds to 'HLHHLLLHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'