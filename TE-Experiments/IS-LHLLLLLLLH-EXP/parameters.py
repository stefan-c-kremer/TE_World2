...
# Used permutation '0100000001', which corresponds to 'LHLLLLLLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'