...
# Used permutation '1110111001', which corresponds to 'HHHLHHHLLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'