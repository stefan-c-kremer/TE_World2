...
# Used permutation '001100112', which corresponds to 'LLHHLLHHZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'