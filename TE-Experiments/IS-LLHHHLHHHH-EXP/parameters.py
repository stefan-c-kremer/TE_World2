...
# Used permutation '0011101111', which corresponds to 'LLHHHLHHHH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'