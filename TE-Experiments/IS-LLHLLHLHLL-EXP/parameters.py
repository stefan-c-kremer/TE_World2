...
# Used permutation '0010010100', which corresponds to 'LLHLLHLHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'