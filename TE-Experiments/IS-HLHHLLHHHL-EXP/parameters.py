...
# Used permutation '1011001110', which corresponds to 'HLHHLLHHHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'