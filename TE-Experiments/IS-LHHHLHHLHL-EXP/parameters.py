...
# Used permutation '0111011010', which corresponds to 'LHHHLHHLHL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'