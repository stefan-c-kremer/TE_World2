...
# Used permutation '0000111100', which corresponds to 'LLLLHHHHLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'