...
# Used permutation '010000002', which corresponds to 'LHLLLLLLZ'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'