...
# Used permutation '0011001100', which corresponds to 'LLHHLLHHLL'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'