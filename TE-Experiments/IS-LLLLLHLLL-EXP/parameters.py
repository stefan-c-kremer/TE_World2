...
# Used permutation '000001000', which corresponds to 'LLLLLHLLL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'