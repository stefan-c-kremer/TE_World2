...
# Used permutation '0000100110', which corresponds to 'LLLLHLLHHL'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'