...
# Used permutation '0110000001', which corresponds to 'LHHLLLLLLH'. Reference the mappings in the configuration file to determine what is 'high' and what is 'low'