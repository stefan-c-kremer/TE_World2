...
# Used permutation '1010011101', which corresponds to 'HLHLLHHHLH'. Reference the configuration_mappings in the configuration file to determine what is 'high' and what is 'low'