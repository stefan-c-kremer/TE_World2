# parameters.py
"""
Replace this with a description of the experiment!
"""
from TEUtil import *;
...
Kidnapping_Effectiveness = lambda live_aut, live_naut: 0.00001 * (max(live_aut - live_naut), 0)  # The larger the number, the higher the probability of non-autonomous kidnapping the autonomous TEs
...
# new Host mutation: fitness chages relative to current fitness
Host_mutation = ProbabilityTable( 0.40, lambda fit: 0.0,
                                  0.30, lambda fit: fit - fit*random.random()*0.10,
                                  0.15, lambda fit: fit,
