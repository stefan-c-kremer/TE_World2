"""Generated parameters for condition HLLHLHH-LH.
...
Host_mutation = ProbabilityTable(
    0.40, lambda fit: 0.0,
    0.30, lambda fit: fit - random.random() * 0.1,
    0.15, lambda fit: fit,
    0.15, lambda fit: fit + random.random() * 0.1,
)
Insertion_effect = ProbabilityTable(
    0.30, lambda fit: 0.0,
    0.20, lambda fit: fit - random.random() * 0.1,
    0.30, lambda fit: fit,
    0.20, lambda fit: fit + random.random() * 0.1,
)
